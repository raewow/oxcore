...
-- Table data for table `area_template`
--
...
CREATE TABLE `area_template` (
  ...
  `zone_id` mediumint unsigned NOT NULL DEFAULT '0',
  `explore_flag` mediumint unsigned NOT NULL DEFAULT '0',
  `flags` mediumint unsigned NOT NULL DEFAULT '0',
  `area_level` mediumint NOT NULL DEFAULT '0',
  `name` varchar(100) NOT NULL DEFAULT '',
  `team` tinyint unsigned NOT NULL DEFAULT '0',
  `liquid_type` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`entry`)
