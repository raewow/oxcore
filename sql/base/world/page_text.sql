...
-- Table data for table `page_text`
--
...
-Verner', 0),
(29, 'A note is attached to the crate.  It reads:
...
Contained within these pages you will find an account of the State of Lakeshire, nestled within the Redridge Mountains.', 31),
...
Kingdom of Stormwind', 0),
(36, 'Honorable Magistrate Solomon:
...
(44, 'Missing Text', 0),
(45, 'Good work, matey!  Now ye need to head due east.  East up the bluffs, east to the road.  Look for the ol\' chimney ruins near the side of the road.  There you\'ll find an old barrel with your next clue.', 0),
...
(53, 'The letters on this note seem to flicker and dance across its surface.  It is impossible to glean meaning from them...', 0),
...
(58, 'A Moon over the Vale shines
...
Yours faithfully,
Calor', 0),
(64, 'Morgan Ladimore was a great and noble knight who fought in defense of the innocent, the poor, and the afflicted. For many years, he worked diligently throughout the outlying areas of Azeroth, bringing relief to the suffering and swift justice to evildoers.
...
(65, 'Lordaeron. Morgan was called to the side of the legendary paladin Uther the Lightbringer to fight against the orcs and the undead. Leaving his wife and children in the safety of his home, Morgan left for war.
...
(66, 'someday be reunited with his wife and children.
...
(67, 'headed towards the village to find answers, and, he hoped, his wife and children.
...
(68, 'there, he decided, against his better judgement, to stop by the Raven Hill cemetary. Morgan spent hours walking amongst the gravestones. He recognized many names of people that he knew and became more and more distraught. Then he saw them: a small, untended plot amongst the many with three small gravestones. A feeling of dread washed over him as he approached. Morgan brushed off the dust of the most prominent gravestone to reveal the name on it. Simply carved upon the grave, letters spelled out', 69),
(69, 'his worst fear:
...
(70, 'of a trio of the cemetary\'s attendants. As they tried to restrain him, he turned his focus to them, hurling accusations of guilt upon the innocent attendants, then killed them all.
...
(71, 'the next day. He was quickly buried, without ceremony, in a hastily dug grave on the outskirts of the cemetary. Because Morgan committed murder against innocents, something that went completely against his beliefs and his nature, and because of the grief that he held in being unable to save his family, Morgan could not die a peaceful death, and lived on as one of the restless dead.

Only days later, his grave was disturbed, and his body could not be found. The being that was Morgan now', 72),
(72, 'wanders Duskwood, consumed by his grief over the loss of his wife and children and his own self-hatred. Mor\'Ladim, as he now calls himself, roams Duskwood with mindless vengeance and hatred, and has been known to commit murder indiscriminately.', 0),
...
The lad got tangled up with a trogg today, put up a fight, and', 81),
...
By each specified day, gold gained from the Elwynn mines will be gathered at the Brackwell pumpkin patch.  The agent in charge of these gatherings, "The Collector," will be known by the engraved ring he possesses.  A ring I gave him.', 250),
(80, 'Grelin,
...
Magni Bronzebeard', 0),
(81, 'managed to get the better of the ugly brute, but he\'s now nursing a nasty cut on his arm. Looks like I\'ll have to do the chores for a while.
...
The lad was back and in good spirits today, so we took our first look at the trolls. Frostmane, I\'d say, judging by the markings on their skin and the various trinkets they wore on their bodies.', 82),
(82, 'DAY FIVE
...
I realize I have not mentioned the troggs of late. They appear in the area in greater numbers, but they are so primitive that they do not pose much of a threat. Time may say if this is true or not.', 83),
(83, 'And not a drop of ale for almost a week now.
...
The trolls are perhaps not as large a problem as we initially thought. They have some', 84),
(84, 'numbers but are not well armed or organized. A small show of force should be more than adequate in dealing with the threat they pose.', 0),
(85, 'My Journal
...
I began a journal before this one, but it remains in a place to which I cannot return.  So I will start afresh.  But this time, I will start from the true beginning.', 186),
...
(87, 'Coldridge Valley and mercenaries (paid with funds set aside by the Senate prior to my dispatchment), I am confident that the problem will be solved in short order. 

This action has been authorized with the sanction given to me by King Bronzebeard.', 0),
(88, 'A Report on the State of the Frostmane Trolls in the General Area of Dun Morogh

The trolls situated in Dun Morogh are largely centralized in Frostmane Hold, a mountain cave on the western border. They have sufficient numbers to cause some concern, however, they seem more than content to stay in their cave. This is, no doubt, because they do not wish to incur the wrath of the dwarves again, and risk total extermination. Their actions can be considered territorial, if anything, and it is', 89),
...
Signed,
Senir Whitebeard', 90),
(90, 'A Report on the State of the Frostmane Trolls in the General Area of Coldridge Valley

Prepared by Grelin Whitebeard, Senate Special Envoy

From the time that I have spent observing the movement of the Frostmane trolls in the Coldridge Valley area, I have determined that they pose no large threat to dwarven settlements in the area. Moreover, they are a threat that can be eliminated with little additional support from the army. Through the assistance of Mountaineers already stationed in', 91),
(91, 'Coldridge Valley and mercenaries (paid with funds set aside by the Senate prior to my dispatchment), I am confident that the problem will be solved in short order. 
...
The dig crew was making significant progress unearthing important Titan artifacts.  But we began to discover other ancient objects, specifically large bones.', 93),
...
--Merrin', 0),
(95, 'The Green Hills of Stranglethorn
...
(98, 'In the years that followed, after Stormwind betrayed the Stonemasons\' Guild, Sir Erlgadin grew bitter about the role of the nobles within the Kingdom.  He no longer wished to uphold the position that his father\'s bloodline had earned for him in the House of Nobles.

But I digress.  The purpose of this story is not to act as a political treatise or a biography.  This is the account of my experiences hunting big game in the green hills of Stranglethorn.', 0),
(100, 'Just as I was about to question Ajeck\'s lack of interest in the day\'s hunting strategy, she reached for her quiver, drew an arrow and unleashed a shot right towards poor Barnil.  But it was not Barnil that Ajeck was shooting at.  For when Barnil stepped aside, mouth agape, a large river crocilisk floated to the surface with Ajeck\'s arrow perfectly placed between his two large eyes.', 0),
...
We passed the Tkashi Ruins without event, much to Barnil\'s relief.  The party proceeded to head westward, toward the Great Sea, skirting the Ruins of Zul\'Kunda just to the south.  As we ascended the high sea bluffs we spotted our first Raptor.', 0),
(118, 'Our hastily aimed shots were enough to buy Barnil\'s escape.  Barnil clamored back down the hill and rejoined the party. We scurried off into the jungle; a pack of ferocious Lashtail Raptor\'s stalking our every move.

The hunters were now the hunted.', 0),
(119, 'I led the party toward the sea, hoping the shoreline would provide refuge from the Raptors.  In our haste we had drifted too far north, to a precariously high elevation.  The mistake was made.  The fault was mine.  We stopped just short of a sheer cliff, the Raptors just a few paces behind.', 0),
...
(124, '  The Green Hills Of Stranglethorn$b$b              By Hemet Nesingwary', 0),
(153, 'Our first day went as well as one can expect first days to go.  Most of our time was preoccupied with making the necessary arrangements to establish a base camp.  I located an ideal setting by a freshwater river inlet.  Judging by the old, abandoned docks nearby, this site was inhabited sometime ago.  As for the original inhabitants, only time can tell that tale.', 154),
...
We gathered our belongings and headed solemnly back to camp.', 164);
...
The Humans, while appreciative of the training Barnil and I offered, decided to refrain from hunting with firearms.  Ajeck was much more comfortable with a finely strung bow and Sir Erlgadin never left camp without his sturdy crossbow.', 172),
...
We passed the Tkashi Ruins without event, much to Barnil\'s relief.  The party proceeded to head westward, toward the Great Sea, skirting the Ruins of Zul\'Kunda just to the south.  As we ascended the high sea bluffs we spotted our first Raptor.', 174),
...
*Flee, Barnil!* I shouted.  Ajeck, Sir Erlgadin and myself loosed a volley of bullets, arrows and bolts over Barnil and toward the pursuing raptors.  One of us landed a kill amidst the confusion.', 176),
(176, 'Our hastily aimed shots were enough to buy Barnil\'s escape.  Barnil clamored back down the hill and rejoined the party. We scurried off into the jungle; a pack of ferocious Lashtail Raptor\'s stalking our every move.
...
But ever since I found the haft of the Scythe jutting from that pile of rubble in the mine and, curse me, pulled it free, Roland\'s Doom became a place of vile death!', 205),
...
But ever since I found the haft of the Scythe jutting from that pile of rubble in the mine and, curse me, pulled it free, Roland\'s Doom became a place of vile death!', 187),
...
But enough waxing like a pipe-mad poet.  I must continue with the chronicle...', 188),
...
Unnerving, yes, but we did not have long to wonder at this strangeness.  It was but a harbinger of what truly drove us from the mine.  The Worgen.', 189),
...
For all I know, I am the only human to escape that place.', 190),
...
Or maybe it was the Scythe I pulled from the rubble.  It cannot be the Scythe itself, for I lost it during my frantic flight.  But if it was I who brought the Worgen to Duskwood, then perhaps the Worgen afforded me a rare courtesy.  Curse them.', 191),
...
That is the next chapter of my tale, and I pray it is the last...', 192),
...
So I remained hidden.  And it saved my life.', 193),
...
At least they parted happily.  And at least his wife was the first to die, and was freed from seeing the slaughter of her children.  But these small graces do nothing for me.  I saw what happened, and it will ever haunt my dreams.', 194),
...
I know this because, just before they began their slaughter they asked one question to Sven\'s wife as she held her children close, giving them what comfort she could though she was certain death was near.', 196),
...
And it was what would kill Sven\'s family.', 197),
...
And it was bold and clever.  If only it had worked.', 198),
...
"I\'ll take you.  All of you," she said, and I could see a small hope flicker behind her eyes.', 199),
...
"Please," I prayed.  "Let them believe."', 200),
...
"This woman lies," it said in a voice that has scarred my dreams.  "She has not seen the Scythe."', 202),
...
"The Lord has spoken.  Kill them."', 203),
...
Or maybe it was the Scythe I pulled from the rubble.  It cannot be the Scythe itself, for I lost it during my frantic flight.  But if it was I who brought the Worgen to Duskwood, then perhaps the Worgen afforded me a rare courtesy.  Curse them.', 207),
...
This progresses well.  And I will update as needed.', 210),
(210, 'REPORT: Thieves
...
We have identified one of their leaders--one Garrick Padfoot--and hope to bring him to justice soon.', 211),
(211, 'REPORT: Wolves
...
Although the wolves rarely hunt human prey, the sheer number of them has caused some incidents with farmers.  And many livestock have gone missing.', 212),
(212, 'COMMENDATION:
...
My only comfort in these dark days is the relief I feel, knowing that you are free of my fate.', 252),
(215, 'Missing Text', 0),
...
It isn\'t a wolf.  It may be a bear.', 231),
(231, 'Day 3
...
I hope he comes close.  I\'ll bury my pick into his head!', 232),
(232, 'Day 4
...
I\'ll have to head back to Hammerfoot and our Steam Tanks tomorrow.  I don\'t want to get lost out here, booze-less.', 233),
(233, 'Day 5
...
I fought the thing off but it chewed my leg up good.  Now I can\'t move, my ale\'s gone, and I never did find that ore.  Curses!', 234),
(234, 'Day 6
...
And take my armor.  You\'ll need it against old Mangeclaw!', 0),
...
They\'re animals, but brutal animals nonetheless--given enough of them, we\'d have reason to be concerned. Better to hide any signs that would provoke them altogether. The last thing we want to give them is a reason to rally and attack us in force.', 0),
(250, 'A party from Defias headquarters will contact the Collector, after which he will transfer the gathered gold.

Be sure this process is performed without fail and with utmost discretion.  The Collector is responsible for the transfer of gold, but ultimately it is the responsibility of each member of the Defias Brotherhood to ensure that his role is acted out with attention and discipline.', 251),
...
If you receive this letter, Yvette, then know that Devlin is a traitor.', 253),
...
If you see my brother, then flee from him.  He is a fiend.  A few nights ago he murdered two of our watchmen and let a small group of Scourge through the breach, leading them to where many more of us slept.', 254),
...
Either way, he is a monster.', 255),
...
It was always hard to understand Devlin\'s motives.  Since he was a child, he was a mystery to us.', 256),
...
Herein lies the town registry for purposes of governing this fair city in the foothills of the great Alterac Mountains as well as serving as a record of those who have paid their taxes to their Kings and to the great almighty Alliance.', 262),
...
Farmer Lyion
Debt outstanding.  Evicted from the land.', 263),
(263, 'Farmer Kalaba
...
Miner Hackett
Debt outstanding.  Payment due upon next delivery of ore from Azurelode.', 265),
(265, 'Miner Orwell
Debt outstanding.  Payment due upon next delivery of ore from Azurelode.
...
Foreman Bonds
Debt outstanding.  Payment due upon next delivery of ore from Azurelode.', 0),
...
Indeed, there is a humanity within him that, I confess, I sometimes see lacking in the humans around me.', 267),
...
"Remnants of the Old Gods still linger in the deep hollows of the world.  New forces seek to harness that ancient power, and those who succeed will have a terrible weapon against their enemies."', 268),
...
For I felt a power within it.  A deep, hidden, hungry power.  And one yearning for release.', 269),
...
But it was then, at the brink of failure, that a breakthrough was made.  My latest test involved a glass beaker whose brim was chipped, leaving a small, jagged space along its edge.  When the test was over, again revealing nothing, I went to clean my worktable and cut myself on the beaker.', 274),
...
And as I was cleaning up this new mess, I noticed the strangest thing...', 275),
...
Does bloodstone drink blood?  Does it crave blood?  Does it attract blood?', 277);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(277, 'Or, is bloodstone made of blood?  And if so, then whose blood?  Mine?  The blood of any human?  Any animal?  
...
That is the question that must be answered.  It is the key.', 278),
...
And, although my lab here is small and I have no subordinates to spare to aid, I did find one more intriguing quality of bloodstone...', 279),
...
My growing fondness for Kegan gave me patience as I waited for my test results.', 283),
...
This is grave news, for although Kegan and his followers still have bloodstone specimens with which we may experiment, I fear the pendant may fall into unsavory hands.', 284),
...
I only hope we\'re not too late.', 0),
...
(286, 'LEGENDS OF THE TROLLS, VOLUME III
...
While I have delved into many', 293),
...
- Falstad Wildhammer - Lord of Aerie Peak', 0),
...
- Antonidas - Archmage of Dalaran', 0),
...
- Lord Uther the Lightbringer - Knight of the Silver Hand', 0),
...
- Thoras Trollbane, Lord of Stromgarde', 0),
...
The Gurubashi Empire was surrounded on three sides by the sea, so it comes as little surprise that water would figure prominently as an aspect of their society. While the trolls were able to roam and control the large areas of their jungle empire, the sea eluded them. It was vast and immeasurable, no', 294),
(294, 'doubt a disconcerting neighbor for the powerful trolls.

It should be noted here that recent discoveries seem to suggest that the trolls had little interest in exploring the lands beyond the Great Sea. While troll species have been encountered along the length and breadth of Azeroth, Khaz Modan and Lordaeron, little evidence of their civilization has been found in the newly discovered lands of Kalimdor or upon the islands in the South Seas. Whether this demonstrates an unwillingness of', 295),
...
Recent discoveries during surveys', 296),
...
It appears that the Stone of the Tides allowed its bearer to control water in its many forms, rivers, rain, and the tides. Because of the stories related to use of the Stone of the Tides, I have conjectured that it is', 297),
...
Like the movements of the eponymous tides, the Stone of the Tides entered the world of the trolls and departed, never constantly staying in the trolls\' hands for longer than a generation at a time.', 298),
...
Over the weeks and months, the warrior discovered that the stone had given him control over water. He could summon forth', 299),
...
The warrior traveled to Zul\'Gurub, to the heart of the empire, to show his newfound abilities to the Emperor. He easily gained a court audience after demonstrating his powers in the center of the Imperial capital. His powers easily amazed the Gurubashi Emperor, who immediately gave him a place of honor at court, naming the warrior "Tidebearer", leaving his', 300),
(300, 'old name behind.
...
The Tidebearer was hiding a secret from the prying eyes of court. The abilities granted to him by the Stone of the Tides also came with a curse. As the years', 301),
...
Generations later, the Stone of the Tides washed upon the shores of Stranglethorn, and another Tidebearer was chosen, as the troll brought the Stone to', 302),
...
Modern day accounts of the Stone of the Tides have appeared from place to place, but one must still wonder why an object of such power would appear with such regularity, and by whose design.', 0),
...
The Damsel\'s Luck will drop anchor off the southern cape for purposes of supply.  Captain Stillwater, the little shorty, is to have his crew prepare to haul up all the plundered loot.  I\'m sure Brutus, that blockhead, will be on top of things.', 306),
...
You blokes are responsible for salvaging anything that might be of use for our little project with VanCleef in the Deadmines.', 307),
...
I thought my ancestors had granted me a boon by allowing me to escape their wrath. But now I wonder what wisdom I shall gain if I live through my imprisonment.', 0),
...
These creatures will surely stop any who come to the island. I must have faith in my ancestors.', 0),
...
I can see the ocean water not far from me, but it does nothing to cool my body or my temper. It only reminds me of my imprisonment.', 0),
(311, 'Day 1:$B6am to 11am - upper camp$B11am to 11:30 am- break, lunch$B11:30am to 4:00pm - canyon pass$B4:00pm to 7:30pm - upper camp$B$BDay 2:$BSame schedule as day 1$B$BDay 3:$BSame schedule$B$BDay 4:$BSame schedule, with one exception.  Just before sunset, Thorsen had me cover for him as he crept down the canyon pass.  I assumed he went to meet with our agents.$B$BBut he returned an hour later.  This surprised me.  I had hoped he met with our agents and would rejoin Kurzen.  Something is wrong.', 312),
(312, 'Day 5:$BThorsen was very agitated today.  Whatever he saw or whomever he met during his excursion yesterday must have scared him.$B$BI assumed our agents spoke with him, but when I asked Thorsen where he went while I covered for him, he remained quiet.  He believes I am his friend, and he believes he is protecting me from a dangerous secret.$B$BHis loyalties are misplaced, but they are strong.  When he rejoins us, he will be a valuable addition to Kurzen\'s forces.', 313),
(313, 'Day 6:$BEarly in the morning, Thorsen spoke at length with Sergeant Yohwa.  I had to pretend I still slept and so was unable to move within earshot.  But I assume they spoke of Thorsen\'s earlier excursion.$B$BI watched him closely at lunch and noticed Yohwa doing the same.  Later, Doren summoned Thorsen.  The three of them share a secret.  Doren and Yohwa must know that Thorsen is meeting with your agents.$B$BHe is spying for the rebels.', 314),
...
The indications are very strong that we shall move to take watch over the Thandol Span in a few days. Lest I shall not be able to write to you again. I feel impelled to write a few lines that may fall under your eye when I shall be no more.', 318),
...
I have no misgivings about or lack of confidence in the cause in which I am engaged and my courage does not halt or falter.', 319),
...
Forgive my many faults and the many pains I have caused you, how thoughtless, how foolish I have often times been.', 323),
...
I must watch you from the twisting nether and hover near you while you buffet the storms with your precious little freight and wait with sad patience till we meet to part no more.', 332),
...
\'Tis not the place of a lowly soldier\'s wife to question the actions of great leaders such as yourself.  The battles that rage across our lands are being fought to preserve the great life we know and love, from the cool waters of Loch Modan to the brisk, snow-capped peaks of Dun Morogh.', 334),
...
Under how many swords and axes must we throw our future? Under how many feet of sodden soil must we bury our past?', 335),
...
Lieutenant Benedict will be second in command in my absence. All domestic Kul Tiras military matters will be handled by him. If I do not send word from Tiragarde Keep within 12 months time, Lieutenant Benedict will lead the second wave to hold the location.', 338),
...
The geology of the region dictates we use extreme measures however. Many of the sand deposits have solidified under the harsh conditions and varying climate.', 343),
...
The work will be noisy and disruptive but our search is of far greater importance than the comfort of the local inhabitants. In fact, we\'ve already had to drive a band of bull-men out of the area who were proving to be a nuisance.', 344),
...
Alas, I have digressed. There is much work to be done beneath the rock. I have spent too much time writing and not enough digging...', 0),
(345, 'Missing Text', 0),
...
The engaged position enables the samophlange. The control mechanism will not automatically disengage when the lever is put in the off position. This will merely', 355),
(351, 'Missing Text', 0),
...
The advisory board understands the difficulties in establishing', 353),
...
The first is the MAIN CONTROL VALVE, which can be found at the base of the large, vertical smokestack. Next, the FUEL CONTROL VALVE can be found on the large pipe which leads ', 356),
...
Displays the operating temperature of the system in general.', 0),
...
Though there were many towns and places of habitation constructed', 364),
...
Brother fought brother. Chosen fought', 366),
(360, 'Missing Text', 0),
(361, 'Master Delgren,
...
Please forgive the terseness in which I have composed this missive, but danger lurks in the forest around me, and I can spare few words to describing the situation. I', 437),
...
His second, a mage known of his prowess in the arcane arts as much as with his physical abilities,', 365),
...
And so it was, upon the shores of the Well of Eternity, the twin towns grew and prospered, while the world beneath the stars fell slowly to madness.', 0),
...
With a spell he could protect them, he would say. While around them, brother and sister, father and mother perished,', 367),
...
An ogre in Alterac, Grel\'borg the Miser, was the last known owner of this gem, whispered to empower its owner with the ability to commune with other worlds.  Sources tell us Grelborg wanders the Ruins of Alterac in the Alterac Mountains, searching the rubble and debris for more relics.', 377),
...
I want that hand.', 378),
(378, 'The Legacy Heart

Old texts say that he who posseses the Legacy Heart fears not the grave.  Perhaps this is true, for the owner of the heart, the troll Mogh, is known as Mogh the Undying.  A witchdoctor of the Skullsplitter tribe, Mogh dwells in Stranglethorn in the Ruins of Zul\'Mamwe.', 379),
(379, 'Bring me these items, the Star, the Hand and the Heart, and I will give you a copy of the Yagyin Digest.

-The Keeper', 0),
(380, 'Deathstalker Mission Report$B$BAgents: Rane Yorick, Quinn Yorick, Erland McKree$B$BPrimary mission: perform reconnaissance through northern silverpine, and determine threat levels of wildlife and Scourge.', 381),
(381, 'Agents commenced sweep, finding significant worg presence.  Recommend hunting squads dispatched to reduce this threat.$B$BUndead gnolls were found at the farm steading dubbed The Dead Field.  Their purpose at the farm is not known, though their movements and level of readiness suggest imminent military action.  In the time they were observed, no notable leaders were found among the gnolls.  It is assumed they await the arrival of leadership or reinforcements.', 382),
(382, 'Continuing the sweep, our agents were detained at Ivar\'s farm.  Ivar, most of his family and his workers had succumbed to the Scourge and become its minions.$B$BOur agents were attacked and although successful in defeating their ambushers, they sustained serious injuries, particularly agent Quinn.', 383),
(383, 'A defensive position was taken in Ivar\'s old house, and while Rane kept watch for future attacks, Erland continued the reconnaissance mission.$B$BErland was then pinned by Worgs in a northern orchard, only escaping with the aid of another Forsaken agent.  That agent is the bearer of this report.', 386),
(386, 'It should be noted here that this report bearer was instrumental in not only the success of our mission, but also in the defeat of Ivar the Foul, the rescue of Erland, and the deliverance of this report.$B$BWe extend our gratitude, and recommend that command acknowledges this individual with awards befitting such meritorious conduct as was displayed in the field.$B$B-Deathstalker Rane Yorick,$BMission Leader', 0),
...
For only death will end his rage.', 0),
(395, 'The Shrine of Mel\'Thandris

"May the light of Elune shine upon this vale eternal and illuminate the ways of the forest as it has for time immemorial."', 0);
...
What mattered was that the worgen heard', 398),
...
May Elune\'s blessings be upon me until my work is done.', 399),
...
May Elune\'s blessings be upon me until my work is done.', 400),
...
May Elune\'s blessings be upon me until my work is done.', 401),
...
Meanwhile, I have searched the libraries in Darnassus and consulted with the Circle of Ancients in Darkshore. Not one scrap of information about these worgen did I find. I have heard reports,', 402),
...
May Elune\'s blessings be upon me until my work is done.', 0),
...
I\'ve recently found truth to the rumors of the wizard Dartol\'s efforts.', 404),
...
I never discovered his goals during my investigation, but his plan seemed simple: using druidic magic, he wanted to befriend and then control the furbolg. If it was in an attempt to harm my kin, or for some other malicious purpose, I hope to find out before my path ends.', 405),
...
Using an item he created (a rod or staff of some kind), he attempted to infiltrate the furbolg tribes of Ashenvale. At some point, and this is where many of the details are still unclear, he was discovered by the furbolg while trying to manipulate them into acting against', 406),
...
I\'m hoping that if I can recreate the rod with the help of a dryad named Shael\'dryn, I can use its power to help our people... and the furbolg.', 407),
...
I\'ve watched him for days, and I think if I were to approach him in the guise of a furbolg, I could help him and discover a way to re-establish a bond between our people.', 408),
...
The Gem
The first part of the rod, a glowing gem, was hidden in a shrine in Northwestern Ashenvale. I believe now this shrine is the ruins at the center of Lake Falathim. The Sentinels tell me that it\'s been inhabited by murlocs now.', 409),
...
My research tells me that the guardians kept the piece in a small glade locked within a chest. To find out any more, I\'ll have to speak to Shael\'dryn.', 411),
...
Their spirits now inhabit the area and are no longer hospitable.', 412),
...
We spoke over a few ales one night, and his tales have given me new hope of finding the pommel...', 413),
...
The slimes seem to gain a great deal of sustenance from things magical. If the chest holding the pommel was enchanted at all, the slimes might have eaten it.', 414),
(414, 'It\'s a gamble, but I have no other clues at this time...

As I find out more I\'ll put the details here; but until then, I shall work on finding the parts of the rod and helping Ashenvale.', 0),
(415, 'Jin\'Zil,
...
Remember, this is a distraction. Get far from the wagons before the goblins get there to check out what happened, then sneak in behind them.', 418),
...
To plant the charge, head to the back of the wagon. Once it\'s set, make haste and get some distance.', 420),
...
Oh, just in case it wasn\'t obvious, don\'t be near the wagon when it blows... it\'ll hurt.', 421),
...
If the goblins don\'t come running to check out the commotion, it\'s probably because the mountain came down on top of their heads.', 422),
...
Oh, and destroy this letter after you\'ve accomplished your mission. Hmm, maybe I should look into a way to make these things destroy themselves after they\'re read. That\'s not a bad idea...', 0),
(424, '--Day One--
...
My assignment: head to the south in search of more clues.', 425),
(425, '--Day Two--
...
The only incident of note took place near the gold road. Off in the distance I noticed some strange creatures. Half pig, half man it seemed. I quickly hid and let the foul beasts pass. My what a foul stench they left behind!', 426),
(426, '--Day Three--

Oh great and splendid discovery!

Whilst exploring today I came across a grand find: massive remains of what seems to have been a boar-like creature. Its skull towered many lengths above me. Each tooth of the beast could dwarf even... well a dwarf. Due to the sheer size of the find, I am lead to believe these are the remains of one of the rumored Old Gods.', 427),
...
Bah! One moment. I hear snorting outside the tent. Surely just some thistle boars trying to get at my apple stash....', 428),
(428, '--Day 4--
...
Attacked by boar men of the Razorfen tribe. Believed they were taking me to the great boar remains of the fallen god. Instead, they skirted the great fossils and headed directly west of the giant skull, across the Gold Road.', 429),
...
Someone coming now...', 430),
(430, '--Day 5--

My night elf cell mate suffers from grave wounds. The boar men have whipped him repeatedly and I believe he will perish before long unless by some miracle a rescue party braves this treacherous place. He slips in and out of consciousness. When he awakes, I try to give him what little water I have.', 431),
...
In a weakened voice he told me that he believed the great boar skull to be the place where the great boar god Agamaggan fell battling the Burning Legion some 10,000 years ago during the War of the Ancients. His massive body flattened the land and his blood sank into the earth. Twisted spires of thorns grow where his blood fell...', 432),
...
Before I could press for more information, Heralath slipped into fitful sleep once again...', 433),
(433, '--Day 6--

Heralath\'s condition worsens.

His eyes opened only once today. He spoke with pained anguish but his message was clear. If I were to escape my doom here in Razorfen Kraul, word must be gotten to Falfindel Waywarder in Thalanaar that Charlga Razorflank was rousing minions in the southern Barrens. The power grows with each day. The Crone must be stopped before the plague of corruption can spread from the Kraul.', 434),
...
My plan is to sneak out when the boar men leave for their next hunt. My guards are lazy and often sleep through their shifts.', 435),
...
What began as an attempt to explore the past of my people has turned into something much larger. The protection of the Alliance lies in my hands....', 0),
(436, 'ORDER NUMBER: 45TK-3
...
If his father knew where he was, he\'d be sure to seek him out and drag him back home... minus a toe for his insolence.', 0),
(439, 'Mr. Fizzlebub,
...
If racing and, more specifically gambling on races, interests you then please read on, for I feel that your knowledge of Stranglethorn would be useful in our scheme.', 445),
(440, 'Mr. Fizzlebub,
...
You are an expert in crafting with metal.  You must help.  You are the only one who can.', 751),
...
So... we\'re looking for a means to force a lapse in one of the pit crews\' dilligence, as any such lapse would cause the crew\'s car to fall quickly into disrepair.', 446),
...
A crisis develops in the Stonetalon Mountains, not far from our Tauren allies\' homeland of Mulgore.  The goblin-run Venture company is mining and lumbering fiercely in those moutains, enraging the mountain spirits.', 449),
...
Tomorrow Uleg and Thargil will return to the docks and steal aboard the ship.  They hope to find political documents, ones that reveal the relations between Theramore and the Alliance.', 579),
(571, 'Captain,
...
The Lich King\'s plan worked perfectly. Many of Lordaeron\'s northern villages were contaminated almost immediately. Just as in Northrend, the citizens who contracted the plague died and arose as the Lich King\'s willing slaves.', 574),
...
The Titans, colossal, metallic-skinned gods from the far reaches of the cosmos, came forward and set to work on the worlds they encountered. They shaped the form of their worlds by raising mighty mountains and dredging out vast seas.', 577),
...
The Titans, ruled by an elite sect known as the Pantheon, brought order to a hundred million worlds scattered throughout the Great Dark Beyond during the first ages of creation. ', 578),
...
I will remain here.  I have witnessed increased shipping activity off the coast of Theramore.  I will continue my watch and personally report any noteworthy events.', 0),
(580, 'Our first plan has already failed!$B$BFist was successful in switching the guard roster for the tunnel shifts that evening, but due to some unforeseen efforts by some of the citizens of Stormwind, our target was able to flee from the scene before we could capture him. But we planned for such contingencies. Plan 2 has been set in motion and was well under way before our ambush was set off in Stormwind.', 581),
...
elves\' remote kingdom of Quel\'Thalas before their rampage was finally stopped.', 628),
...
The Alliance forces under Sir Lothar managed to push Doomhammer\'s clans out of Lordaeron and back into the orc-controlled lands of Azeroth. Lothar\'s forces surrounded the orcs\' volcanic citadel of Blackrock Spire and laid siege to their defenses.', 629),
...
Turalyon and his warriors chased the remaining orcs through the festering Swamp of Sorrows and into the corrupted Blasted Lands where the dark portal stood. There, at the foot of the colossal portal, the broken horde and the rugged Alliance clashed in what would be the last, bloodiest battle of the Second War. ', 632),
...
In time, a primitive tribe of nocturnal humanoids cautiously made their way to the edges of the mesmerizing, enchanted lake.', 639),
...
breadth of Kalimdor and encountered its myriad denizens.', 641),
(641, 'The only creatures that gave them pause were the ancient and powerful dragons. Though
the great serpentine beasts were often reclusive, they did much to safeguard the known lands from potential threats. The night elves believed that the dragons held themselves to be the protectors of the world, and that they and their secrets were best left alone.', 642),
...
', 0),
(691, 'If you are reading this note, then you survived the ordeal of undeath and have returned to us to join the ranks of the Forsaken.   This new life is viewed by many as more of a curse than a blessing, but make of it what you will.$B$BWhen you are ready for more training in the path of arcane magics, then I will show you what you need to know.  You will find me in the old church in Deathknell.$B$B   -Isabella, Mage Trainer.', 0),
(692, 'You led a quiet life of love and good deeds.   You gave to the poor, cured the sick, and comforted the dying.   You waited with joyful certain, secure in the belief that you would be granted an afterlife of everlasting peace.$B$BYou were betrayed.$B$BI cannot offer you comfort.   Revenge, on the other hand, is well within my power.   Come to the old church in Deathknell, and I will teach you how to inflict deadly damage through the very faith you were taught.$B$B   -Dark Cleric Duesten, Priest Trainer.', 0),
(693, 'Revel in your new state of undeath, and wield your powers to cleanse the world of those who would see us eradicated.   Although our enemies are legion, we will destroy them with flame and shadow.$B$BWhen you are ready for me to teach you the ways of darkness and summoning you will find me in the old Deathknell church.$B$B   -Maximillion, Warlock Trainer.', 0),
(694, 'Get your bones up and out of that crypt; there\'s work to be done!   The Scarlet Crusade moves swiftly against our people, and other humans kill us whenever they can.   We have need of your sword.$B$BWhen you want to learn more of weapons, come find me in the ruined tavern in Deathknell.   I will teach you.$B$B   -Dannal Stern, Warrior Trainer.', 0),
(695, 'Don\'t get all weepy about being undead and losing your family and all that rot.   You live, and that\'s what matters.   Even though you are now undead, possession is still nine tenths of the law.   Sneak past your enemies, or kill them and take what they had.$B$BI can teach you what you need to know about deadly strikes and stealth.   Come look for me in the ruined tavern in Deathknell.$B$B   -David Trias, Rogue Trainer.', 0),
...
(697, 'Diary - Day 512$B$BThe bananas have started talking to me and I have learned a great deal about their culture.  I have ceased my senseless destruction of their homes and consumption of the young.  How little I knew then of the great civilization that I was destroying.$B$BOn another topic I seem to be running low on bottles and paper.  When I first looked at those huge stacks of paper that washed ashore I thought they would be inexhaustible.  Woe with me, my diary must end soon.', 0),
(698, '
...
Just as each is home to its own horrors.  ', 699),
(699, '
...
And truth may hide in such tales--perhaps they are warnings against the worgen, veiled as myths to frighten us.', 701),
...
Such chants are best left unuttered, for wherever Worgen tread, they bring terror and bloodshed with them.', 702),
...
But you will just as quickly see its differences:  that coarse hair surrounds a powerful, two-legged body sporting long fangs and dagger-like claws.  And behind its howl lurks a malevolence possessed by no natural beast.', 703),
...
And for this, we are fortunate.', 704),
(704, 'As mentioned above, some worgen are skilled in mystic arts, and their magic is of darkness and corruption.

Curses and supernatural poisons are common, so be forewarned--those who face worgen magicians should arm themselves with wards against shadow.', 705),
...
They are best left to their world.  For if found in ours and not destroyed, then our peril will be dire...', 0),
(711, 'Helgrum,
...
Good planning.  Well done.', 791),
(793, 'It need not be said that we--those garrisoned at Kargath--are quite happy with our assignment.  We stay tough here, because if we get soft then we die.

And I wouldn\'t have it any other way.

Neeka Bloodscar
Head Scout, Kargath', 0),
(792, 'The Badlands are filled with enemies.  Ogres roam the blistering sands, ambushing the unwary.  Dark Iron dwarves inhabit a barracks east of Kargath and battle their lighter-skinned cousins in Loch Modan to the north.  Brutal, primitive beasts called Troggs haunt any scrap of shade they find and defend it savagely.
...
(791, 'I will describe the surrounding lands as the scouts of Kargath have surveyed:
...
TC = "Toe Curls"', 0),
(752, 'Aye, mon. Take dis letter to Frang in da Valley of Trials. He usually be outside da Den whipping young warriors into shape to fight for da Horde.$B$BHe needs cunning warriors like you to show da orcs how to fight wit sometin\' other den their muscles. You be faster and smarter den most, but don\'t be braggin\' \'bout that--orcs don\' take kindly to insults. They be good allies, an\' maybe they teach you a ting or two also.$B$B-Tar\'sere', 0),
(753, 'Missing Text', 0),
(754, 'Missing Text', 0),
(755, 'Missing Text', 0),
(756, 'Missing Text', 0),
...
I speak now of those beings - the Old Gods.  They who dwelt and raged across Azeroth when the world was new.', 795),
...
And despair they should, for just as fire shows no mercy to a child\'s curious hand, the Old Gods have no care for those beneath them.  At best, we are pawns.  At worst, we are playthings.', 796),
...
Those who try are devoured.  But those who know their place, who kneel in supplication to the servants of the Old Gods, who willingly sacrifice mind and soul... only they will find favor.', 797),
...
(812, 'Dirty troggs are so easy to fool. Their hatred for our kin makes it that much easier to direct them and use them as pawns. Amazes me that any kind of alliance could be forged at all, but our kin pose a much greater threat to their existence... at least for now.$B$BAfter the attacks begin though, both sides are gonna be weakened and prone to our own onslaught. Take the homestead south of Helm\'s Bed Lake and await further instructions.$B$BIronforge will be ours.', 0),
(831, 'In the following pages, you\'ll find a list of the materials necessary to make fire-hardened armor.  Good luck, warrior.


-Furen Longbeard', 832),
(832, 'Scorched Spider Fangs:$B$BThe incendicite ore that is found in a cave near the vicinity of Thelgen Rock has scorched the spiders that dwell there.$B$BThe venom in their fangs boils and reacts with the fangs themselves to create a very tough substance.', 833),
(833, 'Charred Horns:$B$BMuch like the scorched spider fangs, the charred horns of the chimaera that reside in the Charred Vale, in the Stonetalon Mountains on Kalimdor, possess a much-prized quality. $B$BPounded flat and properly treated, they become extremely resilient to physical stress.', 834),
(834, 'Galvanized Horn:$B$BThe rare galvanized horn\'s toughness is the lynchpin of the entire piece of armor I will create, and so it too must be procured.$B$BIt may be gained from the rare chimaera matriarch in the Charred Vale.', 835),
(835, 'Vial of Phlogiston:$B$BThe last stage of creating the armor will require an extremely hot forge. To produce the needed level of heat I must have a vial of phlogiston.$B$BThe only known maker of this substance is the fabled Quilboar, Roogug, and he will not give it up without a fight. Roogug dwells deep in Razorfen Kraul in the southern Barrens.', 0),
...
The venom in their fangs boils and reacts with the fangs themselves to create a very tough substance.', 852),
(852, 'Charred Horns:
...
Pounded flat and properly treated, they become extremely resilient to physical stress.', 853),
(853, 'Galvanized Horn:
...
It may be gained from the rare chimaera matriarch in the Charred Vale.', 854),
...
The only known maker of this substance is the fabled Quilboar, Roogug, and he will not give it up without a fight.  Roogug dwells deep in Razorfen Kraul in the southern Barrens.', 0),
...
This may be gathered from the wilderness, or gained from the Withervine Beasts of Dustwallow Marsh.  It\'s power will be necessary to draw the life essence of Cyclonian to this world.', 857),
(857, 'Bloodscalp Tusks:

The tusks of the Bloodscalp Trolls in Stranglethorn Vale have a rare quality.  The depravation of the Bloodscalps is concentrated in their tusks, and if ground into powder their vile powers may be unleashed.', 858),
...
From the charms, the essence of the exile will form.', 0),
(871, '$N,
...
(931, '$N, below are the items needed to create your armor:
...
...make matters worse, the necklace the gnome made for me has been shattered!  Three of the largest gems set into it have been lost.  I must find them; without them the necklace is powerless...', 971),
(953, 'The Lay of Ameth\'Aran

Long had the children of the stars dwelled upon the banks of the shimmering waters of the eternal well. To all was known that Elune, Light of the Eternal Twilight, Aspect and Goddess of the Moon, dwelt within its waters at such time that she rested from her works. Upon the shores of the well did the children of the stars, favored of elune, build their homes. Even as their gaze was trained ever skyward, into the moonlit night.', 0),
...
...of all things, dwarves!  Three of them, to boot.  They\'re barricaded against the troggs currently.  Calling to them would have been a call for suicide, lest I be overran by the foul troggs in my weakened state.  Once I know the third gem, however, I shall...', 973),
(973, 'Uldaman, Day 6

...so very hungry.  I am out of supplies, and would consider moldy bread to be a feast at this point.  I witnessed a trogg\'s head turn into a juicy steak right in front of my very eyes...', 974),
(974, 'Uldaman, Day 7

...last chance at redemtion for my failures.  I believe the ruby is in the last barricaded area the dwarves have against the troggs.  Their battles, no doubt over the gems and the other artifacts from this site, rage continuously.  It would be just like those vile dwarves to hide it somewhere there.  Regardless, I must make a move one way or another.  Perhaps a mad dash to the surface is the best course...', 0),
...
', 0),
(1131, 'SUPER CRITICAL TRIPLE-ENCODED DATA CARD
...
(1153, 'Am I going mad? Today I severed the head of one of my most trusted patrollers in order to get a better look at their soul. As I peered down their severed breathing passage, it occurred to me: I had not eaten anything in days!
', 1154),
...
<the rest of the pages in the book are missing>', 0),
(1156, 'Curgle, 
...
(1191, 'ULTRA VITAL DATA!  SECURITY RATING 5122!
...
', 1212),
(1212, 'THE SNUFFLENOSE COMMAND STICK(tm)
...
Direction following on next page...', 1213),
...
We are confident that you\'ll find our gophers well trained, useful and squeezably soft additions to your party!', 1214),
...
Happy Hunting!
', 0),
(1231, 'This proof of deed is to verify that $n slew Margol the Rager, scourge of the searing gorge.$B$BThe Ironforge museum recognizes this achievement and thanks the bearer for their generous contribution.$B$B-Head Curator Thorius Stonetender', 0),
(1251, 'These months have given me time to ponder, to shuffle loose my old beliefs and bigotries. Alliance? Horde? Good? Evil? The meanings of these words, once so clear, now blur as my eyes gaze across the boundless sea.$B$BI now know what matters. The bananas are after me.$B$BPerched high in their tree, they eye me with cool malevolence. And the last one I tried to eat nearly gagged me! I could almost hear it scream as I smashed it, half bitten, on sea rocks.$B$BIt\'s war, and I will win it.', 0),
...
(1271, 'The Engineering Disciplines$B$BWhile it is arguable which race first devised the science of engineering on Azeroth, there is little argument as to which races are the main proponents of it in modern times: the gnomes and the goblins.  Their dedication to engineering as a collective whole has not only fueled fantastic inventions in what is arguably a magical Age of Invention, but it also fueled their intense racial rivalry.  Nowhere is this more evident than in their divergent disciplines.', 1272),
(1272, 'Gnome Engineering$B$BThe gnomes as a race tend to excel in the design of items intended to manipulate and control the world around them.  While they maintain a cursory understanding of explosives and weaponry, gnome engineering focuses instead on items that quite literally try to make life easier and more accessible.  It is a discipline of theoretical possibilities made reality through gnomish know-how.  Some possibilities, however, are never fully realized.', 1273),
(1273, 'Goblin Engineering$B$BAs a race that finds itself as neutral in almost every conflict, goblins have taken great steps to turn science into profit.  They embrace the practical applications of engineering, as evident in their radical designs of explosives, firearms, and machinery.  Goblin engineering only maintains a passing interest in engineering theory; their inventions usually don\'t have the issue of not working, but rather working too well.  It is certainly not for the faint of heart.', 1274),
(1274, 'Discipline Study$B$BGnomes and goblins protect their knowledge from each other to such lengths that it is nigh impossible to access both sets of disciplines simultaneously.  Each race, regardless of political affiliations, keeps the knowledge of these disciplines available only to those who agree to forgo pursuit of the other\'s discipline.  If a student chooses to embrace gnome engineering, for example, then no knowledge of goblin engineering will ever be made available to them.', 1275),
(1275, 'Permanent Decisions$B$BThe previous section highlighted an important point about the two engineering disciplines that must be reiterated for the sake of education.  A decision to engage in either of the two disciplines means that the opposing discipline\'s schemata will not be available for study.  While such finality may be daunting to the layman engineer, the seasoned one understands that gnomes and goblins guard their secrets with complete fervor; some knowledge is always better than none.', 1276),
(1276, 'Quotes$B$B"You want to know about goblin engineering?  Try asking one of their best and brightest engineers about it - I think his name is \'Nubby Stumpfingers\'.  Want to know why he\'s named that?  THAT\'S goblin engineering."$B-- Ringo Tragediction, gnome engineer$B$B"Say what you want about us goblins, but I will tell you this: WE HAVE EXPLOSIVES!"$B-- Yazz Nitrospork, goblin bombardier', 1277),
(1277, 'More Quotes!$B$B"Know that feeling you get when you finish making something and turn it on for the first time to experience the power and joy of invention as your device springs to life?  Gnomes don\'t."$B-- Nixx Sprocketspring, Master Goblin Engineer of Gadgetzan$B$B"Engineering is about taking fantasy and making it fantastic!"$B-- Rovis McCrankenspank, gnome inventor', 0),
...
In its fervor, the beast MAY run off cliffs or fall off a mountain. Don\'t mourn the loss of the Felhound Tracker, summon another one instead.', 0),
...
It should be noted that I was the former at one time and as of the writing of this letter, the latter.', 1312),
...
Uggel is a skilled and solemn chiseler, and when not burdened with the dark key, his hands shape great works in the Hall of Crafting.', 0),
...
The soldiers of the West Garrison bow in awe as he passes.  For who among them can look into the eyes of Ofgut and see the secrets the dark key whispers?', 0),
...
The list is contained on the following pages...', 1552),
...
I will need a number of them to test  upon. The spiders having eight possible legs themselves should be no problem for a stalwart warrior or practiced mage.', 1553),
...
Hmmm... never did tell me what caused him to crash... ', 1554),
...
It was while he was traveling along the coast of the Swamp of Sorrows when he thought to attack the creature. He failed and apparently fled, but not before leaving the weapon behind for this murloc to take.', 1556),
...
-Tinkee', 0),
(1711, 'Urgent message to Cliffwatcher Longhorn$b$bA large Centaur force from Camp E\'thok have raided one of our supply caravans. All members of the caravan were lost as well as all supplies. This was a bold, unprecedented attack by the Centaurs and I fear there may be more.', 0),
...
(1757, 'Recovered from the undersea ruins of Suramar, this functional astrolabe was crafted by the highborne night elves nearly twelve thousand years ago. The highborne, obsessed with magic, the occult and astronomy, developed a series of ingenious apparatuses. This device provides invaluable insights into the ancient night elves\' level of scientific understanding.', 0),
(1758, 'These ancient pieces of earthenware were recovered from the Uldaman excavation. Though they hold little in the way of suggestive runes or hieroglyphs, they do provide a telling look at the craftsmanship and day to day accessories of the ancient dwarven race.', 0);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(1759, 'These etched relief runners were perhaps the most significant find within the first chambers of Uldaman. The etchings clearly suggest a tie between the golem-like earthen and the dwarven race. Should further evidence arise, the theories of our supposed creation by the mythic titans could prove to be true.', 0),
(1760, 'Found in the sweltering wastes of the Tanaris desert, this peculiar egg remains a mystery to modern ecologists. Dating tests suggest the egg could be up to a thousand years old. Though certain elements denote insectoid structure, its true origins cannot be discerned.  The species that lays such distinct eggs still remains to be discovered.', 0),
(1761, 'This remnant from the Second War serves as a stirring reminder of just how perilously close the Horde came to conquering Ironforge Mountain.', 0),
(1762, 'These demon plates were worn by the creature that first cursed our people with bloodlust. By the heroic act of one brave orc - he was defeated. Mannoroth the Destructor is no more. Let these plates always remind us of how far we\'ve come and how hard we fought to regain our honor.$B$B$B$B- Thrall, Warchief of the Horde', 0),
(1771, 'This remnant from the Second War serves as a stirring reminder of just how perilously close the Horde came to conquering Ironforge Mountain.', 0),
(1772, 'Wyrmthalak, I have been given direct orders from your master, Nefarian, to punish you as I see fit should any more outsiders make it inside the citadel. Do not forget whom commands you, reptile. The son of Blackhand: Master of blade and battle. The one true Warchief. -Rend', 0),
(1773, 'Over time, demonic entities made their way into the Titans\' worlds from the Twisting Nether, and the Pantheon elected its greatest warrior, Sargeras, to act as its first line of defense. A noble giant of molten bronze, Sargeras carried out his duties for countless millennia, seeking out and destroying these demons wherever he could find them. Over the eons, Sargeras encountered two powerful demonic races, both of which were bent on gaining power and dominance over the physical universe.', 1774),
(1774, 'The eredar, an insidious race of devilish sorcerers, used their warlock magics to invade and enslave a number of worlds. The indigenous races of those worlds were mutated by the eredar\'s malevolent powers and turned into demons themselves.', 1775),
(1775, 'Though Sargeras\' nearly limitless powers were more than enough to defeat the vile eredar, he was greatly troubled by the creatures\' corruption and all-consuming evil. Incapable of fathoming such depravity, the great Titan began to slip into a brooding depression. Despite his growing unease, Sargeras rid the universe of the warlocks by trapping them within a corner of the Twisting Nether.', 1776),
(1776, 'While his confusion and misery deepened, Sargeras was forced to contend with another group intent on disrupting the Titans\' order: the Nathrezim. This dark race of vampiric demons (also known as dreadlords) conquered a number of populated worlds by possessing their inhabitants and turning them to the shadow. ', 1777),
(1777, 'The nefarious, scheming dreadlords turned whole nations against one another by manipulating them into unthinking hatred and mistrust. Sargeras defeated the Nathrezim easily, but their corruption affected him deeply.', 1778),
(1778, 'As doubt and despair overwhelmed Sargeras\' senses, he lost all faith not only in his mission, but also in the Titans\' vision of an ordered universe. Eventually he came to believe that the concept of order itself was folly, and that chaos and depravity were the only absolutes within the dark, lonely universe. ', 1779),
(1779, 'His fellow Titans tried to persuade him of his error and calm his raging emotions, but he disregarded their more optimistic beliefs as self-serving delusions. Storming from their ranks forever, Sargeras set out to find his own place in the universe. Although the Pantheon was sorrowful at his departure, the Titans could never have predicted just how far their lost brother would go.', 1780),
(1780, 'By the time Sargeras\' madness had consumed the last vestiges of his valiant spirit, he believed that the Titans themselves were responsible for creation\'s failure. Deciding, at last, to undo their works throughout the universe, he resolved to form an unstoppable army that would set the physical universe aflame.', 1781),
(1781, 'Even Sargeras\' titanic form became distorted from the corruption that plagued his once-noble heart. His eyes, hair, and beard erupted in fire, and his metallic bronze skin split open to reveal an endless furnace of blistering hate.', 1782),
(1782, 'In his fury, Sargeras shattered the prisons of the eredar and the Nathrezim and set the loathsome demons free. These cunning creatures bowed before the dark Titan\'s vast rage and offered to serve him in whatever malicious ways they could. From the ranks of the powerful Eredar, Sargeras picked two champions to command his demonic army of destruction. ', 1783),
(1783, 'Kil\'jaeden the Deceiver was chosen to seek out the darkest races in the universe and recruit them into Sargeras\' ranks. The second champion, Archimonde the Defiler, was chosen to lead Sargeras\' vast armies into battle against any who might resist the Titan\'s will. ', 1784),
(1784, 'Kil\'jaeden\'s first move was to enslave the vampiric dreadlords under his terrible power. The dreadlords served as his personal agents throughout the universe, and they took pleasure in locating primitive races for their master to corrupt and bring into the fold. First amongst the dreadlords was Tichondrius the Darkener. Tichondrius served Kil\'jaeden as the perfect soldier and agreed to bring Sargeras\' burning will to all the dark corners of the universe.', 1785),
(1785, 'The mighty Archimonde also empowered agents of his own. Calling upon the malefic pit lords and their barbarous leader, Mannoroth the Destructor, Archimonde hoped to establish a fighting elite that would scour creation of all life.', 1786),
(1786, 'Once Sargeras saw that his armies were amassed and ready to follow his every command, he launched his raging forces into the vastness of the Great Dark. He referred to his growing army as the Burning Legion. To this date, it is still unclear how many worlds they consumed and burned on their unholy Burning Crusade across the universe.', 0),
(1787, 'Unaware of Sargeras\' mission to undo their countless works, the Titans continued to move from world to world, shaping and ordering each planet as they saw fit. Along their journey they happened upon a small world that its inhabitants would later name Azeroth. ', 1788),
(1788, 'As the Titans made their way across the primordial landscape, they encountered a number of hostile elemental beings. These elementals, who worshipped a race of unfathomably evil beings known only as the Old Gods, vowed to drive the Titans back and keep their world inviolate from the invaders\' metallic touch. ', 1789),
(1789, 'The Pantheon, disturbed by the Old Gods\' penchant for evil, waged war upon the elementals and their dark masters. The Old Gods\' armies were led by the most powerful elemental lieutenants: Ragnaros the Firelord, Therazane the Stonemother, Al\'Akir the Windlord, and Neptulon the Tidehunter. ', 1790),
(1790, 'Their chaotic forces raged across the face of the world and clashed with the colossal Titans. Though the elementals were powerful beyond mortal comprehension, their combined forces could not stop the mighty Titans. One by one, the elemental lords fell, and their forces dispersed. ', 1791),
(1791, 'The Pantheon shattered the Old Gods\' citadels and chained the five evil gods far beneath the surface of the world. Without the Old Gods\' power to keep their raging spirits bound to the physical world, the elementals were banished to an abyssal plane, where they would contend with one another for all eternity. With the elementals\' departure, nature calmed, and the world settled into a peaceful harmony. The Titans saw that the threat was contained and set to work.', 1792),
(1792, 'The Titans empowered a number of races to help them fashion the world. To help them carve out the fathomless caverns beneath the earth, the Titans created the dwarf-like earthen from magical, living stone. To help them dredge out the seas and lift the land from the sea floor, the Titans created the immense but gentle sea giants. For many ages the Titans moved and shaped the earth, until at last there remained one perfect continent. ', 1793),
(1793, 'At the continent\'s center, the Titans crafted a lake of scintillating energies. The lake, which they named the Well of Eternity, was to be the fount of life for the world. Its potent energies would nurture the bones of the world and empower life to take root in the land\'s rich soil. Over time, plants, trees, monsters, and creatures of every kind began to thrive on the primordial continent. ', 1794),
(1794, 'As twilight fell on the final day of their labors, the Titans named the continent Kalimdor: "land of eternal starlight". ', 0),
(1795, 'Satisfied that the small world had been ordered and that their work was done, the Titans prepared to leave Azeroth. However, before they departed, they charged the greatest species of the world with the task of watching over Kalimdor, lest any force should threaten its perfect tranquility. In that age, there were many dragonflights. ', 1796),
(1796, 'Yet there were five flights that held dominion over their brethren. It was these five flights that the Titans chose to shepherd the budding world. The greatest members of the Pantheon imbued a portion of their power upon each of the flights\' leaders. These majestic dragons (as listed below) became known as the Great Aspects, or the Dragon Aspects. ', 1797),
(1797, 'Aman\'Thul, the Highfather of the Pantheon, bestowed a portion of his cosmic power upon the massive bronze dragon, Nozdormu. The Highfather empowered Nozdormu to guard time itself and police the ever-spinning pathways of fate and destiny. The stoic, honorable Nozdormu became known as the Timeless One.', 1798),
(1798, 'Eonar, the Titan patron of all life, gave a portion of her power to the red leviathan, Alexstrasza. Ever after, Alexstrasza would be known as the Life-Binder, and she would work to safeguard all living creatures within the world. Due to her supreme wisdom and limitless compassion for all living things, Alexstrasza was crowned the Dragonqueen and given dominion over her kind.', 1799),
(1799, 'Eonar also blessed Alexstrasza\'s younger sister, the lithe green dragon Ysera, with a portion of nature\'s influence. Ysera fell into an eternal trance, bound to the waking Dream of Creation. Known as the Dreamer, she would watch over the growing wilds of the world from her verdant realm, the Emerald Dream. ', 1800),
(1800, 'Norgannon, the Titan lore keeper and master-magician, granted the blue dragon, Malygos, a portion of his vast power. From then on, Malygos would be known as the Spell-Weaver, the guardian of magic and hidden arcanum.', 1801),
(1801, 'Khaz\'goroth, the Titan shaper and forger of the world, bestowed some of his vast power upon the mighty black wyrm, Neltharion. The great-hearted Neltharion, known afterwards as the Earth-Warder, was given dominion over the earth and the deep places of the world. He embodied the strength of the world and served as Alexstrasza\'s greatest supporter.', 1802),
(1802, 'Thus empowered, the Five Aspects were charged with the world\'s defense in the Titans\' absence. With the dragons prepared to safeguard their creation, the Titans left Azeroth behind forever. Unfortunately it was only a matter of time before Sargeras learned of the newborn world\'s existence.... ', 0),
(1803, 'The Highborne\'s reckless use of magic sent ripples of energy spiraling out from the Well of Eternity and into the Great Dark Beyond. The streaming ripples of energy were felt by terrible alien minds. Sargeras - the Great Enemy of all life, the Destroyer of Worlds - felt the potent ripples and was drawn to their distant point of origin. ', 1804),
(1804, 'Spying the primordial world of Azeroth and sensing the limitless energies of the Well of Eternity, Sargeras was consumed by an insatiable hunger. The great dark god of the Nameless Void resolved to destroy the fledgling world and claim its energies as his own. ', 1805),
(1805, 'Sargeras gathered his vast Burning Legion and made his way towards the unsuspecting world of Azeroth. The Legion was comprised of a million screaming demons, all ripped from the far corners of the universe, and the demons hungered for conquest. Sargeras\' lieutenants, Archimonde the Defiler and Mannoroth the Destructor, prepared their infernal minions to strike. ', 1806),
(1806, 'Queen Azshara, overwhelmed by the terrible ecstasy of her magic, fell victim to Sargeras\' undeniable power and agreed to grant him entrance to her world. Even her Highborne servitors gave themselves over to magic\'s inevitable corruption and began to worship Sargeras as their god. To show their allegiance to the Legion, the Highborne aided their queen in opening a vast, swirling portal within the depths of the Well of Eternity. ', 1807),
(1807, 'Once all his preparations had been made, Sargeras began his catastrophic invasion of Azeroth. The warrior-demons of the Burning Legion stormed into the world through the Well of Eternity and laid siege to the night elves\' sleeping cities. Led by Archimonde and Mannoroth, the Legion swarmed over the lands of Kalimdor, leaving only ash and sorrow in its wake. ', 1808),
(1808, 'The demon warlocks called down searing infernals that crashed like hellish meteors into the graceful spires of Kalimdor\'s temples. A band of burning, bloodletting killers known as the Doomguard marched across Kalimdor\'s fields, slaughtering everyone in their path. Packs of wild, demonic felhounds ravaged the countryside unopposed. Though the brave Kaldorei warriors rushed to defend their ancient homeland, they were forced to give ground, inch by inch, before the fury of the Legion\'s onslaught.', 1809),
(1809, 'It fell to Malfurion Stormrage to find help for his beleaguered people. Stormrage, whose own brother, Illidan, practiced the Highborne\'s magics, was incensed by the growing corruption amongst the upper class. Convincing Illidan to forsake his dangerous obsession, Malfurion set out to find Cenarius and muster a resistance force. ', 1810),
(1810, 'The beautiful young priestess, Tyrande, agreed to accompany the brothers in the name of Elune. Though Malfurion and Illidan shared a love for the idealistic priestess, Tyrande\'s heart belonged to Malfurion alone. Illidan resented his brother\'s budding romance with Tyrande, but knew that his heartache was nothing compared to the pain of his magical addiction. ', 1811),
(1811, 'Illidan, who had grown dependent on magic\'s empowering energies, struggled to keep control of his nearly overwhelming hunger to tap the Well\'s energies once again. However, with Tyrande\'s patient support, he was able to restrain himself and help his brother find the reclusive demigod, Cenarius. ', 1812),
(1812, 'Cenarius, who dwelt within the sacred Moonglades of the distant Mount Hyjal, agreed to help the night elves by finding the ancient dragons and enlisting their aid. The dragons, led by the great red leviathan, Alexstrasza, agreed to send their mighty flights to engage the demons and their infernal masters.', 1813),
(1813, 'Cenarius, calling on the spirits of the enchanted forests, rallied an army of ancient tree-men and led them against the Legion in a daring ground assault. As the night elves\' allies converged upon Azshara\'s temple and the Well of Eternity, all-out warfare erupted. Despite the strength of their newfound allies, Malfurion and his colleagues realized that the Legion could not be defeated by martial strength alone. ', 1814),
(1814, 'As the titanic battle raged around Azshara\'s capital city, the delusional queen waited in anticipation for Sargeras\' arrival. The lord of the Legion was preparing to pass through the Well of Eternity and enter the ravaged world. As his impossibly huge shadow drew ever closer to the Well\'s surface, Azshara gathered the most powerful of her Highborne followers. Only by linking their magics together in one focused spell would they be able to create a gateway large enough for Sargeras to enter.', 1815),
(1815, 'As the battle raged across the burning fields of Kalimdor, a terrible turn of events unfolded. The details of the event have been lost to time, but it is known that Neltharion, the Dragon Aspect of the Earth, went mad during a critical engagement against the Burning Legion. He began to split apart as flame and rage erupted from his dark hide. Renaming himself Deathwing, the burning dragon turned on his brethren and drove the five dragonflights from the field of battle. ', 1816),
(1816, 'Deathwing\'s sudden betrayal was so destructive that the five dragonflights never truly recovered. Wounded and shocked, Alexstrasza and the other noble dragons were forced to abandon their mortal allies. Malfurion and his companions, now hopelessly outnumbered, barely survived the ensuing onslaught. ', 1817),
(1817, 'Malfurion, convinced that the Well of Eternity was the demons\' umbilical link to the physical world, insisted that it should be destroyed. His companions, knowing that the Well was the source of their immortality and powers, were horrified by the rash notion. Yet Tyrande saw the wisdom of Malfurion\'s theory, so she convinced Cenarius and their comrades to storm Azshara\'s temple and find a way to shut the Well down for good.', 0),
(1828, 'The few night elves that survived the horrific explosion rallied together on crudely made rafts and slowly made their way to the only landmass in sight. Somehow, by the grace of Elune, Malfurion, Tyrande, and Cenarius had survived the Great Sundering. The weary heroes agreed to lead their fellow survivors and establish a new home for their people. ', 1829),
(1829, 'As they journeyed in silence, they surveyed the wreckage of their world and realized that their passions had wrought the destruction all around them. Though Sargeras and his Legion had been ripped from the world by the Well\'s destruction, Malfurion and his companions were left to ponder the terrible cost of victory. ', 1830),
(1830, 'There were many Highborne who did survive the cataclysm unscathed. They made their way to the shores of the new land along with the other night elves. Though Malfurion mistrusted the Highborne\'s motivations, he was satisfied that they could cause no real mischief without the Well\'s energies.', 1831),
(1831, 'As the weary mass of night elves landed upon the shores of the new land, they found that the holy mountain, Hyjal, had survived the catastrophe. Seeking to establish a new home for themselves, Malfurion and the night elves climbed the slopes of Hyjal and reached its windswept summit. As they descended into the wooded bowl, nestled between the mountain\'s enormous peaks, they found a small, tranquil lake. To their horror, they found that the lake\'s waters had been fouled by magic.', 1832),
(1832, 'Illidan, having survived the Sundering as well, had reached Hyjal summit long before Malfurion and the night elves. In his mad bid to maintain the flows of magic in the world, Illidan had poured his vials, which contained the precious waters from the Well of Eternity, into the mountain lake. ', 1833),
(1833, 'The Well\'s potent energies quickly ignited and coalesced into a new Well of Eternity. The exultant Illidan, believing that the new Well was a gift to future generations, was shocked when Malfurion hunted him down. Malfurion explained to his brother that magic was innately chaotic and that its use would inevitably lead to widespread corruption and strife. Still, Illidan refused to relinquish his magical powers.', 1834),
(1834, 'Knowing full well where Illidan\'s ruthless schemes would eventually lead, Malfurion decided to deal with his power-crazed brother once and for all. With Cenarius\' help, Malfurion sealed Illidan within a vast underground barrow prison, where he would remain chained and powerless until the end of time. To ensure his brother\'s containment, Malfurion empowered the young warden, Maiev Shadowsong, to be Illidan\'s personal jailor.', 1835),
(1835, 'Concerned that destroying the new Well might bring about an even greater catastrophe, the night elves resolved to leave it be. However, Malfurion declared that they would never practice the arts of magic again. Under Cenarius\' watchful eye, they began to study the ancient arts of druidism that would enable them to heal the ravaged earth and re-grow their beloved forests at the base of Mount Hyjal.', 0),
(1836, 'For many years, the night elves worked tirelessly to rebuild what they could of their ancient homeland. Leaving their broken temples and roads to be overgrown, they constructed their new homes amidst the verdant trees and shadowed hills at Hyjal\'s base. In time, the dragons that had survived the great Sundering came forth from their secret abodes. ', 1837),
(1837, 'Alexstrasza the red, Ysera the green, and Nozdormu the bronze descended upon the druids\' tranquil glades and surveyed the fruits of the night elves\' labors. Malfurion, who had become an arch-druid of immense power, greeted the mighty dragons and told them about the creation of the new Well of Eternity. ', 1838),
(1838, 'The great dragons were alarmed to hear the dark news and speculated that as long as the Well remained, the Legion might one day return and assault the world once again. Malfurion and the three dragons made a pact to keep the Well safe and ensure that the agents of the Burning Legion would never find their way back into the world.', 1839),
(1839, 'Alexstrasza, the Lifebinder, placed a single, enchanted acorn within the heart of the Well of Eternity. The acorn, activated by the potent, magical waters, sprung to life as a colossal tree. The mighty tree\'s roots grew from the Well\'s waters, and its verdant canopy seemed to scrape the roof of the sky. ', 1840),
(1840, 'The immense tree would be an everlasting symbol of the night elves\' bond with nature, and its life-giving energies would extend out to heal the rest of the world over time. The night elves\' gave their World Tree the new name Nordrassil, which meant "crown of the heavens" in their native tongue. ', 1841),
(1841, 'Nozdormu, the Timeless, placed an enchantment upon the World Tree to ensure that as long as the colossal tree stood, the night elves would never age or fall prey to sickness or disease. ', 1842),
(1842, 'Ysera, the Dreamer, also placed an enchantment upon the World Tree by linking it to her own realm, the ethereal dimension known as the Emerald Dream. The Emerald Dream, a vast, ever-changing spirit world, existed outside the boundaries of the physical world. From the Dream, Ysera regulated the ebb and flow of nature and the evolutionary path of the world itself. ', 1843),
(1843, 'The night elf druids, including Malfurion himself, were bound to the Dream through the World Tree. As part of the mystical pact, the druids agreed to sleep for centuries at a time so that their spirits could roam the infinite paths of Ysera\'s Dreamways. Though the druids were grieved at the prospect of losing so many years of their lives to hibernation, they selflessly agreed to uphold their bargain with Ysera.', 0),
(1844, 'As the centuries passed, the night elves\' new society grew strong and expanded throughout the budding forest that they came to call Ashenvale. Many of the creatures and species that were abundant before the Great Sundering, such as furbolgs and quilboars, reappeared and flourished in the land. Under the druids\' benevolent leadership, the night elves enjoyed an era of unprecedented peace and tranquility under the stars.', 1845),
(1845, 'However, many of the original Highborne survivors grew restless. Like Illidan before them, they fell victim to the withdrawal that came from the loss of their coveted magics. They were tempted to tap the energies of the Well of Eternity and exult in their magical practices. Dath\'Remar, the brash, outspoken leader of the Highborne, began to mock the druids publicly, calling them cowards for refusing to wield the magic that he said was theirs by right. ', 1846),
(1846, 'Malfurion and the druids dismissed Dath\'Remar\'s arguments and warned the Highborne that any use of magic would be punishable by death. In an insolent and ill-fated attempt to convince the druids to rescind their law, Dath\'Remar and his followers unleashed a terrible magical storm upon Ashenvale.', 1847),
(1847, 'The druids could not bring themselves to put so many of their kin to death, so they decided to exile the reckless Highborne from their lands. Dath\'Remar and his followers, glad to be rid of their conservative cousins at last, boarded a number of specially crafted ships and set sail upon the seas. Though none of them knew what awaited them beyond the waters of the raging Maelstrom, they were eager to establish their own homeland, where they could practice their coveted magics with impunity. ', 1848),
(1848, 'The Highborne, or Quel\'dorei, as Azshara had named them in ages past, would eventually set shore upon the eastern land men would call Lordaeron. They planned to build their own magical kingdom, Quel\'Thalas, and reject the night elves\' precepts of moon worship and nocturnal activity. Forever after, they would embrace the sun and be known only as the high elves. ', 0),
(1849, 'With the departure of their wayward cousins, the night elves turned their attention back to the safekeeping of their enchanted homeland. The druids, sensing that their time of hibernation was drawing near, prepared to sleep and leave their loved ones and families behind. ', 1850),
(1850, 'Tyrande, who had become the High Priestess of Elune, asked her love, Malfurion, not to leave her for Ysera\'s Emerald Dream. But Malfurion, honor bound to enter the changing Dreamways, bid the priestess farewell and swore that they would never be apart so long as they held true to their love. ', 1851),
(1851, 'Left alone to protect Kalimdor from the dangers of the new world, Tyrande assembled a powerful fighting force from amongst her night elf sisters. The fearless, highly trained warrior women who pledged themselves to Kalimdor\'s defense became known as the Sentinels. Though they preferred to patrol the shadowy forests of Ashenvale on their own, they had many allies upon which they could call in times of urgency. ', 1852),
(1852, 'The demigod Cenarius remained nearby in the Moonglades of Mount Hyjal. His sons, known as the Keepers of the Grove, kept close watch on the night elves and regularly helped the Sentinels maintain peace in the land. Even Cenarius\' shy daughters, the dryads, appeared in the open with increasing frequency.', 1853),
(1853, 'The task of policing Ashenvale kept Tyrande busy, but without Malfurion at her side, she knew little joy. As the long centuries passed while the druids slept, her fears of a second demonic invasion grew. She could not shake the unnerving feeling that the Burning Legion might still be out there, beyond the Great Dark of the sky, plotting its revenge upon the night elves and the world of Azeroth.', 0),
(1854, 'The high elves, led by Dath\'Remar, left Kalimdor behind them and challenged the storms of the Maelstrom. Their fleets wandered the wreckage of the world for many long years, and they discovered mysteries and lost kingdoms along their sojourn. Dath\'Remar, who had taken the name Sunstrider (or "he who walks the day"), sought out places of considerable ley power upon which to build a new homeland for his people.', 1855),
(1855, 'His fleet finally landed on the beaches of the kingdom men would later call Lordaeron. Forging inland, the high elves founded a settlement within the tranquil Tirisfal Glades. After a few years, many of them began to go mad. It was theorized that something evil slept beneath that particular part of the world, but the rumors were never proven to be true. The high elves packed up their encampment and moved northward towards another land rich with ley energies.', 1856),
(1856, 'As the high elves crossed the rugged, mountainous lands of Lordaeron, their journey became more perilous. Since they were effectively cut off from the life-giving energies of the Well of Eternity, many of them fell ill from the frigid climate or died from starvation. The most disconcerting change, however, was the fact that they were no longer immortal or immune to the elements. ', 1857),
(1857, 'They also shrank somewhat in height, and their skin lost its characteristic violet hue. Despite their hardships, they encountered many wondrous creatures that had never been seen in Kalimdor. They also found tribes of primitive humans who hunted throughout the ancient forestlands. However, the direst threat they encountered were the voracious and cunning forest trolls of Zul\'Aman.', 1858),
(1858, 'These moss-skinned trolls could regenerate lost limbs and heal grievous physical injuries, but they proved to be a barbaric, evil race. The Amani empire stretched across most of northern Lordaeron, and the trolls fought hard to keep unwanted strangers from their borders. The elves developed a deep loathing for the vicious trolls and killed them on sight whenever they were encountered.', 1859),
(1859, 'After many long years, the high elves finally found a land which was reminiscent of Kalimdor. Deep within the northern forests of the continent, they founded the kingdom of Quel\'Thalas and vowed to create a mighty empire which would dwarf that of their Kaldorei cousins. Unfortunately they soon learned that Quel\'Thalas was founded upon an ancient troll city that the trolls still held to be sacred. Almost immediately, the trolls began to attack the elven settlements en masse. ', 1860),
(1860, 'The stubborn elves, unwilling to give up their new land, utilized the magics which they had gleaned from the Well of Eternity and kept the savage trolls at bay. Under Dath\'Remar\'s leadership, they were able to defeat the Amani warbands that outnumbered them ten to one. Some elves, wary of the Kaldorei\'s ancient warnings, felt that their use of magic might possibly draw the attention of the banished Burning Legion. ', 1861),
(1861, 'Therefore, they decided to mask their lands within a protective barrier which would still allow them to work their enchantments. They constructed a series of monolithic Runestones at various points around Quel\'Thalas which marked the boundaries of the magic barrier. The Runestones not only masked the elves\' magic from extra-dimensional threats, but helped to frighten away the superstitious troll warbands as well.', 1862),
(1862, 'As time wore on, Quel\'Thalas became a shining monument to the high elves\' efforts and magical prowess. Its beauteous palaces were crafted in the same architectural style as the ancient halls of Kalimdor, yet they were interwoven with the natural topography of the land. Quel\'Thalas had become the shining jewel that the elves had longed to create. ', 1863),
(1863, 'The Convocation of Silvermoon was founded as the ruling power over Quel\'Thalas, though the Sunstrider Dynasty maintained a modicum of political power. Comprised of seven of the greatest high elf lords, the Convocation worked to secure the safety of the elven lands and people. Surrounded by their protective barrier, the high elves remained unmoved by the old warnings of the Kaldorei and continued to use magic flagrantly in almost all aspects of their lives. ', 1864),
(1864, 'For nearly four thousand years the high elves lived peacefully within the secluded safety of their kingdom. Nevertheless, the vindictive trolls were not so easily defeated. They plotted and schemed in the depths of the forests and waited for the numbers of their warbands to grow. Finally, a mighty troll army charged out from the shadowy forests and once again laid siege to the shining spires of Quel\'Thalas. ', 0),
(1865, 'As the high elves fought for their lives against the trolls\' fierce onslaught, the scattered, nomadic humans of Lordaeron fought to consolidate their own tribal lands. The tribes of early humanity raided each other\'s settlements with little heed for racial unification or honor. ', 1866),
(1866, 'Yet one tribe, known as the Arathi, saw that the trolls were becoming too great a threat to ignore. The Arathi wished to bring all of the tribes under its rule so that they could provide a unified front against the troll warbands.', 1867),
(1867, 'Over the course of six years, the cunning Arathi outmaneuvered and outfought the rival tribes. After every victory, the Arathi offered peace and equality to the conquered people; thus, they won the loyalty of those they had beaten. Eventually the Arathi tribe came to include many disparate tribes, and the ranks of its army grew vast. ', 1868),
(1868, 'Confident that they could hold their own against the troll warbands or even the reclusive elves if need be, the Arathi warlords decided to construct a mighty fortress city in the southern regions of Lordaeron. The city-state, named Strom, became the capital of the Arathi nation, Arathor. As Arathor prospered, humans from all over the vast continent traveled south to the protection and safety of Strom.', 1869),
(1869, 'United under one banner, the human tribes developed a strong, optimistic culture. Thoradin, the king of Arathor, knew that the mysterious elves in the northlands were under constant siege by the trolls, but refused to risk the safety of his people in defense of reclusive strangers. Many months passed as rumors of the elves\' supposed defeat trickled down from the north. It was only when weary ambassadors from Quel\'Thalas reached Strom that Thoradin realized how great the troll threat truly was.', 1870),
(1870, 'The elves informed Thoradin that the troll armies were vast and that once the trolls had destroyed Quel\'Thalas, they would move on to attack the southlands. The desperate elves, in dire need of military aid, hastily agreed to teach certain select humans to wield magic in exchange for their help against the warbands. ', 1871),
(1871, 'Thoradin, distrustful of any magic, agreed to aid the elves out of necessity. Almost immediately, elven sorcerers arrived in Arathor and began to instruct a group of humans in the ways of magic.', 1872),
(1872, 'The elves found that although humans were innately clumsy in their handling of magic, they possessed a startling natural affinity for it. One hundred men were taught the very basics of the elves\' magical secrets: no more than was absolutely necessary to combat the trolls. Convinced that their human students were ready to aid in the struggle, the elves left Strom and traveled north alongside the mighty armies of King Thoradin. ', 1873),
(1873, 'The united elf and human armies clashed against the overwhelming troll warbands at the foot of the Alterac Mountains. The battle lasted for many days, but the unflagging armies of Arathor never tired or gave an inch of ground before the troll onslaught. The elven lords deemed that the time had come to release the powers of their magic upon the enemy. ', 1874),
(1874, 'The hundred human magi and a multitude of elven sorcerers called down the fury of the heavens and set the troll armies ablaze. The elemental fires prevented the trolls from regenerating their wounds and burned their tortured forms from the inside out.', 1875),
(1875, 'As the troll armies broke and attempted to flee, Thoradin\'s armies ran them down and slaughtered every last one of their soldiers. The trolls would never fully recover from their defeat, and history would never see the trolls rise as one nation again. Assured that Quel\'Thalas was saved from destruction, the elves made a pledge of loyalty and friendship to the nation of Arathor and to the bloodline of its king, Thoradin. Humans and elves would nurture peaceful relations for ages to come. 
', 0),
(1876, 'With the absence of trolls in the northlands, the elves of Quel\'Thalas bent their efforts towards rebuilding their glorious homeland. The victorious armies of Arathor returned home to southlands of Strom. ', 1877);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(1877, 'The human society of Arathor grew and prospered, yet Thoradin, fearful that his kingdom would splinter apart if it overextended itself, maintained that Strom was the center of the Arathorian empire. After many peaceful years of growth and commerce, mighty Thoradin died of old age, leaving Arathor\'s younger generation free to expand the empire beyond the lands of Strom.', 1878),
(1878, 'The original hundred magi, who were tutored in the ways of magic by the elves, expanded their powers and studied the mystic disciplines of spell-weaving in much greater detail. These magi, initially chosen for their strong wills and noble spirits, had always practiced their magic with care and responsibility; however, they passed their secrets and powers onto a newer generation that had no concept of the rigors of war or the necessity for self-restraint. ', 1879),
(1879, 'These younger magicians began to practice magic for personal gain rather than out of any responsibility towards their fellows. ', 1880),
(1880, 'As the empire grew and expanded into new lands, the young magicians also spread out into the southlands. Wielding their mystical powers, the magicians protected their brethren from the wild creatures of the land and made it possible for new city-states to be constructed in the wilderness. Yet, as their powers grew, the magicians became ever more conceited and isolated from the rest of society.', 1881),
(1881, 'The second Arathorian city-state of Dalaran was founded in the lands north of Strom. Many fledgling wizards left the restraining confines of Strom behind and traveled to Dalaran, where they hoped to use their new powers with greater freedom. These magicians used their skills to build up the enchanted spires of Dalaran and reveled in the pursuit of their studies. ', 1882),
(1882, 'The citizens of Dalaran tolerated the magicians\' endeavors and built up a bustling economy under the protection of their magic-using defenders. Yet, as more and more magicians practiced their arts, the fabric of reality around Dalaran began to weaken and tear.', 1883),
(1883, 'The sinister agents of the Burning Legion, who had been banished when the Well of Eternity collapsed, were lured back into the world by the heedless spellcasting of the magicians of Dalaran. Though these relatively weak demons did not appear in force, they did sew considerable confusion and chaos within the streets of Dalaran. ', 1884),
(1884, 'Most of these demonic encounters were isolated events, and the ruling Magocrats did what they could to keep such events hidden from the public. The most powerful magicians were sent to capture the elusive demons, but they often found themselves hopelessly outmatched by the lone agents of the mighty Legion.', 1885),
(1885, 'After a few months the superstitious peasantry began to suspect that their sorcerous rulers were hiding something terrible from them. Rumors of revolution began to sweep through the streets of Dalaran as the paranoid citizenry questioned the motives and practices of the magicians they had once admired. The Magocrats, fearing that the peasants would revolt and that Strom would take action against them, turned to the only group they felt would understand their particular problem: the elves.', 1886),
(1886, 'Upon hearing the Magocrats\' news of demonic activity in Dalaran, the elves quickly dispatched their mightiest wizards to the human lands. The elven wizards studied the energy currents in Dalaran and made detailed reports of all demonic activity that they beheld. They concluded that although there were only a few demons loose in the world, the Legion itself would remain a dire threat so long as humans continued to wield the forces of magic. ', 1887),
(1887, 'The Council of Silvermoon, which ruled over the elves of Quel\'Thalas, entered into a secret pact with the Magocrat lords of Dalaran. The elves told the Magocrats about the history of ancient Kalimdor and of the Burning Legion, a history which still threatened the world. They informed the humans that so long as they used magic, they would need to protect their citizenry from the malicious agents of the Legion. ', 1888),
(1888, 'The Magocrats proposed the notion of empowering a single mortal champion who would utilize their powers in order to fight a never-ending secret war against the Legion. It was stressed that the majority of mankind could never know about the Guardians or the threat of the Legion for fear that they would riot in fear and paranoia. The elves agreed to the proposal and founded a secret society that would watch over the selection of the Guardian and help to stem the rise of chaos in the world.', 1889),
(1889, 'The society held its secret meetings in the shadowed Tirisfal Glades, where the high elves had first settled in Lordaeron. Thus, they named the secret sect the Guardians of Tirisfal. The mortal champions who were chosen to be Guardians were imbued with incredible powers of both elven and human magic. Though there would only ever be one Guardian at a time, they held such vast power that they could single-handedly fight back the Legion\'s agents wherever they were found in the world. ', 1890),
(1890, 'The Guardian power was so great that only the Council of Tirisfal was allowed to choose potential successors to the mantle of Guardianship. Whenever a Guardian grew too old, or wearied of the secret war against chaos, the Council chose a new champion, and under controlled conditions, formally channeled the Guardian power into its new agent.', 1891),
(1891, 'As the generations passed, Guardians defended the masses of humanity from the invisible threat of the Burning Legion throughout the lands of Arathor and Quel\'Thalas. Arathor grew and prospered while the use of magic spread throughout the empire. Meanwhile, the Guardians kept careful watch for signs of demonic activity. ', 0),
(1892, 'In the ancient times, after the Titans departed Azeroth, their children, known as the earthen, continued to shape and guard the deep recesses of the world. The earthen were largely unconcerned with the affairs of the surface-dwelling races and longed only to plumb the dark depths of the earth. ', 1893),
(1893, 'When the world was sundered by the Well of Eternity\'s implosion, the earthen were deeply affected. Reeling with the pain of the earth itself, the earthen lost much of their identity and sealed themselves within the stone chambers where they were first created. Uldaman, Uldum, Ulduar... these were the names of the ancient Titan cities where the earthen first took shape and form. Buried deep beneath the world, the earthen rested in peace for nearly eight thousand years. ', 1894),
(1894, 'Though it is unclear what awakened them, the earthen sealed within Uldaman eventually arose from their self-imposed slumber. These earthen found that they had changed significantly during their hibernation. Their rocky hides had softened and become smooth skin, and their powers over stone and earth had waned. They had become mortal creatures.', 1895),
(1895, 'Calling themselves dwarves, the last of the earthen left the halls of Uldaman and ventured out into the waking world. Still lulled by the safety and wonders of the deep places, they founded a vast kingdom under the highest mountain in the land. ', 1896),
(1896, 'They named their land Khaz Modan, or "Mountain of Khaz", in honor of the Titan shaper, Khaz\'goroth. Constructing an altar for their Titan father, the dwarves crafted a mighty forge within the heart of the mountain. Thus, the city that grew around the forge would be called Ironforge ever after.', 1897),
(1897, 'The dwarves, by nature fascinated with shaping gems and stone, set out to mine the surrounding mountains for riches and precious minerals. Content with their labors under the world, the dwarves remained isolated from the affairs of their surface-dwelling neighbors.', 0),
(1898, 'Strom continued to act as the central hub of Arathor, but as with Dalaran, many new city-states arose across the continent of Lordaeron. Gilneas, Alterac, and Kul Tiras were the first city-states to arise, and although they each had their own customs and commercial workings, they all held to the unifying authority of Strom. ', 1899),
(1899, 'Under the vigilant watch of the Order of Tirisfal, Dalaran became the chief center of learning for magicians throughout the land. The Magocrats who ruled Dalaran founded the Kirin Tor, a specialized sect that was charged with cataloguing and researching every spell, artifact, and magic item known to mankind at the time. ', 1900),
(1900, 'Gilneas and Alterac became strong supporters of Strom and developed mighty armies that explored the mountainous southern lands of Khaz Modan. It was during this period that humans first met the ancient race of dwarves and traveled to their cavernous subterranean city of Ironforge. The humans and dwarves shared many secrets of metal-smithing and engineering and discovered a common love for battle and storytelling.', 1901),
(1901, 'The city-state of Kul Tiras, founded upon a large island south of Lordaeron, developed a prosperous economy based on fishing and shipping. Over time, Kul Tiras built up a mighty fleet of merchant vessels that sailed throughout the known lands in search of exotic goods to trade and sell. Yet even as the economy of Arathor flourished, its strongest elements began to disintegrate.', 1902),
(1902, 'In time, the lords of Strom sought to move their estates to the lush northlands of Lordaeron and leave the arid lands of the south. The heirs of King Thoradin, the last descendants of the Arathi bloodline, argued that Strom should not be abandoned and thus incurred the displeasure of the greater citizenry, who were likewise eager to leave. ', 1903),
(1903, 'The lords of Strom, seeking to find purity and enlightenment in the untamed north, decided to leave their ancient city behind. Far to the north of Dalaran, the lords of Strom built a new city-state which they named Lordaeron. The entire continent would take its name from this city-state. Lordaeron became a mecca for religious travelers and all those who sought inner peace and security. ', 1904),
(1904, 'The descendents of the Arathi, left within the crumbling walls of ancient Strom, decided to travel south past the rocky mountains of Khaz Modan. Their journey finally ended after many long seasons, and they settled in the northern region of the continent they would name Azeroth. In a fertile valley they founded the kingdom of Stormwind, which quickly became a self-sufficient power in its own right. ', 1905),
...
(1906, 'As the politics and rivalries of the seven human nations waxed and waned, the line of Guardians kept its constant vigil against chaos. There were many Guardians over the years, but only one ever held the magical powers of Tirisfal at any given time. One of the last Guardians of the age distinguished herself as a mighty warrior against the shadow. ', 1907),
(1907, 'Aegwynn, a fiery human girl, won the approbation of the Order and was given the mantle of Guardianship. Aegwynn vigorously worked to hunt down and eradicate demons wherever she found them, but she often questioned the authority of the male-dominated Council of Tirisfal.', 1908),
(1908, 'She believed that the ancient elves and the elderly men who presided over the council were too rigid in their thinking and not farsighted enough to put a decisive end to the conflict against chaos. Impatient with lengthy discussion and debate, she yearned to prove herself worthy to her peers and superiors, and as a result frequently chose valor over wisdom in crucial situations.', 1909),
(1909, 'As her mastery over the cosmic power of Tirisfal grew, Aegwynn became aware of a number of powerful demons that stalked the icy northern continent of Northrend. Traveling to the distant north, Aegwynn tracked the demons into the mountains. There, she found that the demons were hunting one of the last surviving dragonflights and draining the ancient creatures of their innate magic. ', 1910),
(1910, 'The mighty dragons, who had fled from the ever-advancing march of mortal societies, found themselves too evenly matched against the dark magics of the Legion. Aegwynn confronted the demons, and with help from the noble dragons, eradicated them. Yet, as the last demon was banished from the mortal world, a great storm erupted throughout the north.', 1911),
(1911, ' An enormous dark visage appeared in the sky above Northrend. Sargeras, the demon king and lord of the Burning Legion, appeared before Aegwynn and bristled with hellish energy. He informed the young Guardian that the time of Tirisfal was about to come to an end and that the world would soon bow before the onslaught of the Legion. ', 1912),
(1912, 'The proud Aegwynn, believing herself to be a match for the menacing god, unleashed her powers against Sargeras\' avatar. With disconcerting ease, Aegwynn battered the demonlord with her powers and succeeded in killing his physical shell. Fearing that Sargeras\' spirit would linger on, Aegwynn locked the ruined husk of his body within one of the ancient halls of Kalimdor that had been blasted to the bottom of the sea when the Well of Eternity collapsed. ', 1913),
(1913, 'Aegwynn would never know that she had done exactly as Sargeras had planned. She had inadvertently sealed the fate of the mortal world, for Sargeras, at the time of his corporeal death, had transferred his spirit into Aegwynn\'s weakened body. Unbeknownst to the young Guardian, Sargeras would remain cloaked within the darkest recesses of her soul for many long years.', 0),
(1914, 'The dwarves of Ironforge Mountain lived in peace for many long centuries. However, their society grew too large within the confines of their mountain cities. Though the mighty High King, Modimus Anvilmar, ruled over all dwarves with justice and wisdom, three powerful factions had arisen amongst the dwarven society. ', 1915),
(1915, 'The Bronzebeard clan, ruled by Thane Madoran Bronzebeard, held close ties to the High King and stood as the traditional defenders of Ironforge Mountain. The Wildhammer clan, ruled by Thane Khardros Wildhammer, inhabited the foothills and crags around the base of the mountain and sought to gain more control within the city. ', 1916),
(1916, 'The third faction, the Dark Iron clan, was ruled by the sorcerer-thane Thaurissan. The Dark Irons hid within the deepest shadows under the mountain and plotted against both their Bronzebeard and the Wildhammer cousins.', 1917),
(1917, 'For a time the three factions kept a tenuous peace, but tensions erupted when High King Anvilmar passed away from old age. The three ruling clans went to war for control of Ironforge itself. The dwarf civil war raged under the earth for many years. Eventually the Bronzebeards, who had the largest standing army, banished the Dark Irons and Wildhammers from under the mountain. ', 1918),
(1918, 'Khardros and his Wildhammer warriors traveled north through the barrier gates of Dun Algaz, and they founded their own kingdom within the distant peak of Grim Batol. There, the Wildhammers thrived and rebuilt their stores of treasure. Thaurissan and his Dark Irons did not fare as well. Humiliated and enraged by their defeat, they vowed revenge against Ironforge. Leading his people far to the south, Thaurissan founded a city (which he named after himself) within the beautiful Redridge Mountains.', 1919),
(1919, 'Prosperity and the passing of years did little to ease the Dark Iron\'s rancor toward their cousins. Thaurissan and his sorceress wife, Modgud, launched a two-pronged assault against both Ironforge and Grim Batol. The Dark Irons were intent on claiming all of Khaz Modan for their own. ', 1920),
(1920, 'The Dark Iron armies smashed against their cousins\' strongholds and very nearly took both kingdoms. However, Madoran Bronzebeard ultimately led his clan to a decisive victory over Thaurissan\'s sorcerous army. Thaurissan and his servants fled back to the safety of their city, unaware of the events transpiring at Grim Batol, where Modgud\'s army would fare no better against Khardros and his Wildhammer warriors. ', 1921),
(1921, 'As she confronted the enemy warriors, Modgud used her powers to strike fear into their hearts. Shadows moved at her command, and dark things crawled up from the depths of the earth to stalk the Wildhammers in their own halls. Eventually Modgud broke through the gates and laid siege to the fortress itself. The Wildhammers fought desperately, Khardros himself wading through the roiling masses to slay the sorceress queen. ', 1922),
(1922, 'With their queen lost, the Dark Irons fled before the fury of the Wildhammers. They raced south toward their king\'s stronghold, only to meet the armies of Ironforge, which had come to aid Grim Batol. Crushed between two armies, the remaining Dark Iron forces were utterly destroyed. ', 1923),
(1923, 'The combined armies of Ironforge and Grim Batol then turned south, intent on destroying Thaurissan and his Dark Irons once and for all. They had not gone far when Thaurissan\'s fury resulted in a spell of cataclysmic proportions. Seeking to summon a supernatural minion that would ensure his victory, Thaurissan called upon the ancient powers sleeping beneath the world. To his shock, and ultimately his doom, the creature that emerged was more terrible than any nightmare he could have imagined.', 1924),
(1924, 'Ragnaros the Firelord, immortal lord of all fire elementals, had been banished by the Titans when the world was young. Now, freed by Thaurissan\'s call, Ragnaros erupted into being once again. Ragnaros\' apocalyptic rebirth into Azeroth shattered the Redridge Mountains and created a raging volcano at the center of the devastation. ', 1925),
(1925, 'The volcano, known as Blackrock Mountain, was bordered by the Searing Gorge to the north and the Burning Steppes to the south. Though Thaurissan was killed by the forces he had unleashed, his surviving brethren were ultimately enslaved by Ragnaros and his elementals. They remain within the depths of Blackrock to this day. ', 1926),
(1926, 'Witnessing the horrific devastation and the fires spreading across the southern mountains, King Madoran and King Khardros halted their armies and hastily turned back towards their kingdoms, unwilling to face the awesome wrath of Ragnaros. ', 1927),
(1927, 'The Bronzebeards returned to Ironforge and rebuilt their glorious city. The Wildhammers also returned home to Grim Batol. However, the death of the Modgud had left an evil stain on the mountain fortress, and the Wildhammers found it uninhabitable.', 1928),
(1928, ' They were bitter in their hearts over the loss of their beloved home. King Bronzebeard offered the Wildhammers a place to live within the borders of Ironforge, but the Wildhammers steadfastly refused. Khardros took his people north towards the lands of Lordaeron. Settling within the lush forests of the Hinterlands, the Wildhammers crafted the city of Aerie Peak, where the Wildhammers grew closer to nature and even bonded with the mighty gryphons of the area.', 1929),
(1929, 'Seeking to retain relations and trade with their cousins, the dwarves of Ironforge constructed two massive arches, the Thandol Span, to bridge the gap between Khaz Modan and Lordaeron. Bolstered by mutual trade, the two kingdoms prospered. After the deaths of Madoran and Khardros, their sons jointly commissioned two great statues in honor of their fathers. ', 1930),
(1930, 'The two statues would stand guard over the pass into the southlands, which had become volcanic in the wake of Ragnaros\' scorching presence. They served as both a warning to all who would attack the dwarven kingdoms, and as a reminder of what price the Dark Irons paid for their crimes. ', 1931),
(1931, 'The two kingdoms retained close ties for some years, but the Wildhammers were much changed by the horrors they witnessed at Grim Batol. They took to living above ground on the slopes of Aerie Peak, instead of carving a vast kingdom within the mountain. The ideological differences between the two remaining dwarven clans eventually led to their parting of ways. ', 0),
(1932, 'The Guardian Aegwynn grew powerful over the years and used the Tirisfal energies to greatly extend her life. Foolishly believing that she had defeated Sargeras for good, she continued to safeguard the world from the demon king\'s minions for nearly nine hundred years. However, the Council of Tirisfal finally decreed that her stewardship had come to an end.', 1933),
(1933, 'The Council ordered Aegwynn to return to Dalaran so that they could choose a new successor for the Guardian power. Yet Aegwynn, ever distrustful of the Council, decided to choose a successor on her own.', 1934),
(1934, 'The proud Aegwynn planned to give birth to a son whom she would divest her power to. She had no intention of allowing the Order of Tirisfal to manipulate her successor as they had tried to manipulate her. Traveling to the southern nation of Azeroth, Aegwynn found the perfect man to father her son: a skilled human magician known as Nielas Aran.', 1935),
(1935, 'Aran was the court conjuror and advisor for Azeroth\'s king. Aegwynn seduced the magician and conceived a son by him. Nielas\' natural affinity for magic would run deep within the unborn child and define the tragic steps the child would later take. The power of Tirisfal was also implanted in the child, yet it wasn\'t to awaken until he reached physical maturity.', 1936),
(1936, 'Time passed, and Aegwynn gave birth to her son in a secluded grove. Naming the boy Medivh, which means "keeper of secrets" in the high elven tongue, Aegwynn believed that the boy would mature to become the next Guardian. Unfortunately the malignant spirit of Sargeras, which had been hiding inside her, had possessed the defenseless child while it was still in her womb. Aegwynn had no idea that the world\'s newest Guardian was already possessed by its greatest nemesis.', 1937),
(1937, 'Certain that her baby was healthy and sound, Aegwynn delivered young Medivh to the court of Azeroth and left him there to be raised by his mortal father and his people. She then wandered into the wilderness and prepared to pass into whatever afterlife awaited her. Medivh grew to become a strong boy and had no idea of the potential power of his Tirisfalin birthright.', 1938),
(1938, 'Sargeras bided his time until the youth\'s power manifested itself. By the time Medivh had reached his teenage years, he had become very popular in Azeroth for his magical prowess and often went off on adventures with his two friends: Llane, the prince of Azeroth, and Anduin Lothar, one of the last descendents of the Arathi bloodline. The three boys constantly caused mischief around the kingdom, but they were well liked by the general citizenry.', 1939),
(1939, 'When Medivh reached the age of fourteen, the cosmic power inside him awakened and clashed with the pervasive spirit of Sargeras that lurked within his soul. Medivh fell into a catatonic state which lasted for many years.', 1940),
...
(1941, 'Sargeras reveled within the darkening heart of Medivh, for he knew that his plans for the second invasion of the world were nearing completion, and that the world\'s last Guardian would bring them all to fruition.', 0),
(1942, 'Around the time of Medivh\'s birth on Azeroth, Kil\'jaeden the Deceiver sat and brooded amongst his followers within the Twisting Nether. The cunning demonlord, under orders of his master, Sargeras, was plotting the Burning Legion\'s second invasion of Azeroth. ', 1943),
(1943, 'This time he would not allow any mistakes. Kil\'jaeden surmised that he needed a new force to weaken Azeroth\'s defenses before the Legion even set foot upon the world. If the mortal races, such as the night elves and dragons, were forced to contend with a new threat, they would be too weak to pose any real resistance when the Legion\'s true invasion arrived.', 1944),
(1944, 'It was at this time that Kil\'jaeden discovered the lush world of Draenor floating peacefully within the Great Dark Beyond. Home to the shamanistic, clan-based orcs and the peaceful draenei, Draenor was as idyllic as it was vast. ', 1945),
(1945, 'The noble orc clans roamed the open prairies and hunted for sport, while the inquisitive draenei built crude cities within the world\'s towering cliffs and peaks. Kil\'jaeden knew that Draenor\'s denizens had great potential to serve the Burning Legion if they could be cultivated properly. ', 1946),
(1946, 'Of the two races, Kil\'jaeden saw that the warrior orcs were more susceptible to the Legion\'s corruption. He enthralled the elder orc shaman, Ner\'zhul, in much the same way that Sargeras brought Queen Azshara under his control in ages past. Using the cunning shaman as his conduit, the demon spread battle lust and savagery throughout the orc clans. ', 1947),
(1947, 'Before long, the spiritual race was transformed into a bloodthirsty people. Kil\'jaeden then urged Ner\'zhul and his people to take the last step: to give themselves over entirely to the pursuit of death and war. Yet the old shaman, sensing that his people would be enslaved to hatred forever, somehow resisted the demon\'s command. ', 1948),
(1948, 'Frustrated by Ner\'zhul\'s resistance, Kil\'jaeden searched for another orc who would deliver his people into the Legion\'s hands. The clever demonlord finally found the willing disciple he sought - Ner\'zhul\'s ambitious apprentice, Gul\'dan. Kil\'jaeden promised Gul\'dan untold power in exchange for his utter obedience. ', 1949),
(1949, 'The young orc became an avid student of demonic magic and developed into the most powerful mortal warlock in history. He taught other young orcs the arcane arts and strove to eradicate the orcs\' shamanistic traditions. Gul\'dan showed a new brand of magic to his brethren, a terrible new power that reeked of doom.', 1950),
(1950, 'Kil\'jaeden, seeking to tighten his hold over the orcs, helped Gul\'dan found the Shadow Council, a secretive sect that manipulated the clans and spread the use of warlock magics throughout Draenor. As more and more orcs began to wield warlock magics, the gentle fields and streams of Draenor began to blacken and fade. Over time, the vast prairies the orcs had called home for generations withered away, leaving only red barren soil. The demon energies were slowly killing the world.', 0),
(1951, 'The orcs became increasingly aggressive under the secret control of Gul\'dan and his Shadow Council. They constructed massive arenas where the orcs honed their warrior skills in trials of combat and death. During this period, a few clan chieftains spoke out against the growing depravity in their race. ', 1952),
(1952, 'One such chieftain, Durotan of the Frostwolf clan, warned against the orcs\' losing themselves to hate and fury. His words fell on deaf ears, however, as stronger chieftains such as Grom Hellscream of the Warsong clan stepped forward to champion the new age of warfare and dominance.', 1953),
(1953, 'Kil\'jaeden knew that the orc clans were almost ready, but he needed to be certain of their ultimate loyalty. In secret, he had the Shadow Council summon Mannoroth the Destructor, the living vessel of destruction and rage. Gul\'dan called the clan chieftains together and convinced them that drinking Mannoroth\'s raging blood would make them utterly invincible.
', 1954),
(1954, ' Led by Grom Hellscream, all the clan chiefs except Durotan drank and thereby sealed their fates as slaves to the Burning Legion. Empowered by Mannoroth\'s rage, the chieftains unwittingly extended this subjugation to their unsuspecting brethren. ', 1955),
(1955, 'Consumed with the curse of this new bloodlust, the orcs sought to unleash their fury on any who stood before them. Sensing that the time had come, Gul\'dan united the warring clans into a single unstoppable Horde. ', 1956),
(1956, 'However, knowing that the various chieftains like Hellscream and Orgrim Doomhammer would vie for overall supremacy, Gul\'dan set up a puppet warchief to rule over this new Horde. Blackhand the Destroyer, a particularly depraved and vicious orc warlord, was chosen to be Gul\'dan\'s puppet. Under Blackhand\'s command, the Horde set out to test itself against the simple draenei.', 1957),
(1957, 'Over the course of a few months, the Horde eradicated nearly every draenei living on Draenor. Only a scattered handful of survivors managed to evade the orcs\' awesome wrath. Flushed with victory, Gul\'dan reveled in the Horde\'s power and might. Still, he knew that without any enemies to fight, the Horde would consume itself with endless infighting in its unstoppable appetite for glorious slaughter.', 1958),
(1958, 'Kil\'jaeden knew that the Horde was finally prepared. The orcs had become the Burning Legion\'s greatest weapon. The cunning demon shared his knowledge with his waiting master, and Sargeras agreed that the time of his revenge had finally come. ', 0),
(1959, 'As Kil\'jaeden prepared the Horde for its invasion of Azeroth, Medivh continued to fight for his soul against Sargeras. King Llane, the noble monarch of Stormwind, grew wary of the darkness which seemed to taint the spirit of his former friend.', 1960),
(1960, 'King Llane shared his concerns with Anduin Lothar, the last descendent of the Arathi bloodline, whom he named his lieutenant-at-arms. Even so, neither man could have imagined that Medivh\'s slow descent into madness would bring about the horrors that were to come.', 1961),
(1961, 'As a final incentive, Sargeras promised to bestow great power upon Gul\'dan if he agreed to lead the Horde to Azeroth. Through Medivh, Sargeras told the warlock that he could become a living god if he found the undersea tomb where the Guardian Aegwynn had placed Sargeras\' crippled body nearly a thousand years before.', 1962),
(1962, ' Gul\'dan agreed and decided that once the denizens of Azeroth were beaten, he would find the legendary tomb and claim his reward. Assured that the Horde would serve his purposes, Sargeras ordered the invasion to begin.', 1963),
(1963, 'Through a joint effort, Medivh and the warlocks of the Shadow Council opened the dimensional gateway known as the Dark Portal. This portal bridged the distance between Azeroth and Draenor, and it was large enough that armies might pass through it. Gul\'dan dispatched orc scouts through the portal to survey the lands which they would conquer. The returning scouts assured the Shadow Council that the world of Azeroth was ripe for the taking.', 1964),
(1964, 'Still convinced that Gul\'dan\'s corruption would destroy his people, Durotan spoke out against the warlocks once more. The brave warrior claimed that warlocks were destroying the purity of the orcish spirit and that this reckless invasion would be their doom. Gul\'dan, unable to risk killing such a popular hero, was forced to exile Durotan and his Frostwolf Clan into the far reaches of this new world.', 1965),
(1965, 'After the exiled Frostwolves charged through the portal, only a few orc clans followed. These orcs quickly set up a base of operations within the Black Morass, a dark and swampy area far to the east of the kingdom of Stormwind. As the orcs began to branch out and explore the new lands, they came into immediate conflict with the human defenders of Stormwind. 
', 1966),
(1966, 'Though these skirmishes usually ended quickly, they did much to illustrate the weaknesses and strengths of both rival species. Llane and Lothar were never able to gather accurate data of the orcs\' numbers and could only guess at how great a force they would have to contend with. ', 1967),
(1967, 'After a few years the majority of the orcish Horde had crossed into Azeroth, and Gul\'dan deemed that the time for the primary strike against humanity had come. The Horde launched its full might against the unsuspecting kingdom of Stormwind. ', 1968),
(1968, 'As the forces of Azeroth and the Horde clashed across the kingdom, internal conflicts began to take their toll on both armies. King Llane, who believed the bestial orcs to be incapable of conquering Azeroth, contemptuously held his position at his capital of Stormwind. However, Sir Lothar became convinced that the battle should be taken directly to the enemy, and he was forced to choose between his convictions and his loyalty to the king. ', 1969),
(1969, 'Choosing to follow his instincts, Lothar stormed Medivh\'s tower-fortress of Karazhan with the help of the wizard\'s young apprentice, Khadgar. Khadgar and Lothar succeeded in vanquishing the possessed Guardian, whom they confirmed to be the source of the conflict. ', 1970),
(1970, 'By killing Medivh\'s body, Lothar and the young apprentice inadvertently banished the spirit of Sargeras to the abyss. As a consequence, the pure, virtuous spirit of Medivh was also allowed to live on... and wander the astral plane for many years to come.', 1971),
(1971, 'Although Medivh had been defeated, the Horde continued to dominate the defenders of Stormwind. As the Horde\'s victory drew nearer, Orgrim Doomhammer, one of the greatest orc chieftains, began to see the depraved corruption that had spread throughout the clans since their time in Draenor.', 1972),
...
That infant orc would one day rise to become the greatest leader his people would ever know. ', 1973),
(1973, 'Incensed by Durotan\'s death, Orgrim set out to free the Horde from demonic corruption and ultimately assumed the role of warchief of the Horde by killing Gul\'dan\'s corrupt puppet, Blackhand. Under his decisive leadership the relentless Horde finally laid siege to Stormwind Keep. ', 1974),
(1974, 'King Llane had severely underestimated the might of the Horde, and he watched helplessly as his kingdom fell to the green-skinned invaders. Ultimately King Llane was assassinated by one of the Shadow Council\'s finest killers: the half-orc, Garona.', 1975),
(1975, 'Lothar and his warriors, returning home from Karazhan, hoped to stem the loss of life and save their once-glorious homeland. Instead, they returned too late and found their beloved kingdom in smoking ruins. The orcish Horde continued to ravage the countryside and claimed the surrounding lands for its own. Forced into hiding, Lothar and his companions swore a grim oath to reclaim their homeland at any cost.', 0),
(1976, 'Lord Lothar rallied the remnants of Azeroth\'s armies after their defeat at Stormwind Keep, and then launched a massive exodus across the sea to the northern kingdom of Lordaeron. Convinced that the Horde would overcome all of humanity if left unchecked, the leaders of the seven human nations met and agreed to unite in what would become known as the Alliance of Lordaeron. ', 1977);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(1977, 'For the first time in nearly three thousand years, the disparate nations of Arathor were once again united under a common banner. Appointed as Supreme Commander of the Alliance forces, Lord Lothar prepared his armies for the coming of the Horde.', 1978),
(1978, 'Aided by his lieutenants, Uther the Lightbringer, Admiral Daelin Proudmoore, and Turalyon, Lothar was able to convince Lordaeron\'s demi-human races of the impending threat as well. The Alliance succeeded in gaining the support of the stoic dwarves of Ironforge and a small number of high elves of Quel\'Thalas.', 1979),
(1979, 'The elves, led at that time by Anasterian Sunstrider, were largely uninterested in the coming conflict. However, they were duty-bound to aid Lothar because he was the last descendent of the Arathi bloodline, which had aided the elves in ages past.', 1980),
(1980, 'The Horde, now led by Warchief Doomhammer, brought in ogres from its homeworld of Draenor and conscripted the disenfranchised Amani forest trolls into its fold. Setting out on a massive campaign to overrun the dwarf kingdom of Khaz Modan and the southern reaches of Lordaeron, the Horde effortlessly decimated all opposition.', 1981),
(1981, 'The epic battles of the Second War ranged from large-scale naval skirmishes to massive aerial dogfights. Somehow the Horde had unearthed a powerful artifact known as the Demon Soul and used it to enslave the ancient Dragonqueen, Alexstrasza. Threatening to destroy her precious eggs, the Horde forced Alexstrasza to send her grown children to war. The noble red dragons were forced to fight for the Horde, and fight they did.', 1982),
(1982, 'The war raged across the continents of Khaz Modan, Lordaeron, and Azeroth itself. As part of its northern campaign, the Horde succeeded in burning down the borderlands of Quel\'Thalas, thereby ensuring the elves\' final commitment to the Alliance\'s cause. The greater cities and townships of Lordaeron were razed and devastated by the conflict. Despite the absence of reinforcements and overwhelming odds, Lothar and his allies succeeded in holding their enemies at bay.', 1983),
(1983, 'However, during the final days of the Second War, as the Horde\'s victory over the Alliance seemed almost assured, a terrible feud erupted between the two most powerful orcs on Azeroth. As Doomhammer prepared his final assault against the Capital City of Lordaeron - an assault that would have crushed the last remnants of the Alliance - Gul\'dan and his followers abandoned their posts and set out to sea.', 1984),
(1984, 'The bewildered Doomhammer, having lost nearly half of his standing forces to Gul\'dan\'s treachery, was forced to pull back and forsake his greatest chance at victory over the Alliance.', 1985),
(1985, 'The power-hungry Gul\'dan, obsessed with obtaining godhood itself, set out on a desperate search for the undersea Tomb of Sargeras that he believed held the secrets of ultimate power. Having already doomed his fellow orcs to become the slaves of the Burning Legion, Gul\'dan thought nothing of his supposed duty to Doomhammer.', 1986),
(1986, 'Backed by the Stormreaver and Twilight\'s Hammer clans, Gul\'dan succeeded in raising the Tomb of Sargeras from the sea floor. However, when he opened the ancient, flooded vault, he found only crazed demons awaiting him.', 1987),
(1987, 'Seeking to punish the wayward orcs for their costly betrayal, Doomhammer sent his forces to kill Gul\'dan and bring the renegades back into the fold. For his recklessness, Gul\'dan was torn apart by the maddened demons he had set loose. With their leader dead, the renegade clans quickly fell before Doomhammer\'s enraged legions.', 1988),
(1988, 'Though the rebellion had been quelled, the Horde was unable to recoup the terrible losses it had suffered. Gul\'dan\'s betrayal had afforded the Alliance not only hope, but also time to regroup and retaliate.', 1989),
(1989, 'Lord Lothar, seeing that the Horde was fracturing from within, gathered the last of his forces and pushed Doomhammer south, back into the shattered heartland of Stormwind. There, the Alliance forces trapped the retreating Horde within the volcanic fortress of Blackrock Spire. Though Lord Lothar fell in battle at the Spire\'s base, his lieutenant, Turalyon, rallied the Alliance forces at the eleventh hour and drove the Horde back into the abysmal Swamp of Sorrows. ', 1990),
(1990, 'Turalyon\'s forces succeeded in destroying the Dark Portal, the mystical gateway that connected the orcs to their homeworld of Draenor. Cut off from its reinforcements and fractured by infighting, the Horde finally buckled in upon itself and fell before the might of the Alliance.', 1991),
(1991, 'The scattered orc clans were quickly rounded up and placed within guarded internment camps. Though it seemed that the Horde had been defeated for good, some remained highly skeptical that peace would last. Khadgar, now an Archmage of some renown, convinced the Alliance high command to build the fortress of Nethergarde that would watch over the ruins of the Dark Portal and ensure that there would be no further invasions from Draenor.', 0),
(1992, 'As the fires of the Second War died down, the Alliance took aggressive steps to contain the orcish threat. A number of large internment camps, meant to house the captive orcs, were constructed in southern Lordaeron. Guarded by both the paladins and the veteran soldiers of the Alliance, the camps proved to be a great success. ', 1993),
(1993, 'Though the captive orcs were tense and anxious to do battle once more, the various camp wardens, based at the old prison-fortress of Durnholde, kept the peace and maintained a strong semblance of order.', 1994),
(1994, 'However, on the hellish world of Draenor, a new orcish army prepared to strike at the unsuspecting Alliance. Ner\'zhul, the former mentor of Gul\'dan, rallied the remaining orc clans under his dark banner. Aided by the Shadowmoon clan, the old shaman planned to open a number of portals on Draenor that would lead the Horde to new, unspoiled worlds. ', 1995),
(1995, 'To power his new portals, he needed a number of enchanted artifacts from Azeroth. To procure them, Ner\'zhul reopened the Dark Portal and sent his ravenous servants charging through it.', 1996),
(1996, 'The new Horde, led by veteran chieftains such as Grom Hellscream and Kilrogg Deadeye (of the Bleeding Hollow clan), surprised the Alliance defense forces and rampaged through the countryside. Under Ner\'zhul\'s surgical command, the orcs quickly rounded up the artifacts that they needed and fled back to the safety of Draenor.', 1997),
(1997, 'King Terenas of Lordaeron, convinced that the orcs were preparing a new invasion of Azeroth, assembled his most trusted lieutenants. He ordered General Turalyon and the archmage, Khadgar, to lead an expedition through the Dark Portal to put an end to the orcish threat once and for all. Turalyon and Khadgar\'s forces marched into Draenor and repeatedly clashed with Ner\'zhul\'s clans upon the ravaged Hellfire Peninsula. ', 1998),
(1998, 'Even with the aid of the high elf Alleria Windrunner, the dwarf Kurdran Wildhammer, and the veteran soldier Danath Trollbane, Khadgar was unable to prevent Ner\'zhul from opening his portals to other worlds.', 1999),
(1999, 'Ner\'zhul finally opened his portals to other worlds, but he did not foresee the terrible price he would pay. The portals\' tremendous energies began to tear the very fabric of Draenor apart. As Turalyon\'s forces fought desperately to return home to Azeroth, the world of Draenor began to buckle in upon itself. Grom Hellscream and Kilrogg Deadeye, realizing that Ner\'zhul\'s mad plans would doom their entire race, rallied the remaining orcs and escaped back to the relative safety of Azeroth.', 2000),
(2000, 'On Draenor, Turalyon and Khadgar agreed to make the ultimate sacrifice by destroying the Dark Portal from their side. Though it would cost their lives, and the lives of their companions, they knew that it was the only way to ensure Azeroth\'s survival. Even as Hellscream and Deadeye hacked their way through the human ranks in a desperate bid for freedom, the Dark Portal exploded behind them. For them, and the remaining orcs on Azeroth, there would be no going back.', 2001),
(2001, 'Ner\'zhul and his loyal Shadowmoon clan passed through the largest of the newly created portals, as massive volcanic eruptions began to break Draenor\'s continents apart. The burning seas rose up and roiled the shattered landscape as the tortured world was finally consumed in a massive, apocalyptic explosion.', 0),
(2002, 'Ner\'zhul and his followers entered the Twisting Nether, the ethereal plane that connects all of the worlds scattered throughout the Great Dark Beyond. Unfortunately Kil\'jaeden and his demonic minions were waiting for them. Kil\'jaeden, who had sworn to take vengeance on Ner\'zhul for his prideful defiance, slowly tore the old shaman\'s body apart, piece by piece. ', 2003),
(2003, 'Kil\'jaeden kept the shaman\'s spirit alive and intact, thus leaving Ner\'zhul painfully aware of his body\'s gross dismemberment. Though Ner\'zhul pleaded with the demon to release his spirit and grant him death, the demon grimly replied that the Blood Pact they had made long ago was still binding, and that Ner\'zhul still had a purpose to serve.', 2004),
(2004, 'The orcs\' failure to conquer the world for the Burning Legion forced Kil\'jaeden to create a new army to sew chaos throughout the kingdoms of the Azeroth. This new army could not be allowed to fall prey to the same petty rivalries and infighting that had plagued the Horde. It would have to be merciless and single-minded in its mission. This time, Kil\'jaeden could not afford to fail. ', 2005),
(2005, 'Holding Ner\'zhul\'s spirit helpless in stasis, Kil\'jaeden gave him one last chance to serve the Legion or suffer eternal torment. Once again, Ner\'zhul recklessly agreed to the demon\'s pact. Ner\'zhul\'s spirit was placed within a specially crafted block of diamond-hard ice gathered from the far reaches of the Twisting Nether. ', 2006),
(2006, 'Encased within the frozen cask, Ner\'zhul felt his consciousness expand ten thousand-fold. Warped by the demon\'s chaotic powers, Ner\'zhul became a spectral being of unfathomable power. At that moment, the orc known as Ner\'zhul was shattered forever, and the Lich King was born.', 2007),
(2007, 'Ner\'zhul\'s loyal death knights and Shadowmoon followers were also transformed by the demon\'s chaotic energies. The wicked spellcasters were ripped apart and remade as skeletal liches. The demons had ensured that even in death, Ner\'zhul\'s followers would serve him unquestioningly.', 2008),
(2008, 'When the time was right, Kil\'jaeden explained the mission for which he had created the Lich King. Ner\'zhul was to spread a plague of death and terror across Azeroth that would snuff out human civilization forever. All those who died from the dreaded plague would arise as the undead, and their spirits would be bound to Ner\'zhul\'s iron will forever.', 2009),
(2009, ' Kil\'jaeden promised that if Ner\'zhul accomplished his dark mission of scouring humanity from the world, he would be freed from his curse and granted a new, healthy body to inhabit.', 2010),
(2010, 'Though Ner\'zhul was agreeable and seemingly anxious to play his part, Kil\'jaeden remained skeptical of his pawn\'s loyalties. Keeping the Lich King bodiless and trapped within the crystal cask assured his good conduct for the short term, but the demon knew that he would need to keep a watchful eye on him. To this end, Kil\'jaeden called upon his elite demon guard, the vampiric dreadlords, to police Ner\'zhul and ensure that he accomplished his dread task. ', 2011),
(2011, 'Tichondrius, the most powerful and cunning of the dreadlords, warmed to the challenge; he was fascinated by the plague\'s severity and the Lich King\'s unbridled potential for genocide.', 0),
(2012, 'Kil\'jaeden cast Ner\'zhul\'s icy cask back into the world of Azeroth. The hardened crystal streaked across the night sky and smashed into the desolate arctic continent of Northrend, burying itself deep within the Icecrown glacier. The frozen crystal, warped and scarred by its violent descent, came to resemble a throne, and Ner\'zhul\'s vengeful spirit soon stirred within it.', 2013),
(2013, 'From the confines of the Frozen Throne, Ner\'zhul began to reach out his vast consciousness and touch the minds of Northrend\'s native inhabitants. With little effort, he enslaved the minds of many indigenous creatures, including ice trolls and fierce wendigo, and he drew their evil brethren into his growing shadow. His psychic powers proved to be almost limitless, and he used them to create a small army that he housed within Icecrown\'s twisting labyrinths. ', 2014),
(2014, 'As the Lich King mastered his growing abilities under the dreadlords\' persistent vigil, he discovered a remote human settlement on the fringe of the vast Dragonblight. On a whim, Ner\'zhul decided to test his powers on the unsuspecting humans. ', 2015),
...
(2016, 'The raging cacophony in his mind caused Ner\'zhul to grow even more powerful, as if their spirits provided him with much-needed nourishment. He found it was child\'s play to control the zombies\' actions and steer them to whatever end he wished.', 2017),
(2017, 'Over the following months, Ner\'zhul continued to experiment with his plague of undeath by subjugating every human inhabitant of Northrend. With his army of undead growing daily, he knew that the time for his true test was nearing.', 0),
(2018, 'Meanwhile, in the war-torn lands of the south, the scattered remnants of the Horde fought for their very survival. Though Grom Hellscream and his Warsong clan managed to evade capture, Deadeye and his Bleeding Hollow clan were rounded up and placed in the internment camps in Lordaeron. Notwithstanding these costly uprisings, the camps\' wardens soon re-established control over their brutish charges.', 2019),
(2019, 'However, unknown to the Alliance, a large force of orcs still roamed free in the northern wastes of Khaz Modan. The Dragonmaw clan, led by the infamous warlock Nekros, was using an ancient artifact known as the Demon Soul to control the Dragonqueen, Alexstrasza, and her dragonflight. With the Dragonqueen as his hostage, Nekros built up a secret army within the abandoned - some say cursed - Wildhammer stronghold of Grim Batol. ', 2020),
(2020, 'Planning to unleash his forces and the mighty red dragons on the Alliance, Nekros hoped to reunite the Horde and continue its conquest of Azeroth. His vision did not come to pass: a small group of resistance fighters, led by the human mage Rhonin managed to destroy the Demon Soul and free the Dragonqueen from Nekros\' command.', 2021),
(2021, 'In their fury, Alexstrasza\'s dragons tore Grim Batol apart and incinerated the greater bulk of the Dragonmaw clan. Nekros\' grand schemes of reunification came crashing down as the Alliance troops rounded up the remaining orc survivors and threw them into the waiting internment camps. The Dragonmaw clan\'s defeat signaled the end of the Horde, and the end of the orcs\' furious bloodlust. ', 0),
(2022, 'Months passed, and more orc prisoners were rounded up and placed within the internment camps. As the camps began to overflow, the Alliance was forced to construct new camps in the plains south of the Alterac Mountains. To properly maintain and supply the growing number of camps, King Terenas levied a new tax on the Alliance nations. ', 2023),
(2023, 'This tax, along with increased political tensions over border disputes, created widespread unrest. It seemed that the fragile pact that had forged the human nations together in their darkest hour would break at any given moment.', 2024),
(2024, 'Amidst the political turmoil, many of the camp wardens began to notice an unsettling change come over their orc captives. The orcs\' efforts to escape from the camps or even fight amongst themselves had greatly decreased in frequency over time. The orcs were becoming increasingly aloof and lethargic.', 2025),
(2025, ' Though it was difficult to believe, the orcs - once held as the most aggressive race ever seen on Azeroth - had completely lost their will to fight. The strange lethargy confounded the Alliance leaders and continued to take its toll on the rapidly weakening orcs. ', 2026),
(2026, 'Some speculated that some strange disease, contractible only by orcs, brought about the baffling lethargy. But Archmage Antonidas of Dalaran posed a different hypothesis. Researching what little he could find of orcish history, Antonidas learned that the orcs had been under the crippling influence of demonic power for generations.', 2027),
(2027, ' He speculated that the orcs had been corrupted by these powers even before their first invasion of Azeroth. Clearly, demons had spiked the orcs\' blood, and in turn the brutes had been granted unnaturally heightened strength, endurance, and aggression.', 2028),
(2028, 'Antonidas theorized that the orcs\' communal lethargy was not actually a disease, but a consequence of racial withdrawal from the volatile warlock magics that had made them fearsome, bloodlusted warriors. ', 2029),
(2029, 'Though the symptoms were clear, Antonidas was unable to find a cure for the orcs\' present condition. Then too, many of his fellow mages, as well as a few notable Alliance leaders, argued that finding a cure for the orcs would be an imprudent venture. Left to ponder the orcs\' mysterious condition, Antonidas\' conclusion was that the orcs\' cure would have to be a spiritual one.', 0),
(2030, 'The chief warden of the internment camps, Aedelas Blackmoore, watched over the captive orcs from his prison-stronghold, Durnholde. One orc in particular had always held his interest: the orphaned infant he had found nearly eighteen years before. Blackmoore had raised the young male as a favored slave and named him Thrall. Blackmoore taught the orc about tactics, philosophy, and combat. Thrall was even trained as a gladiator. All the while, the corrupt warden sought to mold the orc into a weapon.', 2031),
(2031, 'Despite his harsh upbringing, young Thrall grew into a strong, quick-witted orc, and he knew in his heart that a slave\'s life was not for him. As he grew to maturity, he learned about his people, the orcs, whom he had never met: after their defeat, most of them had been placed in internment camps. Rumor had it that Doomhammer, the orc leader, had escaped from Lordaeron and gone into hiding. Only one rogue clan still operated in secret, trying to evade the watchful eyes of the Alliance.', 2032),
(2032, 'The resourceful yet inexperienced Thrall decided to escape from Blackmoore\'s fortress and set off to find others of his kind. During his journeys Thrall visited the internment camps and found his once-mighty race to be strangely cowed and lethargic. Having not found the proud warriors he hoped to discover, Thrall set out to find the last undefeated orc chieftain, Grom Hellscream.', 2033),
(2033, 'Constantly hunted by the humans, Hellscream nevertheless held onto the Horde\'s unquenchable will to fight. Aided only by his own devoted Warsong clan, Hellscream continued to wage an underground war against the oppression of his beleaguered people. Unfortunately, Hellscream could never find a way to rouse the captured orcs from their stupor. The impressionable Thrall, inspired by Hellscream\'s idealism, developed a strong empathy for the Horde and its warrior traditions.', 2034),
(2034, 'Seeking the truth of his own origins, Thrall traveled north to find the legendary Frostwolf clan. Thrall learned that Gul\'dan had exiled the Frostwolves during the early days of the First War. He also discovered that he was the son and heir of the orc hero Durotan, the true chieftain of the Frostwolves who had been murdered in the wilds nearly twenty years before.', 2035),
(2035, 'Under the tutelage of the venerable shaman Drek\'Thar, Thrall studied his people\'s ancient shamanistic culture, which had been forgotten under Gul\'dan\'s evil rule. Over time, Thrall became a powerful shaman and took his rightful place as chieftain of the exiled Frostwolves. Empowered by the elements themselves and driven to find his destiny, Thrall set off to free the captive clans and heal his race of demonic corruption.', 2036),
(2036, 'During his travels, Thrall found the aged warchief, Orgrim Doomhammer, who had been living as a hermit for many years. Doomhammer, who had been a close friend of Thrall\'s father, decided to follow the young, visionary orc and help him free the captive clans. Supported by many of the veteran chieftains, Thrall ultimately succeeded in revitalizing the Horde and giving his people a new spiritual identity.', 2037),
(2037, 'To symbolize his people\'s rebirth, Thrall returned to Blackmoore\'s fortress of Durnholde and put a decisive end to his former master\'s plans by laying siege to the internment camps. This victory was not without its price: during the liberation of one camp, Doomhammer fell in battle.', 2038),
(2038, 'Thrall took up Doomhammer\'s legendary warhammer and donned his black plate-armor to become the new warchief of the Horde. During the following months, Thrall\'s small but volatile Horde laid waste to the internment camps and stymied the Alliance\'s best efforts to counter his clever strategies. Encouraged by his best friend and mentor, Grom Hellscream, Thrall worked to ensure that his people would never be slaves again.', 0),
(2039, 'While Thrall was liberating his brethren in Lordaeron, Ner\'zhul continued to build up his power base in Northrend. A great citadel was erected above the Icecrown Glacier and manned by the growing legions of the dead. Yet as the Lich King extended his influence over the land, one shadowy empire stood against his power. ', 2040),
(2040, 'The ancient subterranean kingdom of Azjol-Nerub, which had been founded by a race of sinister humanoid spiders, sent their elite warrior-guard to attack Icecrown and end the Lich King\'s mad bid for dominance. Much to his frustration, Ner\'zhul found that the evil nerubians were immune not only to the plague, but to his telepathic domination as well.', 2041),
(2041, 'The nerubian spider-lords commanded vast forces and had an underground network that stretched nearly half the breadth of Northrend. Their hit-and-run tactics on the Lich King\'s strongholds stymied his efforts to root them out time after time. Ultimately Ner\'zhul\'s war against the nerubians was won by attrition. With the aid of the sinister dreadlords and innumerable undead warriors, the Lich King invaded Azjol-Nerub and brought its subterranean temples crashing down upon the spider lords\' heads.', 2042),
(2042, 'Though the nerubians were immune to his plague, Ner\'zhul\'s growing necromantic powers allowed him to raise the spider-warriors\' corpses and bend them to his will. As a testament to their tenacity and fearlessness, Ner\'zhul adopted the nerubians\' distinctive architectural style for his own fortresses and structures. ', 2043),
(2043, 'Left to rule his kingdom unopposed, the Lich King began preparing for his true mission in the world. Reaching out into the human lands with his vast consciousness, the Lich King called out to any dark soul that would listen.... ', 0),
(2044, 'There were a handful of powerful individuals scattered throughout the world who heard the Lich King\'s mental summons from Northrend. Most notable of them was the archmage of Dalaran, Kel\'Thuzad, who was one of senior members of the Kirin Tor, Dalaran\'s ruling council. He had been considered a maverick for years due to his insistence on studying the forbidden arts of necromancy. ', 2045),
(2045, 'Driven to learn all he could of the magical world and its shadowy wonders, he was frustrated by what he saw as his peers\' outmoded and unimaginative precepts. Upon hearing the powerful summons from Northrend, the archmage bent all of his considerable will to communing with the mysterious voice. Convinced that the Kirin Tor was too squeamish to seize the power and knowledge inherent in the dark arts, he resigned himself to learn what he could from the immensely powerful Lich King.', 2046),
...
(2047, 'Intent on reaching Icecrown and offering his services to the Lich King, the archmage passed through the ravaged, war-torn ruins of Azjol-Nerub. Kel\'Thuzad saw firsthand the scope and ferocity of Ner\'zhul\'s power. He began to realize that allying himself with the mysterious Lich King might be both wise and potentially fruitful.', 2048),
(2048, 'After long months of trekking through the harsh arctic wastelands, Kel\'Thuzad finally reached the dark glacier of Icecrown. He boldly approached Ner\'zhul\'s dark citadel and was shocked when the undead guardsmen silently let him pass as though he was expected. ', 2049),
(2049, 'Kel\'Thuzad descended deep into the cold earth and found his way down to the bottom of the glacier. There, in the endless cavern of ice and shadows, he prostrated himself before the Frozen Throne and offered his soul to the dark lord of the dead.', 2050),
(2050, 'The Lich King was pleased with his latest conscript. He promised Kel\'Thuzad immortality and great power in exchange for his loyalty and obedience. Eager for dark knowledge and power, Kel\'Thuzad accepted his first great mission: to go into the world of men and found a new religion that would worship the Lich King as a god.', 2051),
(2051, 'To help the archmage accomplish his mission, Ner\'zhul left Kel\'Thuzad\'s humanity intact. The aged yet still charismatic wizard was charged with using his powers of illusion and persuasion to lull the downtrodden, disenfranchised masses of Lordaeron into a state of trust and belief. Then, once he had their attention, he would offer them a new vision of what society could be - and a new figurehead to call their king.', 2052),
(2052, 'Kel\'Thuzad returned to Lordaeron in disguise, and over the span of three years, he used his fortune and intellect to gather a clandestine brotherhood of like-minded men and women. The brotherhood, which he called the Cult of the Damned, promised its acolytes social equality and eternal life on Azeroth in exchange for their service and obedience to Ner\'zhul. ', 2053),
(2053, 'As the months passed, Kel\'Thuzad found many eager volunteers for his new cult amongst the tired, overburdened laborers of Lordaeron. It was surprisingly easy for Kel\'Thuzad to achieve his goal: namely, to transfer the citizens\' faith in the Holy Light into belief in Ner\'zhul\'s dark shadow. As the Cult of the Damned grew in size and influence, Kel\'Thuzad made sure to hide its workings from the authorities of Lordaeron.', 2054),
(2054, 'With Kel\'Thuzad\'s success in Lordaeron, the Lich King made the final preparations for his assault against human civilization. Placing his plague-energies into a number of portable artifacts called plague-cauldrons, Ner\'zhul ordered Kel\'Thuzad to transport the cauldrons to Lordaeron, where they would be hidden within various cult-controlled villages. ', 2055),
(2055, 'The cauldrons, protected by the loyal cultists, would then act as plague-generators, sending the plague seeping out across the unsuspecting farmlands and cities of northern Lordaeron.', 2056),
(2056, 'The Lich King\'s plan worked perfectly. Many of Lordaeron\'s northern villages were contaminated almost immediately. Just as in Northrend, the citizens who contracted the plague died and arose as the Lich King\'s willing slaves. ', 2057),
(2057, 'The cultists under Kel\'Thuzad were eager to die and be raised again in their dark lord\'s service. They exulted in the prospect of immortality through undeath. As the plague spread, more and more feral zombies arose in the northlands. Kel\'Thuzad looked upon the Lich King\'s growing army and named it the Scourge, for soon it would march upon the gates of Lordaeron and scour humanity from the face of the world. ', 0),
(2064, 'After preparing for many long months, Kel\'Thuzad and his Cult of the Damned finally struck the first blow by releasing the plague of undeath upon Lordaeron. Uther and his fellow paladins investigated the infected regions in the hope of finding a way to stop the plague. Despite their efforts, the plague continued to spread and threatened to tear the Alliance apart.', 2065),
(2065, 'As the ranks of the undead swept across Lordaeron, Terenas\' only son, Prince Arthas, took up the fight against the Scourge. Arthas succeeded in killing Kel\'Thuzad, but even so, the undead ranks swelled with every soldier that fell defending the land. Frustrated and stymied by the seemingly unstoppable enemy, Arthas took increasingly extreme steps to conquer them. Finally Arthas\' comrades warned him that he was losing his hold on his humanity.', 2066),
(2066, 'Arthas\' fear and resolve proved to be his ultimate undoing. He tracked the plague\'s source to Northrend, intending to end its threat forever. Instead, Prince Arthas eventually fell prey to the Lich King\'s tremendous power. Believing that it would save his people, Arthas took up the cursed runeblade, Frostmourne. ', 2067),
(2067, 'Though the sword did grant him unfathomable power, it also stole his soul and transformed him into the greatest of the Lich King\'s death knights. With his soul cast aside and his sanity shattered, Arthas led the Scourge against his own kingdom. Ultimately, Arthas murdered his own father, King Terenas, and crushed Lordaeron under the Lich King\'s iron heel.', 0),
(2068, 'Though he had defeated all of the people he now saw as his enemies, Arthas was still haunted by the ghost of Kel\'Thuzad. The ghost told Arthas that he needed to be revived for the next phase of the Lich King\'s plan. To revive him, Arthas needed to bring Kel\'Thuzad\'s remains to the mystical Sunwell, hidden within the high elves\' eternal kingdom of Quel\'Thalas.', 2069),
(2069, 'Arthas and his Scourge invaded Quel\'Thalas and laid siege to the elves\' crumbling defenses. Sylvanas Windrunner, the Ranger-General of Silvermoon, put up a valiant fight, but Arthas eventually eradicated the high elf army and battled through to the Sunwell. In a cruel gesture of his dominance, he even raised Sylvanas\' defeated body as a banshee, cursed to endless undeath in the service of Quel\'Thalas\' conqueror.', 2070),
(2070, 'Ultimately, Arthas submerged Kel\'Thuzad\'s remains within the holy waters of the Sunwell. Although the potent waters of Eternity were fouled by this act, Kel\'Thuzad was reborn as a sorcerous lich. Resurrected as a far more powerful being, Kel\'Thuzad explained the next phase of the Lich King\'s plan. ', 2071),
(2071, 'By the time Arthas and his army of the dead turned southward, not one living elf remained in Quel\'Thalas. The glorious homeland of the high elves, which had stood for more than nine thousand years, was no more.', 0),
(2072, 'Once Kel\'Thuzad was whole again, Arthas led the Scourge south to Dalaran. There the lich would obtain the powerful spellbook of Medivh, and use it to summon Archimonde back into the world. From that point on, Archimonde himself would begin the Legion\'s final invasion. Not even the wizards of the Kirin Tor could stop Arthas\' forces from stealing Medivh\'s book, and soon Kel\'Thuzad had all he needed to perform his spell. ', 2073),
(2073, 'After ten thousand years, the mighty demon Archimonde and his host emerged once again upon the world of Azeroth. Yet Dalaran was not their final destination. Under orders from Kil\'jaeden himself, Archimonde and his demons followed the undead Scourge to Kalimdor, bent on destroying Nordrassil, the World Tree.', 2074),
(2074, 'In the midst of this chaos, a lone, mysterious prophet appeared to lend the mortal races guidance. This prophet proved to be none other than Medivh, the last Guardian, miraculously returned from the Beyond to redeem himself for past sins. Medivh told the Horde and the Alliance of the dangers they faced and urged them to band together. ', 2075),
(2075, 'Jaded by generations of hate, the orcs and humans would have none of it. Medivh was forced to deal with each race separately, using prophecy and trickery to guide them across the sea to the legendary land of Kalimdor. The orcs and humans soon encountered the long-hidden civilization of the Kaldorei.', 2076),
(2076, 'The orcs, led by Thrall, suffered a series of setbacks on their journey across Kalimdor\'s Barrens. Though they befriended Cairne Bloodhoof and his mighty tauren warriors, many orcs began to succumb to the demonic bloodlust that had plagued them for years. Thrall\'s greatest lieutenant, Grom Hellscream, even betrayed the Horde by giving himself over to his baser instincts.', 2077),
(2077, ' As Hellscream and his loyal Warsong warriors stalked through the forests of Ashenvale, they clashed with the ancient night elf Sentinels. Certain that the orcs had returned to their warlike ways, the demigod Cenarius came forth to drive Hellscream and his orcs back. Yet Hellscream and his orcs, overcome with supernatural hate and rage, managed to kill Cenarius and corrupt the ancient forestlands. ', 2078),
(2078, 'Ultimately, Hellscream redeemed his honor by helping Thrall defeat Mannoroth, the demon lord who first cursed the orcs with his bloodline of hate and rage. With Mannoroth\'s death, the orcs\' blood-curse was finally brought to an end. ', 2079),
(2079, 'While Medivh worked to convince the orcs and humans of the need for an alliance, the night elves fought the Legion in their own secretive ways. Tyrande Whisperwind, the immortal High Priestess of the night elf Sentinels, battled desperately to keep the demons and undead from overrunning the forests of Ashenvale. Tyrande realized that she needed help, so she set out to awaken the night elf druids from their thousand-year slumber. ', 2080),
(2080, 'Calling upon her ancient love, Malfurion Stormrage, Tyrande succeeded in galvanizing her defenses and driving the Legion back. With Malfurion\'s help, nature herself rose up to vanquish the Legion and its Scourge allies.', 2081),
(2081, 'While searching for more of the hibernating druids, Malfurion found the ancient barrow prison in which he had chained his brother, Illidan. Convinced that Illidan would aid them against the Legion, Tyrande set him free. Though Illidan did aid them for a time, he eventually fled to pursue his own interests.', 2082),
(2082, 'The night elves braced themselves and fought the Burning Legion with grim determination. The Legion had never ceased in its desire for the Well of Eternity, long the source of strength for the World Tree and itself the heart of the night elf kingdom. If their planned assault on the Tree was successful, the demons would literally tear the world apart.', 0);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(2083, 'During the Legion\'s invasion of Ashenvale, Illidan was released from his barrow prison after ten thousand years of captivity. Though he sought to appease his comrades, he soon reverted to true form and consumed the energies of a powerful warlock artifact known as the Skull of Gul\'dan.', 2084),
(2084, 'By doing so, Illidan developed demonic features and vastly magnified power. He also gained some of Gul\'dan\'s old memories - especially those of the Tomb of Sargeras, the island dungeon rumored to hold the remains of the Dark Titan, Sargeras.', 2085),
(2085, 'Bristling with power and free to roam the world once more, Illidan set out to find his own place in the great scheme of things. However, Kil\'jaeden confronted Illidan and made him an offer he could not refuse. Kil\'jaeden was angered by Archimonde\'s defeat at Mount Hyjal, but he had greater concerns than vengeance.', 2086),
(2086, 'Sensing that his creation, the Lich King, was growing too powerful to control, Kil\'jaeden ordered Illidan to destroy Ner\'zhul and put an end to the undead Scourge once and for all. In exchange, Illidan would receive untold power and a true place amongst the remaining lords of the Burning Legion.', 2087),
(2087, 'Illidan agreed and immediately set out to destroy the Frozen Throne, the icy crystal cask in which the Lich King\'s spirit resided. Illidan knew that he would need a mighty artifact to destroy the Frozen Throne. Using the knowledge he had gained from Gul\'dan\'s memories, Illidan decided to seek out the Tomb of Sargeras and claim the Dark Titan\'s remains.', 2088),
(2088, 'He called in some old Highborne debts and lured the serpentine naga from their dark undersea lairs. Led by the cunning witch Lady Vashj the naga helped Illidan reach the Broken Isles, where Sargeras\' Tomb was rumored to be located.', 2089),
(2089, 'As Illidan set out with the naga, Warden Maiev Shadowsong began to hunt him. Maiev had been Illidan\'s jailor for ten thousand years and relished the prospect of recapturing him. However, Illidan outsmarted Maiev and her Watchers and succeeded in claiming the Eye of Sargeras despite their efforts. With the powerful Eye in his possession, Illidan traveled to the former wizard-city of Dalaran.', 2090),
(2090, 'Strengthened by the city\'s ley power lines, Illidan used the Eye to cast a destructive spell against the Lich King\'s citadel of Icecrown in distant Northrend. Illidan\'s attack shattered the Lich King\'s defenses and ruptured the very roof of the world. At the final moment, Illidan\'s destructive spell was stopped when his brother Malfurion and the Priestess Tyrande arrived to aid Maiev.', 2091),
(2091, 'Knowing that Kil\'jaeden would not be pleased with his failure to destroy the Frozen Throne, Illidan fled to the barren dimension known as Outland: the last remnants of Draenor, the orcs\' former homeworld. There he planned to evade Kil\'jaeden\'s wrath and plan his next moves.', 2092),
(2092, 'After they succeeded in stopping Illidan, Malfurion and Tyrande returned home to Ashenvale Forest to watch over their people. Maiev, however, would not quit so easily, and followed Illidan to Outland, determined to bring him to justice.', 0),
(2093, 'At this time, the undead Scourge had essentially transformed Lordaeron and Quel\'Thalas into the toxic Plaguelands. There were only a few pockets of Alliance resistance forces left. One such group, consisting primarily of high elves, was led by the last of the Sunstrider dynasty: Prince Kael\'thas. ', 2094),
(2094, 'Kael, an accomplished wizard himself, grew wary of the failing Alliance. The high elves grieved for the loss of their homeland and decided to call themselves blood elves in honor of their fallen people. Yet as they worked to keep the Scourge at bay, they suffered greatly at being cut off from the Sunwell that had empowered them. ', 2095),
(2095, 'Desperate to find a cure for his people\'s racial addiction to magic, Kael did the unthinkable: he embraced his people\'s Highborne ancestry and joined with Illidan and his naga in hopes of finding a new magical power source upon which to feed. The remaining Alliance commanders condemned the blood elves as traitors and cast them out for good.', 2096),
...
(2097, 'Ner\'zhul, the Lich King, knew that his time was short. Imprisoned within the Frozen Throne, he suspected that Kil\'jaeden would send his agents to destroy him. The damage caused by Illidan\'s spell had ruptured the Frozen Throne; thus, the Lich King was losing his power daily. Desperate to save himself, he called his greatest mortal servant to his side: the death knight Prince Arthas.', 2098),
(2098, 'Though his powers were drained by the Lich King\'s weakness, Arthas had been involved in a civil war in Lordaeron. Half of the standing undead forces, led by the banshee Sylvanas Windrunner, staged a coup for control over the undead empire. Arthas, called by the Lich King, was forced to leave the Scourge in the hands of his lieutenant, Kel\'Thuzad, as the war escalated throughout the Plaguelands.', 2099),
(2099, 'Ultimately, Sylvanas and her rebel undead (known as the Forsaken) claimed the ruined capital city of Lordaeron as their own. Constructing their own bastion beneath the wrecked city, the Forsaken vowed to defeat the Scourge and drive Kel\'Thuzad and his minions from the land.', 2100),
(2100, 'Weakened, but determined to save his master, Arthas reached Northrend only to find Illidan\'s naga and blood elves waiting for him. He and his nerubian allies raced against Illidan\'s forces to reach the Icecrown Glacier and defend the Frozen Throne.', 0),
(2101, 'Even weakened as he was, Arthas ultimately outmaneuvered Illidan and reached the Frozen Throne first. Using his runeblade, Frostmourne, Arthas shattered the Lich King\'s icy prison and thereby released Ner\'zhul\'s enchanted helm and breastplate.', 2102),
(2102, 'Arthas placed the unimaginably powerful helm on his head and became the new Lich King. Ner\'zhul and Arthas\' spirits fused into a single mighty being, just as Ner\'zhul had always planned. Illidan and his troops were forced to flee back to Outland in disgrace, while Arthas became one of the most powerful entities the world had ever known.', 2103),
(2103, 'Currently Arthas, the new and immortal Lich King, resides in Northrend; he is rumored to be rebuilding the citadel of Icecrown. His trusted lieutenant, Kel\'Thuzad, commands the Scourge in the Plaguelands. Sylvanas and her rebel Forsaken hold only the Tirisfal Glades, a small portion of the war-torn kingdom.', 0),
(2104, 'Though victory was theirs, the mortal races found themselves in a world shattered by war. The Scourge and the Burning Legion had all but destroyed the civilizations of Lordaeron, and had almost finished the job in Kalimdor. There were forests to heal, grudges to bury, and homelands to settle. The war had wounded each race deeply, but they had selflessly banded together to attempt a new beginning, starting with the uneasy truce between the Alliance and Horde.', 2105),
(2105, 'Thrall led the orcs to the continent of Kalimdor, where they founded a new homeland with the help of their tauren brethren. Naming their new land Durotar after Thrall\'s murdered father, the orcs settled down to rebuild their once-glorious society.', 2106),
...
(2109, 'Proudmoore\'s armada posed a serious threat to the stability of the region. As a renowned hero of the Second War, Jaina\'s father was a staunch enemy of the Horde, and he was determined to destroy Durotar before the orcs could gain a foothold in the land.', 2110),
(2110, 'The Grand Admiral forced Jaina to make a terrible decision: support him in battle against the orcs and betray her newfound allies, or fight her own father to maintain the fragile peace that the Alliance and the Horde had finally attained. After much soul-searching, Jaina chose the latter and helped Thrall defeat her crazed father. ', 2111),
(2111, 'Unfortunately Admiral Proudmoore died in battle before Jaina could reconcile with him or prove that orcs were no longer bloodthirsty monsters. For her loyalty, the orcs allowed Jaina\'s forces to return home safely to Theramore.', 0),
...
-Frang, Warrior Trainer', 0),
(2151, 'Arellas Fireleaf
High Wizard of the Scarlet Crusade 
Citizen of Quel\'Thalas  
Locked in eternal combat with the Necromancer Diesalven', 0),
(2152, 'Admiral Barean Westwind
Grand Admiral of the Scarlet Fleet 
Citizen of Kul\'Tiras
Lost off the Frozen Coast of Northrend', 0),
...
Last seen in the Mountains of Alterac', 0),
(2171, 'Fellari Swiftarrow
Ranger Captain of the Scarlet Crusade
Citizen of Quel\'Thalas
Lost in the forests of Silverpine', 0),
(2172, 'Ferren Marcus
...
Killed defending the Scarlet Monastery at the First Summertide Assault', 0),
(2173, 'Harthal Truesight
Lord Paladin of the Scarlet Crusade 
Citizen of Azeroth - Knight of the Silver Hand
Last seen entering the cursed city of Stratholme', 0),
(2174, 'Holia Sunshield$bDefender of the Scarlet Crusade$bKilled while slaying the Dreadlord Beltheris', 0),
(2175, 'Invar One-Arm
The first Chief Assassin of the Scarlet Crusade 
Citizen of Dalaran
Last seen on the shores of Northrend', 0),
(2176, 'Orman of Stromgarde
...
(2178, 'Yana Bloodspear$bThe Second Chief Assassin of the Scarlet Crusade$bCitizen of Dalaran$bLost in the Tirisfal Glades', 0),
(2191, 'About 16,000 years ago (long before the night elves foolishly called down the wrath of the Burning Legion), trolls lorded over much of Kalimdor (then a single continent). There were twin troll empires -- the Gurubashi Empire of the southeastern jungles -- and the Amani Empire of the middle forestlands.', 2192),
(2192, 'There were smaller tribes that lived far to the north (in the region now known as Northrend). These tribes founded a small nation known as Gundrak, but never achieved the size or prosperity of the southern empires.', 2193),
(2193, 'The Gurubashi and Amani empires had little love for one another, but rarely warred against each other. At the time, their greatest common enemy was a third empire -- the civilization of Azj\'Aqir. The aqir were intelligent insectoids who ruled the lands of the far west. These clever insectoids were greatly expansionistic and incredibly evil. The aqir were obsessed with eradicating all non-insect life from the fields of Kalimdor. ', 2194),
(2194, 'The trolls fought them for many thousands of years, but never succeeded in winning a true victory over the aqir. Eventually, due to the troll\'s persistence, the aqiri kingdom split in half as its citizens fled to separate colonies in the far northern and southern regions of the continent. ', 2195),
(2195, 'Two aqiri city-states emerged -- Azjol-Nerub in the northern wastes, and Ahn\'Qiraj in the southern desert. Though the trolls suspected that there were other aqiri colonies beneath Kalimdor, their existence was never verified.', 2196),
(2196, 'With the insectoids driven into exile, the twin troll empires returned to business as usual. Despite their great victory, neither civilization expanded much farther than their original boundaries. However, ancient texts speak of a small faction of trolls that broke off from the Amani Empire and founded their own colony in the heart of the dark continent. ', 2197),
(2197, 'There, these brave pioneers discovered the cosmic Well of Eternity which transformed them into beings of immense power. Some legends suggest that these adventurous trolls were the first night elves, though this theory has never been proven.', 0),
(2198, 'Aside from their shadowy origins, it is clear that the night elves came to power soon after their discovery of the Well of Eternity. Despite the trolls\' attempts to keep them from expanding their territories, the night elves built up a mighty empire that expanded rapidly across primordial Kalimdor. Wielding fierce magics never before imagined by the superstitious trolls, the night elves had little trouble doing what the evil aqir could never do: topple the two greatest empires in the world.', 2199),
(2199, 'The night elves systematically dismantled the troll\'s defenses and supply chains. The trolls, unable to counter the elves\' destructive magics, buckled under the onslaught. The night elves proved to be every bit as cunning and bloodthirsty as the savage trolls -- incurring the latter race\'s eternal hatred and disdain. The Gurubashi and Amani empires fragmented within only a few short years.', 2200),
(2200, 'Eventually, the night elves were burned by the arcane fires they had sought to control. Their reckless use of magic had lured the demonic Burning Legion to the world. The demons crushed much of the night elves\' civilization. Though there are no records to indicate that the Legion attacked either troll civilization, it is likely that battles took place across the breadth of the continent. ', 2201),
(2201, 'At the end of this terrible conflict -- known as the War of the Ancients -- the Well of Eternity imploded. The resulting shockwave shattered the greater landmass of Kalimdor. The center of the continent was blasted beneath the sea, leaving only a small group of broken, single continents.', 2202),
(2202, 'Thus, great chunks of both the Amani and Gurubashi Empires still exist in the present day lands of Quel\'Thalas and Stranglethorn (respectively). The Azj\'Aqir kingdoms of Azjol-Nerub and Ahn\'Qiraj have also survived in present day Northrend and Tanaris (respectively).   

Both troll civilizations recoiled from the vast destruction of the primordial world they had known. The dauntless trolls rebuilt their ravaged cities and set about to reclaim some of their former power.', 0),
(2203, 'The long centuries following the Great Sundering of the world were difficult ones for the troll race. Famine and terror were commonplace within the broken kingdoms. The Gurubashi trolls, driven to desperate ends, sought aid from ancient, mystical forces. Though both of the troll kingdoms shared a central belief in a great pantheon of primitive gods, the Gurubashi fell under the sway of the darkest one.', 2204),
(2204, 'Hakkar the Soulflayer, a vile, bloodthirsty spirit, heard the trolls\' call and decided to aid them. Hakkar gave his secrets of blood to the Gurubashi and helped them extend their civilization across most of Stranglethorn Vale and certain islands of the South Seas. Though he brought them great power, Hakkar wanted more and more for his efforts.', 2205),
(2205, 'The bloodthirsty god demanded souls be sacrificed to him daily. He dreamed of gaining access to the physical world so he could devour the blood of all mortal creatures. In time the Gurubashi realized what kind of creature they had courted with -- and turned against him. The strongest tribes rose up against Hakkar and his loyal priests -- the Atal\'ai.', 2206),
(2206, 'The terrible war that ensued between Hakkar\'s followers and the rest of the Gurubashi tribes is spoken of only in whispers. The budding empire was shattered by the magic unleashed between the angry god and his rebel children. Just as the battle seemed most hopeless, the trolls succeeded in destroying Hakkar\'s avatar and banishing him from the world. ', 2207),
...
(2215, 'Go to the place of power above the Spirestone domain, beyond the Skitterweb Tunnels.  At that place are piled the skulls of Urok\'s enemies and rivals.  It is here where you must drive the pike with Omokk\'s head!$B$BWhen the head is in place, Urok is sure to come... but first he will send his minions against you.  Defeat them, and in time Urok himself will be summoned.$B$BKill Urok and retrieve my magic.  With my powers returned, I will reward you.', 2216),
(2216, 'Luck to you.  And here is a clue that may help in your trials against Urok\'s minions:$B$BThe spell Omokk uses against the ogres, the one that strikes them dead, may still have power after you kill Omokk.  During your fight with Urok\'s minions, invoke the power in Omokk\'s head -- with luck, Omokk will strike down Urok\'s minions!$B$BFitting irony.', 0),
(2217, 'In loving memory of Jesse Morales', 0),
(2231, 'Missing Text', 0),
(2232, 'Agasham,$b$bOur plans must be kept secret at all costs! It will be disasterous if the other tauren tribes discover our affiliation.$b$bSigned,$b$bHarbinger Elm', 0),
(2233, 'Agasham,$b$bWorking together, our forces will be more powerful than all of the tauren tribes put together! Yet, we require your total obedience. Remember, your people will be rewarded only after our plans come to fruition!$b$bSigned,$b$bHarbinger Rex', 0),
(2234, 'Agasham,$b$bOur agents from Lordaeron will meet with your delegates, soon. We will notify you once we\'ve found an appropriate location for our summit.$b$bSigned,$b$bHarbinger Grakus', 0),
(2251, 'Attackers... from all sides.$B$BCan see it in their eyes. Timbermaw are evil. Enemy.$B$BMust protect tribe. Must protect Winterfall. Must drive intruders from our land.', 2413),
(2271, 'Nataka, all is well in Thousand Needles. The centaur annoyance is nothing more than that...occasionally attacking, nothing substantial as a real threat. However, there does seem to be some news of centaur clans uniting.$B$BWe always pondered the threat of a united ruthless race such as the centaur... I try not to dwell on such ideas, as you know... nothing could penetrate the pure hatred they have... even of each other.$B$B-Cliffwatcher Longhorn', 0),
(2291, 'Archbishop Alonsus Faol
...
This Cathedral stands not only as a bastion of the Holy Light, but as a lasting testament to one man\'s noble spirit and generosity. ', 0),
(2292, 'King Llane I of the House of Wrynn

Liege Lord of Stormwind 

Defender of Azeroth', 0),
(2293, 'Commander of the Alliance Fleets
...
(2305, 'In time, the child, Cenarius, grew to the stature of his proud father. A brother to both the trees and the stars, the great hunter roamed the far places of the world, singing the harmonious songs of the dawning. All creatures bowed before his grace and beauty - there were none so cunning as the son of the moon and the white stag.', 2306),
(2306, 'Eventually, Cenarius befriended the Shu\'halo and spoke to them of the turning world. The children of the earth knew him as brother and swore to help him care for the fields of life and the favored creatures of their great Earthmother. ', 2307),
(2307, 'Cenarius taught the children of the earth to speak to the trees and plants. The Shu\'halo became druids and worked great deeds of magic to nurse the land to health. For many generations the Shu\'halo hunted with Cenarius and kept the world safe from the shadows that stirred beneath it.', 0),
...
(2311, 'This intact pteradon skeleton was recovered from the remote Un\'Goro Crater. Based on the skeletal structure, it is clear that this specific genus has not yet been encountered. This skeleton could have been preserved for any number of centuries beneath the region\'s rich soil. 
', 0),
(2350, 'This intact pteradon skeleton was recovered from the remote Un\'Goro Crater. Based on the skeletal structure, it is clear that this specific genus has not yet been encountered. This skeleton could have been preserved for any number of centuries beneath the region\'s rich soil.', 0),
(2351, '<HTML>
<BODY>
...
', 0),
(2371, 'The Annals of Darrowshire$b$bDarrowshire, named from the Darrowmere Lake to its west, is a village tucked into the southern foothills of Lordaeron. Known for humble yet hardworking residents, Darrowshire stayed in the background of Lordaeron history until the Second War.$b$bHeroes were made during that war. And heroes were lost.', 2372),
(2372, 'The Battle of Darrowshire$b$bThe Battle of Darrowshire took place in the middle of the Second War, when scourge forces rampaged across Lordaeron. Darrowshire was cut off from the bulk of Alliance forces, but the town was bolstered by a company of troops, a contingent of paladins of the Silver Hand, and a staunch group of local militia led by Captain Joseph Redpath.', 2373),
(2373, 'The Scourge\'s first assaults on Darrowshire were sparse. Small groups of marauding skeletons and corpses wandered the outskirts of the village and were repelled.$b$bBut the Scourge were not balked by the defender\'s tenacity, and responded in kind; soon after the first wave of attacks a second wave emerged. Champion ghouls, servants of the ghoul lord Horgus, screamed down from the hills and clashed with beleaguered Darrowshire defenders.', 2374),
(2374, 'The Defenders weakened, but were relieved by paladins, disciples of the Silver Hand. Their leader, Davil Crokford, was a native of Darrowshire. He brought his followers to the village when he heard of the impending attack, and together with the defenders they held back the servants of Horgus.$b$bWhen Horgus himself entered the battle, he met with Davil. For many minutes they fought and Davil eventually prevailed, but he suffered a mortal wound and died soon after defeating the ghoul lord.', 2375),
(2375, 'The battle continued, and Captain Redpath led his militia bravely. And it might have been won, had the captain not been corrupted by the death knight Marduk the Black.$b$bIn the middle of the fray Marduk rode up to Redpath, and with black magic he tore loose Redpath\'s spirit, twisting it into an evil shadow of the brave captain.', 2376);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(2376, 'The corrupted Captain Redpath then spread his evil taint among the defenders of Darrowshire, who betrayed their allies and slaughtered them. They then turned on the town of Darrowshire and killed all who hid in their homes.$b$bThe remaining scourge army, along with the corrupted spirit of Captain Redpath, then left the ravaged village of Darrowshire and tore into Lordaeron, adding to the pain and death of the Second War.', 0),
...
But the Scourge sensed the defenders\' tenacity, and responded in kind; soon after the first wave of attacks a second wave emerged.  Champion ghouls, servants of the ghoul lord Horgus, screamed down from the hills and clashed with beleaguered Darrowshire defenders.', 2380),
...
When Horgus himself entered the battle, he met with Davil.  For many minutes they fought and Davil eventually prevailed, but he suffered a mortal wound and died soon after defeating the ghoul lord.', 2381),
...
In the middle of the fray Marduk rode up to Redpath, and with black magic he tore loose Redpath\'s spirit, twisting it into an evil shadow of the brave captain.', 2382),
...
The remaining scourge army, along with the corrupted spirit of Captain Redpath, then left the ravaged village of Darrowshire and tore into Lordaeron, adding to the pain and death of the Second War.', 2383),
...
Days later, the company of Scourge who possessed the head were defeated by Silver Hand Paladins.  Horgus\' head was cast into Blackwood Lake.', 2384),
...
Marduk\'s sword sank into the earth and corrupted it, eating a gorge into the land, now known as the Infectis Scar.', 2385),
...
His book, his paladin\'s libram, was recovered by Scarlet Crusade troops.  It now resides in the town hall of the Scarlet Crusade controlled Hearthglen, often read by crusaders eager to draw from Davil\'s strength.', 2386),
...
At Gahrron\'s Withering, east of Andorhal, the corrupted Redpath was finally defeated by Alliance forces.  His shield still rests near the barn of the plagued farmstead, and Scourge minions are still drawn to the memory of his evil.', 2391),
...
Grateful for their charity, Carlin joined the ranks of the Argent Dawn and now fights a battle of revenge against the Scourge.', 0),
(2411, 'OoOoOoO OOoOOoo OOOoOoo OOoOooO OOoOOoO OOooooO Oooooo OooOOOO OOoOOOo OOoOOoo OOoOooO OOoOOOo OOooOoO Oooooo OooOOOo OOooooO OOOoooo OOooooO Oooooo OoOoOOo OOooooO OOoOOoo OOoOOoo OOooOoO OOOOooO Oooooo OooOoOO OOoOOOo OOoOooO OOooOOO OOoOooo OOOoOoo OOOooOO Oooooo OOoOOOO OOooOOo Oooooo OooooOO OOoOooo OOooooO OOoOOOO OOOooOO', 0),
(2413, 'Snow, blinding...$B$BMust protect tribe. Make them strong. Be strong.$B$BDo not know...', 2414),
(2414, 'Firewater.$B$BMake more. More firewater.$B$BFirewater make Winterfall strong. Defeat our enemies.$B$BWinterfall have no ally. Winterfall are strong. Have great power.', 2415),
(2415, 'More. Must have more...$B$BWinterfall... not... weak...', 0),
(2431, 'Entry Date: Unknown$B$BName: Nathanos Marris, Human Ranger Lord of Lordaeron.$B$BEntry:$B$BKael\'thas Sunstrider\'s dissention in regards to my decision to allow Nathanos Marris into the order is noted. It should also be noted that Nathanos - although a human - is one of the most gifted rangers I have ever had the pleasure of training.$B$B(continued)', 2471),
(2432, 'Never been more proud to be part of the trade as I am in these last few years. The need for assassins, spies, and scouts has never been more prevelant. You\'d think war-time would have had higher demand, but suprisingly, war isn\'t a time we flourish like we do now--the times after peace starts to deteriorate.$B$BI was told you\'d be in the area looking to learn a few things. When you have time, come see me by the stables in back of the abbey.$B$B-Jorik Kerridan, Rogue Trainer', 0),
(2433, 'You were expecting this to be a normal note from your king or whoever, I\'m betting. Well, let\'s just say that I know a thing or two about forging notes and wanted to make sure you got this one. Can\'t go calling attention to myself, now could I?$B$BI\'ve holed myself up inside Anvilmar--you\'ll find me in the firepit area. When you\'re ready, come talk to me. I just want to introduce myself while we have time.$B$B-Solm Hargrin, Rogue Trainer', 0),
(2434, 'I send greetings, $N. I was lost in thought when it came to my attention that I needed to write to you.$B$BMany in our culture praise our shamans for being our spiritual leaders, like our great Warchief. Others think the sword and axe are even more noble pursuits, but never forget that battles--even wars--are won on the backs of those with more specialized skills. That is what I wish to speak to you about, $N. Find me deep within the Den in the Valley of Trials.$B$B-Rwag, Rogue Trainer', 0),
(2435, '$gBrother:Sister;, I hope this rune finds you well. I wanted to take a moment to let you know that I\'m inside Anvilmar above Coldridge Valley.$B$BI know how important it is we all stick together, and in this time of strained peace it\'s becoming even more important to have our kind around. Look for me when you have the time. $B$B-Solm Hargrin, Rogue Trainer', 0),
(2436, 'Take care not to ignore my words, $N. This is the time for subterfuge and deceit throughout all nations... even our great Undercity. Everyone loyal to Sylvanas is working towards creating a new era, one controlled by the Forsaken. And even though we posses no magical skills, nor will we take up weapons along our borders, we still have our own role to play.$B$BSeek me out in the inn in Deathknell. We\'ll speak more then.$B$B-David Trias, Rogue Trainer', 0),
(2437, 'Sael\'ah, my friend. I hope this sigil finds you well. I was asked to offer you my services. I too am in Shadowglen, in the great tree of Aldrassil, and I wanted you to know that if you need any training that you could seek me out.$B$BIn these questionable times, I thought it prudent that those dealing in stealth remain even closer to one another. How else will we be able to protect Teldrassil and our ways?$B$BFind me when you can.$B$B-Frahun Shadewhisper, Rogue Trainer', 0),
(2438, 'Greetings, $gbrother:sister;. The Shattered Hand sends its regards and hopes you find the Valley a comfortable place to apply your trade. This is a time of testing for you, so do not think you are not being watched constantly.$B$BIt is my duty to appraise the Hand of your skills, and to then inform them when I feel you are ready to move on to greater challenges.$B$BWhen you are ready, come find me deep inside the Den. I\'ll be waiting for you there.$B$B-Rwag, Rogue Trainer', 0),
(2439, 'Tell me, $c, have you heard an orc scream yet? Perhaps defended your home from gnolls as they seek to tear your throat out? Yeah, sounds harsh, doesn\'t it?$B$BWell, you\'re gonna need my help if you want to protect your loved ones. You\'ll find me inside the abbey in Northshire. My knowledge doesn\'t come cheap, but if you\'re experienced enough, I can train you in a number of styles and moves that will help you fight off the threats to Stormwind and beyond.$B$BLlane Beshere, Warrior Trainer', 0),
(2440, 'ATTENTION:$BYou must report to Thran Khorman immediately. He is located within building A3; also known as Anvilmar to local inhabitants. After successfully making contact with Khorman, you will proceed to prepare yourself for the coming war--the war to take back our home of Gnomeregan!$B$BAll efforts and essential tasks should be focused on achieving this directive. Once accomplished, a new task will be given to you.', 0),
...
(2442, 'By Magni\'s beard, there\'s much to discuss, and little time to do it, $N. Find me in Anvilmar overlooking Coldridge Valley as soon as you can. We gotta get started.$B$BThere\'s a mess of things I can tell you about to get you caught up to speed, but all that\'s got nothing to do with us... for now. What we need to focus on is the grip of an axe, the weight of our armor, and the smell of our own sweat beadin\' down our foreheads as we fight our enemies. We\'ll start with that.$B$B-Thran Khorman, Warrior Trainer', 0),
(2443, 'Many of our kind resort to the arcane and divine as a means to give themselves strength, but we know better, don\'t we, $c? We know that our weapons are our holy symbols, our shield is our spell book, and our mail is our wisdom.$B$BEven in undeath we are strong, and we will only become stronger.$B$BFind me in the inn in Deathknell. I will speak to you more of these matters and other things.$B$B-Dannal Stern, Warrior Trainer', 0),
(2444, 'I hope my sigil finds you well, $c. I write to you because our people have need for those strong with the blade, the glaive, and all other weapons. So much has happened since our people have been reintroduced to the other races of Azeroth that we have an even greater need for protectors of all kinds.$B$BThis is where you come in. I would tell you more, but I feel it should be in person. Find me inside Aldrassil... on the lower levels.$B$B-Alyissia, Warrior Trainer', 0),
(2445, 'There are four rules to magic:$B$B   Magic is powerful.$B   Magic is corrupting.$B   Magic is addicting.$B   Magic draws the denizens of the Twisting Nether to those who wield the arcane.$B$BThose rules you can always guarantee. Those rules will govern your destiny if you chose to continue down the path as a mage.$B$BIf you\'re foolish enough to ignore this warning, then come speak to me inside the library wing of the abbey in Northshire. I\'ll be waiting for you upstairs.$B$B-Khelden Bremen, Mage Trainer', 0),
(2446, 'To: New Students of the Arcane Arts:$BYou are required to seek out and study under the gnome Marryk Nurribit until such time comes that you are called upon to aid your people in re-establishing themselves in a new habitation. Please, without trepidation, prepare yourself for rigorous testing procedures and a difficult acclimation process as you find a domicile and/or any form of companionship with the local denizens.$B$BQuestions regarding your duties and abilities should be directed to Marrek Nurribit.', 0),
(2447, 'The corruption and evil that rumor says travels with the arcane is nothing compared to the pain we\'ve already felt. We are no longer victims, $N. We are the ones who control our fate. Sylvanas has paved the way for us--she has proven that our will is our own; that we are no longer thralls to that bastard Arthas.$B$BSeek me out in the church, I shall instruct you further... if that is your desire.$B$B- Isabella, Mage Trainer', 0),
(2448, 'Welcome to your awakening, mon. Da secrets of da arcane be wit\'in your grasp if you be strong enough to hold onto dem.$B$BYou find Mai\'ah when you be ready. She teach you much about magic and da spells you need to destroy those dat stand against you.$B$BMai\'ah be near da Den in da Valley of Trials. You come, you find her, den you be strong. Den you show other mages how magic bends to your will... not de other way \'round.', 0),
(2449, 'Too often people like the followers of the Holy Light scare those curious about true power into thinking they cannot investigate any form of the arcane--not all things from outside this world are evil. Not all entities seek to dominate or subjugate others. If you are powerful enough, those same entities can become the followers.$B$BThis is something I would like to discuss more with you. Seek me out in the graveyard on the right side of the abbey.$B$B-Drusilla La Salle, Warlock Trainer', 0),
(2450, 'ATTENTION:$B$BRemain Silent! Don\'t look around at anyone! Someone could be watching you this very moment.$B$BMy name is Alamar Grimm, $N. I train those willing to seek knowledge and greater power from... worlds beyond. I\'ve been asked to get in touch with you discretely and inform you that I can train you further in a real form of magic.$B$BWhen you can, come find me in the back of Anvilmar.$B$B-Alamar Grimm, Warlock Trainer', 0),
(2451, 'I write this message in the most powerful inks I can create, $N. It would instantly curse anyone who would dare read it besides yourself. I am that powerful. I summon demons from the Twisting Nether at my leisure. I plague my enemies in their sleep and in the field of battle. And now you too have seen the power of my path. My brothers are pleased by that.$B$BSeek me out in the depths of the Den once you\'ve found your way around. I would speak to you about important matters.$B$B-Nartok, Warlock Trainer', 0),
(2452, 'An awful predicament to find ourselves in, isn\'t it, $N? Plagued by the Foul Prince. Ostracized and spurned by our own loved ones. We finally have our own will thanks to the beautiful Sylvanas, but what does that afford us now? Slaves to a different master is still a slave, or so I say.$B$BBut what if we were the masters? Yes, you know what I mean, don\'t you?$B$BWe are even more separated from the rest of the Forsaken, $N. And that is why we must speak further. Find me in the church in Deathknell.', 0),
(2453, 'Mighty warriors defend our home. Our shamans guide our spirits and show us our ancestors\' past. And our druids help us discover the Earthmother\'s will.$B$BBut you are one of our hunters, and our hunters learn many aspects of those roles and blend them together. You will find you represent the heart of our people--some of our tribe will look to you for guidance, some for protection. It is my duty to ensure you are prepared for that. Seek me out in Camp Narache.$B$B-Lanka Farshot, Hunter Trainer', 0),
(2454, 'Ya be in good hands now, mon. Jen\'shan know you be lookin\' to learn da ways of da hunter, and she be ready to teach you... if you be ready to listen.$B$BCome find me in da Valley of Trials. Jen\'shan start your trainin\' and show you just how powerful da ways of da hunter is.$B$B-Jen\'shan, Hunter Trainer', 0),
(2455, 'Tamer of beasts, master marskman, proven tracker--what else ya want to accomplish in this lifetime? All those things combined takes quite a bit of intelligence and a great deal of patience.$B$BThe path of the hunter ain\'t an easy one, that\'s fer sure. You\'re gonna need lots of training if you wanna be as good as even our lowest ranking rifleman. But that\'s why I\'m here.$B$BFind me inside Anvilmar overlooking Coldridge Valley. I\'ll be waiting.$B$B-Thorgas Grimson, Hunter Trainer', 0),
(2456, 'Elune is with you, $N. The wind whispers it to me, and I\'m glad I can directly take part in the shaping of our next generation of hunters.$B$BFrom what I have been told, you are close to Aldrassil. I would meet with you inside the great tree when you have time.$B$BOur elders have charged me with ensuring that new hunters are properly trained for the trials ahead. You being one of the newest students, it would behoove you to visit me. Until then, be well.$B$B-Ayanna Everstride, Hunter Trainer', 0),
(2457, 'It be good to hear that one of Jen\'shan\'s $gbrothers:sisters; be comin\' to da Valley to test $ghis:her; skill. Jen\'shan lookin\' forward to that!$B$BMe not be havin\' to tell you how strong and cunning a hunter you be--you already know that. It\'s Jen\'shan\'s task to tell you how to get stronger and more cunning.$B$BYou find Jen\'shan in da Valley of Trials. She teach you good. She teach you how to tame da greatest beasts among many other tings.$B$B-Jen\'shan, Hunter Trainer', 0),
(2458, 'The spirits came to me in my dreams last night. They told me of your coming, and that it would be my task to aid you. We have much to go over in our short time together--discussions about nature, the spirits, the Earthmother, and even the night elves. But I will save the lessons for your arrival, and I will do all that is in my power to ensure that you are ready for the trials ahead.$B$BMay wisdom guide you. I will be waiting.$B$B-Gart Mistrunner, Druid Trainer', 0),
(2459, 'When word reached me that you were ready, I sent this sigil immediately. All of Cenarius\' druids take great satisfaction in seeing our numbers bolster. The spirits even seem to have become stronger with our enhanced presence. In time, and with some patience, hopefuly our strength will return to its former grandeur. Find me near the top of Aldrassil when you are ready. I will be your guide as long as you are in Shadowglen.$B$B- Mardant Strongoak, Druid Trainer', 0),
(2460, 'I greet you, young $c. The winds told me of your coming. The earth gave praise of your strength. And now the ancient spirits whisper of your accomplishments to come. Our people always need wise and great leaders. They often turn to our kind for both virtues. If you are willing, I would teach you more of our ways.$B$BSeek me out in Camp Narache on Red Cloud Mesa--we will speak more then.$B$B-Meela Dawnstrider, Shaman Trainer', 0),
...
(2465, 'Your connection to the world, and its connection to you, are paramount to your success as a priest. Wisdom and compassion will allow you to help those who have a true need. Overeagerness and clumsy decisions only prevent others from becoming stronger or cause harm.$B$BAs you begin to understand what this means, you will need new abilities and spells to help you. That is where my role begins: find me in the library wing of Northshire Abbey when you are ready to train.$B$B-Priestess Anetta, Priest Trainer', 0),
(2466, 'With the Holy Light warmin\' our backs and new discoveries being made every day, \'tis an exciting time to be one of Ironforge\'s $gsons:daughters;. The Explorer\'s League makes headway every day in its search for long-lost answers to even older questions. And now we have you among our faithful to aid in the battle against the troggs and any other threat to our borders.$B$BFind me when ya have the time. I\'ll be in the back of Anvilmar, just up the hill. $B$B- Branstock Khalder, Priest Trainer', 0),
(2467, 'Feel blessed that your spirit was not released to the Nether, $N. Feel even more blessed that I decided you were worth the effort to write this scroll for.$B$BThe people you once knew, perhaps even cared for, are no longer! You must learn to "live" with that for the rest of your now unnatural life. I suggest you learn to deal with that first.$B$BIf you think you\'re ready for the trials ahead, then seek me out in the church in Deathknell.$B$B- Dark Cleric Duesten, Priest Trainer', 0),
(2468, 'I hope this sigil finds you well, $N. The spirits told me of your coming and I sent word immediately. I look forward to sharing my experiences with you, and helping guide you as you prepare to leave Teldrassil for more important matters.$B$BWith all that has happened in the last few years, there is much we can do to aid the other races of Azeroth. When you are ready, find me inside Aldrassil, on the second level.$B$B-Shanda, Priest Trainer', 0),
(2469, 'Ah hope da spirits have protected ya thus far, mon. Ya have many tests ahead of ya, and ah be willin\' to share me experiences witcha when yer ready. It be up to ya to decide how quickly and how powerful ya become. Ah can only guide ya once yer ready.$B$BFor some, dat be real quick-like; for others... not so fast. But doncha be worryin\' \'bout dat none. We can talk more when ya come to see me.$B$B-Ken\'jai, Priest Trainer', 0),
(2471, 'For millennia we have isolated ourselves from outsiders. I will be the first among us to admit that mistakes were made in the past. Humans should have never been exposed to magic. I will not deny this but I will not condemn us to this guarded existance for the blunders of our predecessors. There is much that a coexistance between the Quel\'dorei and other races of this world can bring. We must practice tolerance.$B$B(continued)', 2472),
(2472, 'It is with these words, then, that I deny Kael\'s request in regards to Nathanos Marris. He will prove to be an invaluable ally. Mark my words.$B$BSigned,$B$BSylvanas Windrunner$BRanger General of Silvermoon', 0),
(2490, 'I hope this sigil finds you well, $N. The spirits told me of your coming and I sent word immediately. I look forward to sharing my experiences with you, and helping guide you as you prepare to leave Teldrassil for more important matters.$B$BWith all that has happened in the last few years, there is much we can do to aid the other races of Azeroth. When you are ready, find me inside Aldrassil, on the second level.$B$B-Shanda, Priest Trainer', 0),
(2491, 'Grish-$B$BYour request for some time off has been accepted. I am sending a reserve Tauren warrior to watch your post while you take time off to spend with your family. Report back in one week!$B$B-Maggran Earthbinder', 0),
(2511, 'Dear Zargh,$B$BThe steaks you sent are fine.  Well marbled, thickly sliced and packed in boar fat.  They\'re just how I like them.  When I eat them later, I will think of you as I gnaw on the last bits of bone and grisle.  I will close my eyes and see your strong, scarred hands chopping and cutting...$B$BHah!  That reminds me of when you had your accident and lost a finger... Oh, Zargh!  Thinking of that day makes me giggle like a little girl.$B$BYou\'re so cute when you\'re bleeding!$B$B-Gryshka', 0),
(2512, 'Osric,
...
Fulfillment of this order is to be considered a direct command of the Dark Lady, and those responsible will be brought to Her attention, as will any who oppose or otherwise hamper Her wishes.', 0),
(2531, 'This 3 page document is blank.', 0),
(2551, 'Layo:$B$BWe have received the generous help of this fine adventurer.  I have dispatched the adventurer to you in Silithus as a resource.  Please see that such a valuable resource does not go to waste in your efforts to unlock the secrets present there.  The Circle eagerly awaits news of progress.$B$BMay Cenarius watch over you...$BRabine', 0),
(2571, 'The Feast of Winter Veil$B$BThe later seasons of Azeroth are marked as a time of change in many cultures.  The dwarves and the tauren especially look to a legend of the coming Winter Veil - the blanketing of the land in snow, thus heralding a time of renewal - as a time for celebration.  Though the understanding of the legends that the races of Azeroth share are not dissimilar, the ways they choose to acknowledge them are as diverse as the races themselves.', 2572),
(2572, 'The Legend of Greatfather Winter$B$BThe term "Winter Veil" is said to stem from a supernatural being referred in many cultures to as Greatfather Winter.  As he would walk the land late in the seasons, winter itself would be his billowing cloak.  In his wake was the blanketing of the land in snow, and thus it is said that Greatfather Winter would cast his wintry veil over the land.  Though parts of Azeroth may lie in snow, it gives the land time for rebirth and renewal.', 2573),
(2573, 'The Dwarves$B$BEver consumed with the research of their origins, the dwarves choose to celebrate the season as a recognition of Greatfather Winter himself.  They consider him to be the personification of one of the ancients of Azeroth - the titans.  Much as they claim lineage in one degree or another to these mystical beings, they consider their snowy home of Dun Morogh as the prime example of Greatfather Winter\'s blessings.', 2574),
(2574, 'The Tauren$B$BThe tauren and their shamanistic understanding of winter, along with their recent emergence into druidic endeavors, fit in well with the legend of Winter Veil.  They focus almost entirely on the renewing aspects of the lore however, leaving legend worship to those races (as they view it) less in tune with the nature of things.  Many tauren choose this time as the right time to give thanks for the blessings of their new home in Mulgore.', 2575),
(2575, 'Feasting$B$BThe idea of feasting during this time of year is one that traces its origins to the legend itself.  As Greatfather Winter walked Azeroth, bringing winter in his wake, it is said he would provide a bounty for those who welcomed his presence.  As such, the idea of feasting during the Winter Veil would bring together communities as they shared whatever they had.  Typically, a single day of merriment and feasting welcomed the change, all in anticipation of the land\'s renewal.', 2576),
(2576, 'Modern Day Observation$B$BOther cultures have begun to recognize the Feast of Winter Veil as a time of great celebration, though not in the same traditions as the legend bases it in.  Customs, often unrelated to anything other than a chance for celebration and gift exchange, have made their way into modern day observation of the season.  Even the image of Greatfather Winter is sometimes used, but more as a harbinger of commercial exploit rather than as a supernatural titan.', 0),
(2591, 'Set far back in the Valley of Spears is the holy temple of Maraudon. If that were not transgression enough, you will quickly see why I have asked a non-centaur to aid me in my plight.$B$BThere, just beyond the doors where only spirits and our most sacred priests and priestesses may travel is one called The Nameless Prophet. He is the highest of any tribe in spiritual matters and is one of the oldest of any tribe.', 2592),
...
Ain\'t it amazin\' what you run into in an ordinary day of fishin\'?', 0),
...
(2659, 'When you peer into the Eye, images of a great battle fill your mind..$b$bThis terrifying conflict appears to be taking place somewhere in Lordaeron..$b$bYou can barely make out a lone female figure, standing amidst a thousand corpses, fending off a sea of Scourge..$b$b She is hopelessly outnumbered..$b$bTendrils of light escape her hands, cutting through undead by the hundreds.', 2666),
...
(2666, 'All for naught, it would seem..$b$bMoments later the priestess is swarmed by the corpses of the peasants that were surrounding her....$b$bThe fallen have risen.', 0),
(2671, 'Simone the Seductress:$B$BYou will find Simone befouling Un\'Goro Crater. Do not be fooled by her disguise. Approach her with caution and challenge her to battle.', 2672);

INSERT INTO `page_text` (`entry`, `text`, `next_page`) VALUES
(2672, 'Klinfran the Crazed:$B$BKlinfran wanders the Burning Steppes. Approach him with caution and force him to show his true form.', 2673),
(2673, 'Solenor the Slayer:$B$BIn the arid landscape of Silithus lurks the fiend, Solenor the Slayer. Undoubtedly disguised, definitely a danger. Approach him and force him to transform.', 2674),
(2674, 'Artorius the Doombringer:$B$BArtorius brings corruption and doom to all that he touches in Winterspring. Find him, kill him.', 2675),
(2675, 'Be warned, hunter, these demons must be fought on their own terms. If they feel that they do not outmatch you, they will flee.$B$BGO ALONE.', 0),
(2676, '<HTML>
<BODY>
...
(2696, 'It must also be noted that the Black Lodestone, used to restart the Bell, Wheel or Candle if they fail, requires soul shards.  Each time you restart a ritual object with the Lodestone one of your soul shards will be consumed, so be sure to have a large stock of them before the ritual begins.', 2711),
(2697, 'Completing the Ritual$B$BYou can track your progress by the magic runes along the border of the circle. When nine runes appear then the ritual is complete, and you will see energy rise from the newly empowered Circle.$B$BFrom there, you may invoke the Xorothian Glyphs and open a portal into Xoroth and pull a dreadsteed through it.$B$BDefeat the dreadsteed and release his spirit. Confront the spirit and it will be enthralled, and you will be rewarded with the secret of its summoning.', 0),
(2731, '<HTML>
<BODY>
<BR/>
<BR/>
...
After having done all of this, you are left with the center of the onion: The sweet core. Vanndar Stormpike will be left defenseless and alone. Rules of military conduct require that we ask for his surrender before carrying out any executions. Be sure to mention the surrender thing when you see him... then kill him.', 0),
...
The towers are heavily fortified, each housing one of Drek\'Thar\'s elite Commanders. They must be killed. This will expedite the dismantling of the Frostwolf defenses.', 2782),
...
The Frostwolf Guardians are sent out from the platoons held in reserve at the east and west Frostwolf towers. Destroy those towers and watch the remaining Frostwolf Guardians flee in shame.', 2784),
(2784, 'Epilogue
...
', 0),
(2787, 'His name brought Light to darkest Azeroth.$B$BHis valor tore the walls of mis\'ry down.$B$BThe Silver Hand would ne\'er do better more$B$Bthan give the world the knight who\'d give himself.', 2788),
(2788, 'His fame was not that which he sought to grow,$B$Bnor was the lordship over his own kind.$B$BInstead he chose to fight for Lordaeron$B$Bto hope his kin would have to fight no more.', 2789),
(2789, 'The tragic tale of this most holy knight$B$Bwill never end with his unholy death.$B$BWe honor him, and we shall give him thanks!$B$BUther always shall know glory and Light!', 0),
(2790, 'His name will not die.$BHis sacrifice will always$Bserve to show the way.$B$BShackles once that choked$Bthe inhale of honor\'s breath$Bno longer bind us.', 2791),
(2791, 'Can you hear his scream?$BA battle wail for the Horde:$BVictory or death!$B$BWe must remember$Bhis strength in the face of death.$BHis dream, now made real.', 2792),
(2792, 'Dangers everywhere!$BEnemies seek to bring us$Bback to the shackles.$B$BWhen we fight, think of$Bhe who did what must be done.$BHellscream, forever!', 0),
...
The battle raged on for months. All of Silithus was overtaken by the Qiraji. Staghelm and his army were pushed back to Tanaris. With a decimated army and countless innocents slain, the arrogance that had driven Fandral Staghelm was snuffed out completely.', 2798),
...
Tomorrow we shall construct a wind stone!', 2808),
(2808, 'Day 2
...
Already we are gathering the necessary building materials at great speed.  ', 2809),
(2809, 'Day 15
...
I expect he will be most pleased with us.', 0),
...
', 0),
(2811, 'For immediate dissemination to all Twilight Hammer members.$B$BGiven the current state of affairs in Silithus, all distribution of True Believer texts are to be made under the escort of no less than four armed Twilight Hammer personnel.$B$BAny members found in violation of this new policy will be summarily punished.$B$B-Twilight Lord D\'Sak', 0),
...
For details on the summoning rituals involved, refer to last month\'s True Believer.', 2814),
(2814, 'Abyssal Dukes
...
', 0),
(2816, 'The State of the Cult, Volume 92$B$BIt is with a joyous heart that I greet you, my brethren, for the state of our cult could not be more grand. We are legion, and our goals grow ever closer to fruition.$B$BNew recruits continue to gather. The sing praise to our lords in Darkshore, they bow in jubilant reverie within the Searing Gorge, they embrace our masters\' servant, Aku\'mai, in Blackfathom Deeps. Indeed, my brothers and sisters, soon a swarm of the faithful will blanket all of Azeroth!', 0),
(2817, 'State of the Cult, Volume 127$B$BIt is truly a happy day!  We have been tested in Silithus, and we have passed!$B$BReports of the destruction of our northernmost camp may challenge the hearts of the unfaithful, but this slaughter should not be seen as tragedy. No!', 2818),
(2818, 'The spilling of our blood by one of the Abyssal High Council is a blessing! We must envy our fallen comrades, for their spirits now reside in the belly of a most righteous beast!$B$BPraise to the Old Gods! Praise to their servants! Praise to the Twilight\'s Hammer!', 0),
...
The red stones are critical to our new allies.  We mustn\'t let the Cenarion Circle\'s lapdogs succeed.  Stand firm, my faithful friends.  Stand firm!', 0),
(2820, 'How Do We Know They Love Us?$B$BSome may wonder how the Old Gods and their minions can love us. Do they not kill us? Do they not cause pain and suffering to all? How could beings so bent on malevolence know love in their hearts?$B$BThere is a simple answer to this question. So simple it need not be uttered?', 2821),
(2821, 'Faith. Faith is the wellspring from which the joy of servitude showers us. Faith will keep us warm on the coldest Silithus nights. Faith will keep us in our Lords\' good graces when the Ending Days arrive.$B$BFaith will save us.', 0),
...
P.S. I hope you can figure out a way to actually make an arcanite buoy because I just made that nonsense up on the spot. I have no idea how they\'re going to find Maws.', 0),
(2828, '<HTML>
<BODY>
...
Today, my arch-enemy, Narain Soothfancy, attempted to deceive me by sending cronies to fill his spot at the execution. HIS execution. Can you believe it?$B$BI had gone through all the trouble of devising this diabolical plan to lure him out of that damnable hut and he pulls this? Whatever... Too angry to keep writing. I\'ll be back later.', 2830),
(2830, 'Dear Diary,

I left my hide-out in a rage after my last entry. Boy was I angry. I decided to redesign my minions\' uniforms to better reflect my angst. I feel a little better but something is missing. I\'ll be right back...', 2831),
(2831, 'Dear Diary,

Ok, I\'m good now. I beat one of my minions until he wept like a little girl.$B$BHrm... I feel sort of bad now. Wait a minute! Damnit, I\'m an EVIL genius! Evil, you know? I\'m so disappointed in myself. Be right back.', 2832),
(2832, 'Dear Diary,

I gave him a hug and told him to keep up the good work. I feel better now. Keep that between you and me, diary.$B$BWhere was I? Oh yes, NARAIN! ARGH!!! I hate that guy. It was Narain, after all, that destroyed the curve on every exam back when we were students at the Gnomeregan Institute of Tinkering.$B$BFail me out of school, will they? As far as I\'m concerned, Gnomeregan got what it deserved!$B$BThat\'s all for today. Sleep tight, diary!', 2833),
(2833, 'Dear Diary,

I must be getting old. I totally forgot that I was telling you about Narain and his deception. Anyhow, I was so angry when I saw a decoy disguised as Narain instead of Narain that I commanded Number Two to destroy the fool!$B$BI got in my flying machine and began tearing away at his precious, stupid, dumb-head book on Draconic. What a show-off? Who reads Draconic? I hate him so much!', 2834),
(2834, 'Dear Diary,

Sorry, I fell asleep. So I was flying angry and throwing out chapters of that stupid book. I saw a demon below me in Darkwhisper and decided to make the first chapter form a magical tornado of paper and shred its body into a million pieces! It was liberating. Magic + paper = fun.$B$BThat made me pretty happy so I decided to fly to the Eastern Kingdoms. My first stop was the Molten Core. Narain always talked about that place! "Molten Core this and Ragnaros that..."', 2835),
(2835, 'Well you know what? If he likes it so much, maybe he\'ll like trying to piece his book back together by going to the Molten Core and reviving the chapter back from a pile of ash! Hah!$B$BWhile I was in the neighborhood, I figured some of those slavering technicians in ol\' Victor Nefarius\' lab might have a use for this Draconic stuff. Bombs away!', 2836),
(2836, 'This was starting to become a sport of sorts. I was really getting into splitting up that damned book!$B$BThe next few drops were easy.$B$BUndercity, home of the fetid rotting dead and possibly the best chili I\'ve ever had, got one chapter. Stormwind, capital of Cheese, the other. Diary, have you ever put cheese from Stormwind on Undercity chili? HELLO? That should sound some alarms.', 2837),
(2837, 'I was getting tired at this point so I turned the flying machine around and headed for home, but not before I would make two more stops. I gave Lord Kazzak and his demons a fly by in the Tainted Scar (he hates when I do that) and stuck another down Onyxia\'s chimney.$B$BTired. Going to sleep.', 0),
(2838, 'To Whom It May Concern,

How I love these games that we play. 

I can only assume that if you are reading this letter, you have somehow, through miracle or divine intervention, managed to vanquish me. Preposterous, I know, but stranger things have happened in the history of this world.', 2839),
...
"Nefarian"', 0),
(2841, 'On behalf of Smokywood Pastures, thanks again for looking into this.  We\'re not sure which group has Metzen, but investigating either would be a good place to start!$B$BTime is money friend, and we have very precious little of it in this case.  Be swift in your efforts to rescue, as these groups are not to be taken lightly in what they are capable of.$B$BAnyway, the next two pages are the ransom notes we received.  Good luck...', 2842),
(2842, 'If you want the reindeer back alive, then you\'ll be quick with the ransom.  The Southsea Pirates don\'t take kindly to delays in payment, and we know how valuable the beast is to YOUR form of piracy.$B$BBring the sum of 1000 gold in to the mouth of Lost Rigger Cove in Tanaris.  Any attempt to rescue the reindeer will result in Metzen taking a very long walk off of a very short plank.$B$BYeargh...$B$BThe Southsea Pirates', 2843),
(2843, 'Your prized pet isn\'t doing very well out here in the unrelenting heat of Searing Gorge... you\'ll be wise to meet our demands without delay.$B$BYou will bring us five star rubies and the sum of 700 gold - place both in a single plain package that is free of markings.  Leave the package at the gates to Stonewrought Pass within a week.$B$BFailure to meet our demands will result in Metzen being the main course of a traditional Dark Iron Dwarven Winter Veil feast.$B$BMmmm... reindeer...', 2844),
(2844, 'More rapid than eagles his coursers they came,$B$BAnd he whistled, and shouted, and called them by name;$B$B"Now, Mercer! now, Chilton! now, Jordan and Kaplan!$B$BOn, Nagle! on Pardo! on, Goodman and Metzen!$B$BTo the top of the porch! to the top of the wall!$B$BNow dash away! dash away! dash away all!"
', 0),
...
I believe the future of the sin\'dorei can once again serve as a shining example to all!', 2847),
...
I shall redouble our efforts.', 2849),
...
I\'ve devised an entirely new approach, and if successful, it will allow me to filter out the \'impurities\' in some corrupted, fel magic power sources that I have stashed away. I must proceed with caution.', 2850),
...
With any luck at all, we should be able to refine the process and kill two birds with one stone - an abundant source of energy for ourselves, and a way to counter any fel magics we may come across in the future!', 2851),
...
Such is the price of discovery, but I feel the weight of that cost too dearly already.', 2852),
...
I will have to abandon these investigations, and start over from scratch.', 2853),
...
I must find a way to atone for this horrible error in judgment.', 0),
(2854, '<HTML>
<BODY>
<H1 align="center">OFFICER RANKS OF THE HORDE</H1><BR/>
<P align="center">Part 2</P>
