...
use oxcore_db::database::characters::repositories::item_repository_trait::MockItemRepositoryTrait;
use oxcore_db::database::characters::repositories::mail_repository_trait::MockMailRepositoryTrait;
