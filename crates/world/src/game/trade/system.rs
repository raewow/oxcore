...
use crate::game::trade::types::TradeStatus;
    ...
    async fn execute_trade(
        ...
        if initiator_gold > 0 {
            ...
            match self.inventory.remove_gold(initiator_guid, initiator_gold) {
                crate::game::inventory::GoldResult::Success { .. } => {}
                crate::game::inventory::GoldResult::InsufficientFunds => {
                    tracing::error!(
                ...
                crate::game::inventory::GoldResult::DatabaseError(e) => {
            ...
            match self.inventory.add_gold(target_guid, initiator_gold) {
                ...
                crate::game::inventory::GoldResult::CapExceeded => {
                    tracing::error!(
        ...
        for (_slot, item_guid) in &initiator_items {
            ...
            match self
                ...
                .await
            {
                crate::game::inventory::TransferItemResult::Success { .. } => {
                    tracing::info!(
                ...
                crate::game::inventory::TransferItemResult::TargetInventoryFull => {
                    tracing::error!(
                ...
                crate::game::inventory::TransferItemResult::ItemNotFound => {
                    tracing::error!(
                ...
                crate::game::inventory::TransferItemResult::DatabaseError(e) => {
