...
use crate::core::common::ObjectGuidGenerator;
use crate::game::common::object_type::update_flags;
use crate::game::common::object_type::MovementSpeeds;
use crate::game::common::object_type::ObjectTypeId;
use crate::game::common::player_constants::{get_faction_for_race, get_player_display_id};
...
impl PlayerManager {
    ...
    pub(crate) fn collect_skills_for_save(&self, player_guid: ObjectGuid) -> Vec<(u16, u16, u16)> {
        use crate::game::player::skills::state::SkillSaveState;
        self.get_player(player_guid)
            .map(|p| {
                p.skills
                    .skills
    ...
    pub fn get_quest_share_info(
        &self,
        guid: ObjectGuid,
    ) -> Option<crate::game::player::player::QuestShareInfo> {
    ...
    pub fn set_quest_share_info(
        &self,
        guid: ObjectGuid,
        info: crate::game::player::player::QuestShareInfo,
    ) {
...
mod tests {
    ...
    use crate::game::player::reputation::state::FactionStanding;
    use crate::game::player::settings::state::{
        ACTION_BUTTON_ITEM, ACTION_BUTTON_MACRO, ACTION_BUTTON_SPELL,
    };
    use crate::game::player::skills::state::{SkillData, SkillSaveState, SkillState};
    ...
    fn quest_share_info_set_and_get_roundtrip() {
        ...
        let info = crate::game::player::player::QuestShareInfo {
            player_guid: sharer,
            quest_id: 42,
        };
    ...
    fn quest_share_info_clear_removes() {
        ...
        mgr.set_quest_share_info(
            guid,
            crate::game::player::player::QuestShareInfo {
