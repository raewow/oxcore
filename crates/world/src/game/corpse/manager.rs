...
use crate::game::player::death::corpse::Corpse;
...
impl CorpseManager {
    ...
    pub fn find_expired(&self, now_secs: u64) -> Vec<CorpseExpiration> {
        use crate::game::player::death::corpse::CorpseType;
        use crate::game::player::death::flow::{BONES_EXPIRE_SECS, CORPSE_REPOP_TIME_MS};
    ...
    pub fn convert_to_bones(
        &self,
        guid: ObjectGuid,
    ) -> Option<crate::game::player::death::corpse::Corpse> {
        use crate::game::player::death::corpse::CorpseType;
