...
use crate::game::creature::ai::{AIAction, AIEvent, AIInput, CombatEndReason, MovementType};
            ...
            LuaAction::SetReactState { state: react } => {
                let react_state = match react {
                    super::actions::ReactState::Passive => {
                        crate::game::creature::ai::ReactState::Passive
                    }
                    super::actions::ReactState::Defensive => {
                        crate::game::creature::ai::ReactState::Defensive
                    }
                    super::actions::ReactState::Aggressive => {
                        crate::game::creature::ai::ReactState::Aggressive
                    }
                };
