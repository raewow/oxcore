...
CREATE TABLE IF NOT EXISTS "character_battleground_data" (
    ...
    "join_map" INTEGER NOT NULL DEFAULT '0',
    PRIMARY KEY ("guid")
);
...
ALTER TABLE IF EXISTS "character_battleground_data" ADD COLUMN IF NOT EXISTS "team" BIGINT NOT NULL DEFAULT '0' CHECK ("team" >= 0);
...
ALTER TABLE IF EXISTS "character_battleground_data" ADD COLUMN IF NOT EXISTS "join_map" INTEGER NOT NULL DEFAULT '0';
