...
- `set_task_status` — the only mutating tool; advances a symbol along the porting ladder. Pass `source_file` when a qualified symbol name occurs in more than one C++ file.
