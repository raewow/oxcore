    ...
    pub async fn load_all(&self) -> Result<Vec<SpellEntry>> {
        ...
        for row in rows.iter() {
            let entry = SpellEntry {
                ...
                reagent: [
                    row.get::<i32, _>(43), row.get::<i32, _>(44),
                    row.get::<i32, _>(45), row.get::<i32, _>(46),
                    row.get::<i32, _>(47), row.get::<i32, _>(48),
                    row.get::<i32, _>(49), row.get::<i32, _>(50),
                ],
                reagent_count: [
                    row.get(51), row.get(52), row.get(53), row.get(54),
                    row.get(55), row.get(56), row.get(57), row.get(58),
                ],
                ...
                effect_die_sides: [
                    row.get::<i32, _>(65), row.get::<i32, _>(66), row.get::<i32, _>(67),
                ],
                effect_base_dice: [row.get(68), row.get(69), row.get(70)],
                effect_dice_per_level: [
                    row.get::<f32, _>(71), row.get::<f32, _>(72), row.get::<f32, _>(73),
                ],
                effect_real_points_per_level: [
                    row.get::<f32, _>(74), row.get::<f32, _>(75), row.get::<f32, _>(76),
                ],
                effect_base_points: [
                    row.get::<i32, _>(77), row.get::<i32, _>(78), row.get::<i32, _>(79),
                ],
                effect_bonus_coefficient: [
                    row.get::<f32, _>(80), row.get::<f32, _>(81), row.get::<f32, _>(82),
                ],
                ...
                effect_multiple_value: [
                    row.get::<f32, _>(101), row.get::<f32, _>(102), row.get::<f32, _>(103),
                ],
                ...
                effect_misc_value: [
                    row.get::<i32, _>(110), row.get::<i32, _>(111), row.get::<i32, _>(112),
                ],
                effect_trigger_spell: [row.get(113), row.get(114), row.get(115)],
                effect_points_per_combo_point: [
                    row.get::<f32, _>(116), row.get::<f32, _>(117), row.get::<f32, _>(118),
                ],
                ...
                dmg_multiplier: [
                    row.get::<f32, _>(143), row.get::<f32, _>(144), row.get::<f32, _>(145),
                ],
            };
