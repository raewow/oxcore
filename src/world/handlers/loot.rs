...
pub async fn handle_loot_item(
    ...
    // Delegate to LootSystem
    world.systems.loot
        .handle_loot_item(player_guid, target_guid, slot, world).await
...
pub async fn handle_loot_release(
    ...
    // Delegate to LootSystem
    world.systems.loot
        .handle_loot_release(player_guid, target_guid, world).await
