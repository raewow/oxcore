...
pub async fn effect_apply_aura(input: &EffectInput, world: &World) -> Result<EffectResult> {
    ...
    tracing::info!(
        ...
        input.spell_id, effect_idx, aura_type, input.base_value,
        periodic_interval_ms, duration_ms, spell_entry.duration_index,
        spell_entry.effect[effect_idx], input.misc_value, spell_entry.attributes,
    );
...
pub async fn effect_persistent_area_aura(input: &EffectInput, world: &World) -> Result<EffectResult> {
    ...
    let target_location = world.systems.player.manager().with_player(caster_guid, |player| {
    ...
    tracing::debug!(
        ...
        input.spell_id, radius, duration_ms
    );
...
pub async fn effect_apply_area_aura_party(input: &EffectInput, world: &World) -> Result<EffectResult> {
...
pub async fn effect_apply_area_aura_pet(input: &EffectInput, world: &World) -> Result<EffectResult> {
...
pub async fn effect_apply_area_aura_friend(input: &EffectInput, world: &World) -> Result<EffectResult> {
...
pub async fn effect_apply_area_aura_enemy(input: &EffectInput, world: &World) -> Result<EffectResult> {
...
pub async fn effect_apply_area_aura_raid(input: &EffectInput, world: &World) -> Result<EffectResult> {
...
async fn apply_area_aura(
    ...
    tracing::debug!(
        ...
        input.spell_id, target_type, target_guid
    );
