...
impl AddonSystem {
        ...
        world
            ...
            .with_creature_mut(creature_guid, |creature| {
                ...
                if stand_state > 0 {
                    ...
                    tracing::debug!(
                        "[ADDON] Would apply stand_state {} to {:?}",
                        stand_state,
                        creature_guid
                    );
                }
                ...
                if sheath_state > 0 {
                    ...
                    tracing::debug!(
                        "[ADDON] Would apply sheath_state {} to {:?}",
                        sheath_state,
                        creature_guid
                    );
                }
    ...
    pub async fn set_mount(
        ...
        world
            .managers
            .creature_mgr
            .with_creature_mut(creature_guid, |_creature| {
                // TODO: Set mount_display_id field and send update packet
                tracing::debug!(
                    "[ADDON] Would set mount {} on {:?}",
                    mount_id,
                    creature_guid
                );
            });
    ...
    pub async fn set_stand_state(
        ...
        world
            ...
            .with_creature_mut(creature_guid, |_creature| {
                ...
                tracing::debug!(
                    "[ADDON] Would set stand_state {} on {:?}",
                    stand_state,
                    creature_guid
                );
            });
