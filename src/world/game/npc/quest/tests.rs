...
use crate::world::game::inventory::cache::InventoryCache;
use crate::world::game::inventory::system::InventorySystem;
use crate::world::game::inventory::types::GoldResult;
...
fn add_player_to_setup(setup: &TestQuestSetup, player: Player) {
    ...
    let inv_data = crate::world::game::inventory::cache::PlayerInventoryData::new(guid);
